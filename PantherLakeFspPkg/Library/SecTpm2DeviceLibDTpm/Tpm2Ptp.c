  ...
  )
{
  ...
  TpmBaseAddress = Bspm->TpmBaseAddress;
  ...
  while (TRUE) {
    ...
    //
    if ((Tpm2GetIdleByPass ((VOID *)(UINTN) TpmBaseAddress) == 0) && ((MmioRead32 ((UINTN)&CrbReg->CrbControlStatus) & PTP_CRB_CONTROL_AREA_STATUS_TPM_IDLE) == 0)) {
      Status = PtpCrbWaitRegisterBits (
  ...
  )
{
  ...
  PtpInterface = Tpm2GetPtpInterface ((VOID *)(UINTN) TpmBaseAddress);
  switch (PtpInterface) {
    case Tpm2PtpInterfaceCrb:
      return PtpCrbTpmCommand (
               (PTP_CRB_REGISTERS_PTR)(UINTN) TpmBaseAddress,
               InputParameterBlock,
    ...
    case Tpm2PtpInterfaceTis:
      return Tpm2TisTpmCommand (
               (TIS_PC_REGISTERS_PTR)(UINTN) TpmBaseAddress,
               InputParameterBlock,
               InputParameterBlockSize,
               OutputParameterBlock,
               OutputParameterBlockSize
  ...
  )
{
  ...
  switch (PtpInterface) {
    case Tpm2PtpInterfaceCrb:
      return PtpCrbRequestUseTpm ((PTP_CRB_REGISTERS_PTR)(UINTN) TpmBaseAddress);
    case Tpm2PtpInterfaceFifo:
    case Tpm2PtpInterfaceTis:
      return TisPcRequestUseTpm ((TIS_PC_REGISTERS_PTR)(UINTN) TpmBaseAddress);
    default:
      return EFI_NOT_FOUND;
  }
}
