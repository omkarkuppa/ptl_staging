...
Include ("Fru/PtlPcd/AcpiTables/Dsdt/PtlPcdPmc.asl")
...
Scope (\_SB_.PC00) {
  ...
  //
  include ("Fru/PtlPcd/AcpiTables/Dsdt/PtlPcdXdci.asl")
  ...
  //
  Include ("Fru/PtlPcd/AcpiTables/Dsdt/PtlPcdXhci.asl")

  //
  // HD-Audio
  //
  Include ("Fru/PtlPcd/AcpiTables/Dsdt/PtlPcdHda.asl")
}

Include ("Fru/PtlPcd/AcpiTables/Dsdt/PchFruPtlPcd.asl")
