...
GLOBAL_REMOVE_IF_UNREFERENCED PTL_INFO_STR_TABLE mPtlPcdSkuStrs[] = {
  ...
  {V_PTL_PCD_P_ESPI_CFG_DEVICE_ID_MB_4,   "NEX INDU SuperSKU"},
  {V_PTL_PCD_P_ESPI_CFG_DEVICE_ID_MB_5,   "NEX INDU Premium"},
  {V_PTL_PCD_H_ESPI_CFG_DEVICE_ID_MB_0,   "PTL H Unfused"},
  {V_PTL_PCD_H_ESPI_CFG_DEVICE_ID_MB_1,   "H SKU"},
  {V_PTL_PCD_H_ESPI_CFG_DEVICE_ID_MB_2,   "H SKU"},
  {V_PTL_PCD_H_ESPI_CFG_DEVICE_ID_MB_3,   "H SKU"},
  {V_PTL_PCD_P_ESPI_CFG_DEVICE_ID_MB_6,   "U SKU"},
  {V_PTL_PCD_P_ESPI_CFG_DEVICE_ID_MB_7,   "U SKU"},
  {V_PTL_PCD_P_ESPI_CFG_DEVICE_ID_MB_8,   "U SKU"},
