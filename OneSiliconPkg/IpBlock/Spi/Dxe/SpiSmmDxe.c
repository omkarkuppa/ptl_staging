  ...
  )
{
  ...
  while (TempByteCount > 0) {
    ...
    if (EFI_ERROR (Status)) {
      DEBUG ((DEBUG_WARN, "SpiFlashRead - InitCommunicateBuffer fails\n"));
      return Status;
    }
    ...
    //
    if (EFI_ERROR (Status)) {
      DEBUG ((DEBUG_WARN, "SpiFlashRead - Communication : %r\n", Status));
      return Status;
    }
  ...
  )
{
  ...
  while (TempByteCount > 0) {
    ...
    if (EFI_ERROR (Status)) {
      DEBUG ((DEBUG_WARN, "SpiFlashWrite - InitCommunicateBuffer fails\n"));
      return Status;
    }
    ...
    //
    if (EFI_ERROR (Status)) {
      DEBUG ((DEBUG_WARN, "SpiFlashWrite - Communication : %r\n", Status));
      return Status;
    }
  ...
  )
{
  ...
  if (EFI_ERROR (Status)) {
    DEBUG ((DEBUG_WARN, "SpiFlashErase - Communication : %r\n", Status));
    return Status;
  }
  ...
  )
{
  ...
  if (EFI_ERROR (Status)) {
    DEBUG ((DEBUG_WARN, "SpiFlashReadSfdp - InitCommunicateBuffer fails\n"));
    return Status;
  }
  ...
  //
  if (EFI_ERROR (Status)) {
    DEBUG ((DEBUG_WARN, "SpiFlashReadSfdp - Communication : %r\n", Status));
    return Status;
  }
  ...
  )
{
  ...
  if (EFI_ERROR (Status)) {
    DEBUG ((DEBUG_WARN, "SpiFlashReadJedecId - InitCommunicateBuffer fails\n"));
    return Status;
  }
  ...
  //
  if (EFI_ERROR (Status)) {
    DEBUG ((DEBUG_WARN, "SpiFlashReadJedecId - Communication : %r\n", Status));
    return Status;
  }
  ...
  )
{
  ...
  if (EFI_ERROR (Status)) {
    DEBUG ((DEBUG_WARN, "SpiFlashWriteStatus - InitCommunicateBuffer fails\n"));
    return Status;
  }
  ...
  //
  if (EFI_ERROR (Status)) {
    DEBUG ((DEBUG_WARN, "SpiFlashWriteStatus - Communication : %r\n", Status));
    return Status;
  }
  ...
  )
{
  ...
  if (EFI_ERROR (Status)) {
    DEBUG ((DEBUG_WARN, "SpiFlashReadStatus - InitCommunicateBuffer fails\n"));
    return Status;
  }
  ...
  //
  if (EFI_ERROR (Status)) {
    DEBUG ((DEBUG_WARN, "SpiFlashReadStatus - Communication : %r\n", Status));
    return Status;
  }
  ...
  )
{
  ...
  if (EFI_ERROR (Status)) {
    DEBUG ((DEBUG_WARN, "SpiGetRegionAddress - InitCommunicateBuffer fails\n"));
    return Status;
  }
  ...
  //
  if (EFI_ERROR (Status)) {
    DEBUG ((DEBUG_WARN, "SpiGetRegionAddress - Communication : %r\n", Status));
    return Status;
  }
  ...
  )
{
  ...
  if (EFI_ERROR (Status)) {
    DEBUG ((DEBUG_WARN, "SpiReadPchSoftStrap - InitCommunicateBuffer fails\n"));
    return Status;
  }
  ...
  //
  if (EFI_ERROR (Status)) {
    DEBUG ((DEBUG_WARN, "SpiReadPchSoftStrap - Communication : %r\n", Status));
    return Status;
  }
  ...
  )
{
  ...
  if (EFI_ERROR (Status)) {
    DEBUG ((DEBUG_WARN, "SpiReadCpuSoftStrap - InitCommunicateBuffer fails\n"));
    return Status;
  }
  ...
  //
  if (EFI_ERROR (Status)) {
    DEBUG ((DEBUG_WARN, "SpiReadCpuSoftStrap - Communication : %r\n", Status));
    return Status;
  }
...
/**
  ...
  @retval EFI_NOT_FOUND           EfiSmmCommunicationProtocol not found
**/
EFI_STATUS
EFIAPI
InstallSpiSmmDxe (
  ...
  )
{
  ...
  if (EFI_ERROR (Status)) {
    FreePages (mCommunicateBuffer, SPI_COMM_BUFFER_PAGE);
    return Status;
  }
