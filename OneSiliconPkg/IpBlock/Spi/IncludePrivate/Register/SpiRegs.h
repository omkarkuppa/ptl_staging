...
#define B_SPI_CFG_BIOS_SPI_BDE_BLE                   BIT31        ///< BDE Lock Enable
...
//
// SPI DMA related registers
//
#define R_SPI_CFG_BIOS_RD_DMA_BA_HI                                     0xB0         ///< BIOS Direct Read DMA Base Address High
#define R_SPI_CFG_BIOS_RD_DMA_BA                                        0xB4         ///< BIOS Direct Read DMA Base Address
#define R_SPI_CFG_BIOS_RD_DMA_BASE_OFFSET                               0xB8         ///< BIOS Direct Read DMA Base Offset
#define B_SPI_CFG_BIOS_RD_DMA_BASE_OFFSET_BIOS_RD_DMA_BASE_OFFSET       0xFFFF0000   ///< SPI BIOS Read DMA Buffer Base Offset
#define N_SPI_CFG_BIOS_RD_DMA_BASE_OFFSET_BIOS_RD_DMA_BASE_OFFSET       16
#define R_SPI_CFG_BIOS_RD_DMA_CNTRL                                     0xBC         ///< BIOS Direct Read DMA Control
#define B_SPI_CFG_BIOS_RD_DMA_CNTRL_SPI_BIOS_RD_DMA_START               BIT0         ///< SPI BIOS Read DMA Start
#define B_SPI_CFG_BIOS_RD_DMA_CNTRL_SPI_BIOS_RD_DMA_WRPTR_RST           BIT6         ///< SPI BIOS Read DMA Write Pointer Reset
#define B_SPI_CFG_BIOS_RD_DMA_CNTRL_RD_DMA_REGION                       (BIT11 | BIT10 | BIT9 | BIT8) ///< Read DMA region number
#define N_SPI_CFG_BIOS_RD_DMA_CNTRL_RD_DMA_REGION                       8
#define B_SPI_CFG_BIOS_RD_DMA_CNTRL_BIOS_DMA_LOCK                       BIT15        ///< BIOS DMA Lock
#define B_SPI_CFG_BIOS_RD_DMA_CNTRL_BIOS_RD_DMA_SIZE                    0xFFFF0000   ///< SPI BIOS Read DMA Buffer Size
#define N_SPI_CFG_BIOS_RD_DMA_CNTRL_BIOS_RD_DMA_SIZE                    16
#define R_SPI_CFG_BIOS_RD_DMA_STS                                       0xC0         ///< BIOS Direct Read DMA Status
#define B_SPI_CFG_BIOS_RD_DMA_STS_SPI_BIOS_RD_DMA_CPL                   BIT2         ///< RX DMA Complete
#define B_SPI_CFG_BIOS_RD_DMA_STS_SPI_BIOS_RD_DMA_ERR                   BIT3         ///< SPI BIOS Read DMA Error
#define B_SPI_CFG_BIOS_RD_DMA_STS_SPI_BIOS_RD_DMA_SAF_CE                BIT4         ///< SAF ctype error
#define B_SPI_CFG_BIOS_RD_DMA_STS_SPI_BIOS_RD_DMA_SAF_LE                BIT5         ///< SAF link Error
#define B_SPI_CFG_BIOS_RD_DMA_STS_SPI_BIOS_RD_DMA_SAF_DLE               BIT6         ///< SAF Data length Error
#define B_SPI_CFG_BIOS_RD_DMA_STS_SPI_BIOS_RD_DMA_AEL                   BIT7         ///< Access Error Log
#define B_SPI_CFG_BIOS_RD_DMA_STS_SPI_BIOS_RD_DMA_WRPTR                 0xFFFF0000   ///< SPI BIOS DMA Write Pointer
