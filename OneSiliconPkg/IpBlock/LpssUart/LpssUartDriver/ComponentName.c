...
extern EFI_DRIVER_BINDING_PROTOCOL  mLpssUartDriverBinding;

EFI_STATUS
EFIAPI
LpssUartComponentNameGetDriverName (
...
EFI_STATUS
EFIAPI
LpssUartComponentNameGetControllerName (
  IN  EFI_COMPONENT_NAME_PROTOCOL   *This,
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_COMPONENT_NAME_PROTOCOL     mLpssUartDriverComponentName = {
  LpssUartComponentNameGetDriverName,
  LpssUartComponentNameGetControllerName,
  "eng"
};

static EFI_UNICODE_STRING_TABLE mLpssUartDriverNameTable[] = {
  {
    "eng",
    L"Lpss Uart Driver"
  },
  ...
  )
{
  ...
  Status = gBS->OpenProtocol (
                  ...
                  mLpssUartDriverBinding.DriverBindingHandle,
                  ControllerHandle,
  ...
  UartDevice = LPSS_UART_DEV_FROM_THIS (SerialIoProtcol);
