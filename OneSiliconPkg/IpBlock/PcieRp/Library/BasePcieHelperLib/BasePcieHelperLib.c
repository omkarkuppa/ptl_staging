  ...
  )
{
  ...
  CapOffset = PcieBaseFindCapId (Base, 0x10);
  if (CapOffset != 0) {
    *LnkSts = PciSegmentRead16 (Base + CapOffset + R_PCIE_LSTS_OFFSET) & B_PCIE_LSTS_CLS;
    if (*LnkSts != 0xFFFF) {
      return TRUE;
    }
  }
  ...
  )
{
  ...
  CapOffset = PcieBaseFindCapId (Base, 0x10);
  if (CapOffset != 0) {
    *LnkSts = PciSegmentRead16 (Base + CapOffset + R_PCIE_LSTS_OFFSET) & B_PCIE_LSTS_NLW;
    if (*LnkSts != 0xFFFF) {
      return TRUE;
    }
  }
