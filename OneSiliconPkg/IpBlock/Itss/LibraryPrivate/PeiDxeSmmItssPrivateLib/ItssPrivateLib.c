...
{
  *ClockGeteState = (ItssPcrAccess->Read32 (ItssPcrAccess, R_ITSS_PCR_ITSSPRC) & B_ITSS_PCR_ITSSPRC_CGE8254) != 0;
  return EFI_SUCCESS;
}
...
{
  ItssPcrAccess->AndThenOr32 (
    ItssPcrAccess, R_ITSS_PCR_ITSSPRC,
    (UINT32)~B_ITSS_PCR_ITSSPRC_CGE8254,
    ClockGateEnable ? B_ITSS_PCR_ITSSPRC_CGE8254 : 0
    );
  return EFI_SUCCESS;
}
