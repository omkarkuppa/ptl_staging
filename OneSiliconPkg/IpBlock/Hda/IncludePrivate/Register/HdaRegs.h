...
#define R_HDA_MEM_SOCCI                       0x1C80
#define R_HDA_MEM_SOCCI_FUSVAL                R_HDA_MEM_SOCCI + 0x00
#define B_HDA_MEM_SOCCI_FUSVAL_DSPSD          BIT1
...
#define R_HDA_PCR_FUSVAL                    0xF0
#define B_HDA_PCR_FUSVAL_ADSPD              BIT1
...
#define B_HDA_PCR_PTDC_IPGIW                (BIT14 | BIT13 | BIT12)
#define N_HDA_PCR_PTDC_IPGIW                12
#define V_HDA_PCR_PTDC_IPGIW_1US            0
#define V_HDA_PCR_PTDC_IPGIW_4US            1
#define V_HDA_PCR_PTDC_IPGIW_16US           2
#define V_HDA_PCR_PTDC_IPGIW_64US           3
#define V_HDA_PCR_PTDC_IPGIW_256US          4
#define V_HDA_PCR_PTDC_IPGIW_1MS            5
