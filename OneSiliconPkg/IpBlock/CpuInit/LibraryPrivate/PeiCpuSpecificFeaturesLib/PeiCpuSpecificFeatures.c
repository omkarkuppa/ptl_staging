...
/**
  Initializes ApicTprUpdateMessage feature to specific state.
  ...
  @param[in]  ConfigData       A pointer to the configuration buffer returned
                               ...
                               RegisterCpuFeature().
  @param[in]  State            If TRUE, then the ApicTprUpdateMessage feature
                               must be enabled.
                               If FALSE, then the ApicTprUpdateMessage feature
                               must be disabled.

  @retval RETURN_SUCCESS       ApicTprUpdateMessage feature is initialized.
