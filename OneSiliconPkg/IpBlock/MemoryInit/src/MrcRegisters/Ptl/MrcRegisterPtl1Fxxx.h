#ifndef __MrcRegisterPtl1Fxxx_h__
#define __MrcRegisterPtl1Fxxx_h__
/** @file
...
#define MC1_BC_CR_PM_PDWN_CONFIG_UARCH_REG                             (0x0001F024)
...
#define MC1_BC_CR_ECC_DFT_UARCH_REG                                    (0x0001F03C)
...
#define MC1_BC_CR_QUEUE_ENTRY_DISABLE_WPQ_HIGH_REG                     (0x0001F058)
...
#define MC1_BC_CR_QUEUE_ENTRY_DISABLE_WPQ_LOW_REG                      (0x0001F060)
...
#define MC1_BC_CR_TC_CAS_REG                                           (0x0001F070)
...
#define MC1_BC_CR_SC_GS_CFG_UARCH_REG                                  (0x0001F08C)
...
#define MC1_BC_CR_SC_GS_CFG_TRAINING_REG                               (0x0001F0B4)
...
#define MC1_BC_CR_SC_BLOCKING_RULES_CFG_REG                            (0x0001F0E0)
...
#define MC1_BC_CR_TR_RRDVALID_CTRL_REG                                 (0x0001F100)
//Duplicate of MC0_CH0_CR_TR_RRDVALID_CTRL_REG

#define MC1_BC_CR_TR_RRDVALID_DATA_REG                                 (0x0001F104)
//Duplicate of MC0_CH0_CR_TR_RRDVALID_DATA_REG

#define MC1_BC_CR_TC_WCK_REG                                           (0x0001F108)
...
#define MC1_BC_CR_ROWHAMMER_CTL_REG                                    (0x0001F120)
//Duplicate of MC0_CH0_CR_ROWHAMMER_CTL_REG

#define MC1_BC_CR_MERGE_REQ_READS_PQ_REG                               (0x0001F128)
//Duplicate of MC0_CH0_CR_MERGE_REQ_READS_PQ_REG

#define MC1_BC_CR_DFI_CTL_REG                                          (0x0001F12C)
//Duplicate of MC0_CH0_CR_DFI_CTL_REG

#define MC1_BC_CR_AUTO_PRE_CONTROL_REG                                 (0x0001F130)
//Duplicate of MC0_CH0_CR_AUTO_PRE_CONTROL_REG

#define MC1_BC_CR_TC_ACT_REG                                           (0x0001F138)
//Duplicate of MC0_CH0_CR_TC_ACT_REG

#define MC1_BC_CR_QUEUE_ENTRY_DISABLE_RPQ_REG                          (0x0001F140)
//Duplicate of MC0_CH0_CR_QUEUE_ENTRY_DISABLE_RPQ_REG

#define MC1_BC_CR_WCK_CONFIG_REG                                       (0x0001F148)
//Duplicate of MC0_CH0_CR_WCK_CONFIG_REG

#define MC1_BC_CR_SC_WDBWM_UARCH_REG                                   (0x0001F158)
//Duplicate of MC0_CH0_CR_SC_WDBWM_UARCH_REG

#define MC1_BC_CR_ROWHAMMER_CTL_UARCH_REG                              (0x0001F15C)
...
#define MC1_BC_CR_RH_TRR_CONTROL_UARCH_REG                             (0x0001F410)
...
#define MC1_BC_CR_SCH0_DDR_MR_RESULT_LOW_REG                           (0x0001F418)
//Duplicate of MC0_CH0_CR_SCH0_DDR_MR_RESULT_LOW_REG

#define MC1_BC_CR_SCH0_DDR_MR_RESULT_HIGH_REG                          (0x0001F41C)
//Duplicate of MC0_CH0_CR_SCH0_DDR_MR_RESULT_HIGH_REG

#define MC1_BC_CR_SCH0_DDR_MR_RESULT_ECC_REG                           (0x0001F420)
//Duplicate of MC0_CH0_CR_SCH0_DDR_MR_RESULT_ECC_REG

#define MC1_BC_CR_RANK_TEMPERATURE_REG                                 (0x0001F424)
//Duplicate of MC0_CH0_CR_RANK_TEMPERATURE_REG

#define MC1_BC_CR_PM_CONFIG_THERM_STATUS_REG                           (0x0001F428)
...
#define MC1_BC_CR_RH_TRR_ADDRESS_REG                                   (0x0001F430)
//Duplicate of MC0_CH0_CR_RH_TRR_ADDRESS_REG

#define MC1_BC_CR_MC_INIT_STATE_UARCH_REG                              (0x0001F434)
//Duplicate of MC0_CH0_CR_MC_INIT_STATE_UARCH_REG

#define MC1_BC_CR_RFP_REG                                              (0x0001F438)
//Duplicate of MC0_CH0_CR_RFP_REG

#define MC1_BC_CR_RFP_UARCH_REG                                        (0x0001F440)
...
#define MC1_BC_CR_ZQCAL_CONTROL_REG                                    (0x0001F44C)
//Duplicate of MC0_CH0_CR_ZQCAL_CONTROL_REG

#define MC1_BC_CR_SCH1_DDR_MR_RESULT_LOW_REG                           (0x0001F450)
//Duplicate of MC0_CH0_CR_SCH0_DDR_MR_RESULT_LOW_REG
...
#define MC1_BC_CR_REF_FSM_STATUS_REG                                   (0x0001F460)
...
#define MC1_BC_CR_PM_SREF_CONTROL_REG                                  (0x0001F474)
...
#define MC1_BC_CR_SCH0_BIT_DESWIZZLE_REG                               (0x0001F480)
//Duplicate of MC0_CH0_CR_SCH0_BIT_DESWIZZLE_REG

#define MC1_BC_CR_SCH1_BIT_DESWIZZLE_REG                               (0x0001F484)
//Duplicate of MC0_CH0_CR_SCH0_BIT_DESWIZZLE_REG

#define MC1_BC_CR_SC_PBR_REG                                           (0x0001F488)
//Duplicate of MC0_CH0_CR_SC_PBR_REG

#define MC1_BC_CR_DVFSQ_CTL_REG                                        (0x0001F48C)
//Duplicate of MC0_CH0_CR_DVFSQ_CTL_REG

#define MC1_BC_CR_TC_MR_REG                                            (0x0001F490)
//Duplicate of MC0_CH0_CR_TC_MR_REG

#define MC1_BC_CR_SCH1_DDR_MR_RESULT_HIGH_REG                          (0x0001F498)
//Duplicate of MC0_CH0_CR_SCH0_DDR_MR_RESULT_HIGH_REG

#define MC1_BC_CR_SCH1_DDR_MR_RESULT_ECC_REG                           (0x0001F49C)
//Duplicate of MC0_CH0_CR_SCH0_DDR_MR_RESULT_ECC_REG

#define MC1_BC_CR_TC_RFTP_REG                                          (0x0001F4A0)
//Duplicate of MC0_CH0_CR_TC_RFTP_REG

#define MC1_BC_CR_MRS_CR_MAILBOX_REG                                   (0x0001F4A8)
//Duplicate of MC0_CH0_CR_MRS_CR_MAILBOX_REG

#define MC1_BC_CR_SCH0_BYTE_DESWIZZLE_REG                              (0x0001F4B8)
//Duplicate of MC0_CH0_CR_SCH0_BYTE_DESWIZZLE_REG

#define MC1_BC_CR_SCH1_BYTE_DESWIZZLE_REG                              (0x0001F4BC)
//Duplicate of MC0_CH0_CR_SCH0_BYTE_DESWIZZLE_REG

#define MC1_BC_CR_TC_SREXITTP_REG                                      (0x0001F4C0)
//Duplicate of MC0_CH0_CR_TC_SREXITTP_REG

#define MC1_BC_CR_RETRAINING_OSCL_PARAMS_REG                           (0x0001F4C8)
...
#define MC1_BC_CR_TC_RETRAINING_OSCL_REG                               (0x0001F4D0)
//Duplicate of MC0_CH0_CR_TC_RETRAINING_OSCL_REG

#define MC1_BC_CR_FORCE_DRAM_MNT_FLOW_REG                              (0x0001F4D4)
...
#define MC1_BC_CR_WDB_CAPTURE_STATUS_REG                               (0x0001F520)
//Duplicate of MC0_CH0_CR_WDB_CAPTURE_STATUS_REG

#define MC1_BC_CR_WDB_CAPTURE_CTL_REG                                  (0x0001F524)
//Duplicate of MC0_CH0_CR_WDB_CAPTURE_CTL_REG

#define MC1_BC_CR_MRH_CONFIG_REG                                       (0x0001F528)
//Duplicate of MC0_CH0_CR_MRH_CONFIG_REG

#define MC1_BC_CR_PAGEOPEN_POLICY_LIMIT_REG                            (0x0001F52C)
//Duplicate of MC0_CH0_CR_PAGEOPEN_POLICY_LIMIT_REG

#define MC1_BC_CR_RH_TRR_LFSR0_REG                                     (0x0001F530)
//Duplicate of MC0_CH0_CR_RH_TRR_LFSR0_REG

#define MC1_BC_CR_RH_TRR_LFSR1_REG                                     (0x0001F534)
//Duplicate of MC0_CH0_CR_RH_TRR_LFSR0_REG

#define MC1_BC_CR_MRS_FSM_CONTROL_REG                                  (0x0001F5D0)
//Duplicate of MC0_CH0_CR_MRS_FSM_CONTROL_REG

#define MC1_BC_CR_MRS_FSM_CONTROL_UARCH_REG                            (0x0001F5D4)
...
#define MC1_BC_CR_ZQCAL_CONTROL_UARCH_REG                              (0x0001F600)
