#ifndef __MrcRegisterStructPtlCxxx_h__
#define __MrcRegisterStructPtlCxxx_h__
/** @file
...
typedef union {
  ...
  UINT16 Data16[4];
  UINT8  Data8[8];
} MC0_SHARED_CR_CPGC2_ACCESS_CONTROL_POLICY_STRUCT;
typedef union {
  struct {
  ...
  UINT16 Data16[4];
  UINT8  Data8[8];
} MC0_SHARED_CR_CPGC2_ACCESS_READ_POLICY_STRUCT;
typedef union {
  struct {
  ...
  UINT16 Data16[4];
  UINT8  Data8[8];
} MC0_SHARED_CR_CPGC2_ACCESS_WRITE_POLICY_STRUCT;
typedef union {
  struct {
  ...
  UINT16 Data16[4];
  UINT8  Data8[8];
} MC0_SHARED_CR_CPGC2_VISA_MUX_SEL_STRUCT;
typedef union {
  struct {
  ...
  UINT16 Data16[4];
  UINT8  Data8[8];
} MC0_SHARED_CR_CPGC2_STG_CHICKEN_STRUCT;
typedef union {
  struct {
  ...
  UINT16 Data16[2];
  UINT8  Data8[4];
} MC0_SHARED_CR_CPGC2_CREDIT_CFG_STRUCT;
typedef union {
  struct {
    ...
    UINT32 AXI_ORDER_MODE                          :  1;  // Bits 17:17
    UINT32 TID_ORDER_OOO                           :  1;  // Bits 18:18
    UINT32                                         :  5;  // Bits 23:19
  ...
  UINT16 Data16[2];
  UINT8  Data8[4];
} MC0_SHARED_CR_CPGC2_V_CHICKEN_STRUCT;
typedef union {
  struct {
...
typedef union {
  struct {
    ...
    UINT32                                         :  8;  // Bits 15:8
    UINT32 SPLIT_BACKGROUND                        :  1;  // Bits 16:16
...
typedef union {
  struct {
    UINT32 Block_Origin_Col_Current                :  16;  // Bits 15:0
    UINT32                                         :  8;  // Bits 23:16
    UINT32 Block_Origin_Rank_Current               :  5;  // Bits 28:24
    UINT32                                         :  3;  // Bits 31:29
    UINT32 Block_Origin_Row_Current                :  18;  // Bits 49:32
    UINT32                                         :  6;  // Bits 55:50
    UINT32 Block_Origin_Bank_Current               :  5;  // Bits 60:56
  } Bits;
  UINT64 Data;
  UINT32 Data32[2];
  UINT16 Data16[4];
  UINT8  Data8[8];
} MC0_REQ0_CR_CPGC2_BLOCK_ORIGIN_CURRENT_STRUCT;
typedef union {
  struct {
    UINT32 Base_Col_Current                        :  16;  // Bits 15:0
    UINT32                                         :  8;  // Bits 23:16
    UINT32 Base_Rank_Current                       :  5;  // Bits 28:24
    UINT32                                         :  3;  // Bits 31:29
    UINT32 Base_Row_Current                        :  18;  // Bits 49:32
    UINT32                                         :  6;  // Bits 55:50
    UINT32 Base_Bank_Current                       :  5;  // Bits 60:56
  } Bits;
  UINT64 Data;
  UINT32 Data32[2];
  UINT16 Data16[4];
  UINT8  Data8[8];
} MC0_REQ0_CR_CPGC2_BASE_ADDRESS_CURRENT_STRUCT;
typedef union {
  struct {
    UINT32 Offset_Col_Current                      :  16;  // Bits 15:0
    UINT32                                         :  16;  // Bits 31:16
    UINT32 Offset_Row_Current                      :  18;  // Bits 49:32
  } Bits;
  UINT64 Data;
  UINT32 Data32[2];
  UINT16 Data16[4];
  UINT8  Data8[8];
} MC0_REQ0_CR_CPGC2_OFFSET_ADDRESS_CURRENT_STRUCT;
typedef union {
  struct {
...
typedef union {
  struct {
    UINT8  ABDI_BACKGROUND                         :  8;  // Bits 7:0
  } Bits;
  UINT8  Data;
} MC0_REQ0_CR_CPGC2_DATA_INSTRUCTION_CTRL_0_STRUCT;

typedef MC0_REQ0_CR_CPGC2_DATA_INSTRUCTION_CTRL_0_STRUCT MC0_REQ0_CR_CPGC2_DATA_INSTRUCTION_CTRL_1_STRUCT;

typedef MC0_REQ0_CR_CPGC2_DATA_INSTRUCTION_CTRL_0_STRUCT MC0_REQ0_CR_CPGC2_DATA_INSTRUCTION_CTRL_2_STRUCT;

typedef MC0_REQ0_CR_CPGC2_DATA_INSTRUCTION_CTRL_0_STRUCT MC0_REQ0_CR_CPGC2_DATA_INSTRUCTION_CTRL_3_STRUCT;
typedef union {
  struct {
    UINT32 Address_PRBS_Column_Seed                :  16;  // Bits 15:0
    UINT32                                         :  8;  // Bits 23:16
...
typedef union {
  struct {
    UINT32 Address_PRBS_Column_Current             :  16;  // Bits 15:0
    UINT32                                         :  8;  // Bits 23:16
...
typedef union {
  struct {
    UINT32 Address_PRBS_Column_Save                :  16;  // Bits 15:0
    UINT32                                         :  8;  // Bits 23:16
...
typedef union {
  struct {
    UINT32 Address_PRBS_Column_Poly                :  16;  // Bits 15:0
    UINT32                                         :  8;  // Bits 23:16
...
typedef union {
  struct {
    ...
    UINT32 SRSP_WRITE_FORCE                        :  1;  // Bits 26:26
    UINT32 SRSP_RANK4_QUAL                         :  1;  // Bits 27:27
    UINT32                                         :  4;  // Bits 31:28
  } Bits;
  UINT32 Data;
  UINT16 Data16[2];
...
typedef union {
  struct {
    UINT32 NIBBLE_GROUP_EVEN_PLUS_ONE              :  9;  // Bits 8:0
    UINT32 NIBBLE_GROUP_ODD_PLUS_TWO               :  9;  // Bits 17:9
    UINT32 NIBBLE_GROUP_ODD_MINUS_ONE              :  9;  // Bits 26:18
    UINT32                                         :  5;  // Bits 31:27
  } Bits;
  UINT32 Data;
  UINT16 Data16[2];
  UINT8  Data8[4];
} MC0_CH0_CR_CPGC_DPAT_NIBBLE_STRUCT;
typedef union {
  struct {
...
typedef union {
  struct {
    ...
    UINT32 DBI_TRAIN_ERR_EN                        :  1;  // Bits 9:9
    UINT32                                         :  2;  // Bits 11:10
...
typedef union {
  struct {
    ...
    UINT32 ECCGRP_DBI_ERR_STAT                     :  1;  // Bits 8:8
    UINT32                                         :  7;  // Bits 15:9
    UINT32 CHUNK_ERR_STAT                          :  8;  // Bits 23:16
    UINT32 RANK_ERR_STAT                           :  8;  // Bits 31:24
  } Bits;
  UINT32 Data;
  UINT16 Data16[2];
  UINT8  Data8[4];
...
typedef union {
  ...
  UINT16 Data16[2];
  UINT8  Data8[4];
} MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF0_CR_CPGC_DPAT_EXTBUF_1_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF0_CR_CPGC_DPAT_EXTBUF_2_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF0_CR_CPGC_DPAT_EXTBUF_3_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF0_CR_CPGC_DPAT_EXTBUF_4_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF0_CR_CPGC_DPAT_EXTBUF_5_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF0_CR_CPGC_DPAT_EXTBUF_6_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF0_CR_CPGC_DPAT_EXTBUF_7_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF0_CR_CPGC_DPAT_EXTBUF_8_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF0_CR_CPGC_DPAT_EXTBUF_9_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF0_CR_CPGC_DPAT_EXTBUF_10_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF0_CR_CPGC_DPAT_EXTBUF_11_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF0_CR_CPGC_DPAT_EXTBUF_12_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF0_CR_CPGC_DPAT_EXTBUF_13_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF0_CR_CPGC_DPAT_EXTBUF_14_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF0_CR_CPGC_DPAT_EXTBUF_15_STRUCT;
typedef union {
  struct {
  ...
  UINT16 Data16[4];
  UINT8  Data8[8];
} MC0_BUF0_CR_CPGC_B_DUMMY_STRUCT;
typedef union {
  struct {
...
typedef union {
  struct {
    ...
    UINT32 L2P_COL9_SWIZZLE                        :  5;  // Bits 19:15
    UINT32 L2P_COL10_SWIZZLE                       :  5;  // Bits 24:20
    UINT32 L2P_COL11_SWIZZLE                       :  5;  // Bits 29:25
    UINT32                                         :  2;  // Bits 31:30
  } Bits;
  UINT32 Data;
  UINT16 Data16[2];
...
typedef union {
  struct {
    UINT32 L2P_COL12_SWIZZLE                       :  5;  // Bits 4:0
    UINT32 L2P_COL13_SWIZZLE                       :  5;  // Bits 9:5
    UINT32 L2P_COL14_SWIZZLE                       :  5;  // Bits 14:10
    UINT32 L2P_COL15_SWIZZLE                       :  5;  // Bits 19:15
    UINT32                                         :  12;  // Bits 31:20
  } Bits;
  UINT32 Data;
  UINT16 Data16[2];
  UINT8  Data8[4];
} MC0_REQ0_CR_CPGC_SEQ_COL_ADDR_SWIZZLE_C_STRUCT;
typedef union {
  struct {
  ...
  UINT16 Data16[2];
  UINT8  Data8[4];
} MC0_REQ0_CR_CPGC_SEQ_ROW_ADDR_DQ_MAP0_STRUCT;

typedef MC0_REQ0_CR_CPGC_SEQ_ROW_ADDR_DQ_MAP0_STRUCT MC0_REQ0_CR_CPGC_SEQ_ROW_ADDR_DQ_MAP1_STRUCT;

typedef MC0_BUF0_CR_CPGC_B_DUMMY_STRUCT MC0_REQ0_CR_CPGC_A_DUMMY_STRUCT;
...
typedef MC0_REQ0_CR_CPGC2_BLOCK_ORIGIN_CURRENT_STRUCT MC0_REQ1_CR_CPGC2_BLOCK_ORIGIN_CURRENT_STRUCT;

typedef MC0_REQ0_CR_CPGC2_BASE_ADDRESS_CURRENT_STRUCT MC0_REQ1_CR_CPGC2_BASE_ADDRESS_CURRENT_STRUCT;

typedef MC0_REQ0_CR_CPGC2_OFFSET_ADDRESS_CURRENT_STRUCT MC0_REQ1_CR_CPGC2_OFFSET_ADDRESS_CURRENT_STRUCT;
...
typedef MC0_REQ0_CR_CPGC2_DATA_INSTRUCTION_CTRL_0_STRUCT MC0_REQ1_CR_CPGC2_DATA_INSTRUCTION_CTRL_0_STRUCT;

typedef MC0_REQ0_CR_CPGC2_DATA_INSTRUCTION_CTRL_0_STRUCT MC0_REQ1_CR_CPGC2_DATA_INSTRUCTION_CTRL_1_STRUCT;

typedef MC0_REQ0_CR_CPGC2_DATA_INSTRUCTION_CTRL_0_STRUCT MC0_REQ1_CR_CPGC2_DATA_INSTRUCTION_CTRL_2_STRUCT;

typedef MC0_REQ0_CR_CPGC2_DATA_INSTRUCTION_CTRL_0_STRUCT MC0_REQ1_CR_CPGC2_DATA_INSTRUCTION_CTRL_3_STRUCT;
...
typedef MC0_REQ0_CR_CPGC_SEQ_CFG_A_STRUCT MC0_REQ1_CR_CPGC_SEQ_CFG_A_STRUCT;
...
typedef MC0_CH0_CR_CPGC_DPAT_NIBBLE_STRUCT MC0_CH1_CR_CPGC_DPAT_NIBBLE_STRUCT;
...
typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF1_CR_CPGC_DPAT_EXTBUF_0_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF1_CR_CPGC_DPAT_EXTBUF_1_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF1_CR_CPGC_DPAT_EXTBUF_2_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF1_CR_CPGC_DPAT_EXTBUF_3_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF1_CR_CPGC_DPAT_EXTBUF_4_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF1_CR_CPGC_DPAT_EXTBUF_5_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF1_CR_CPGC_DPAT_EXTBUF_6_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF1_CR_CPGC_DPAT_EXTBUF_7_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF1_CR_CPGC_DPAT_EXTBUF_8_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF1_CR_CPGC_DPAT_EXTBUF_9_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF1_CR_CPGC_DPAT_EXTBUF_10_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF1_CR_CPGC_DPAT_EXTBUF_11_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF1_CR_CPGC_DPAT_EXTBUF_12_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF1_CR_CPGC_DPAT_EXTBUF_13_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF1_CR_CPGC_DPAT_EXTBUF_14_STRUCT;

typedef MC0_BUF0_CR_CPGC_DPAT_EXTBUF_0_STRUCT MC0_BUF1_CR_CPGC_DPAT_EXTBUF_15_STRUCT;

typedef MC0_BUF0_CR_CPGC_B_DUMMY_STRUCT MC0_BUF1_CR_CPGC_B_DUMMY_STRUCT;
...
typedef MC0_REQ0_CR_CPGC_SEQ_COL_ADDR_SWIZZLE_C_STRUCT MC0_REQ1_CR_CPGC_SEQ_COL_ADDR_SWIZZLE_C_STRUCT;

typedef MC0_REQ0_CR_CPGC_SEQ_ROW_ADDR_DQ_MAP0_STRUCT MC0_REQ1_CR_CPGC_SEQ_ROW_ADDR_DQ_MAP0_STRUCT;

typedef MC0_REQ0_CR_CPGC_SEQ_ROW_ADDR_DQ_MAP0_STRUCT MC0_REQ1_CR_CPGC_SEQ_ROW_ADDR_DQ_MAP1_STRUCT;

typedef MC0_BUF0_CR_CPGC_B_DUMMY_STRUCT MC0_REQ1_CR_CPGC_A_DUMMY_STRUCT;
...
typedef MC0_CH0_CR_CPGC_DPAT_NIBBLE_STRUCT MC0_CH2_CR_CPGC_DPAT_NIBBLE_STRUCT;
...
typedef MC0_CH0_CR_CPGC_DPAT_NIBBLE_STRUCT MC0_CH3_CR_CPGC_DPAT_NIBBLE_STRUCT;
