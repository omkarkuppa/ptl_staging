#ifndef __MrcRegisterStructPtl1Fxxx_h__
#define __MrcRegisterStructPtl1Fxxx_h__
/** @file
...
typedef MC0_CH0_CR_PM_ADAPTIVE_CKE_STRUCT MC1_BC_CR_PM_ADAPTIVE_CKE_STRUCT;

typedef MC0_CH0_CR_SC_ROUNDTRIP_LATENCY_STRUCT MC1_BC_CR_SC_ROUNDTRIP_LATENCY_STRUCT;

typedef MC0_CH0_CR_PM_PDWN_CONFIG_UARCH_STRUCT MC1_BC_CR_PM_PDWN_CONFIG_UARCH_STRUCT;
...
typedef MC0_CH0_CR_ECC_DFT_UARCH_STRUCT MC1_BC_CR_ECC_DFT_UARCH_STRUCT;
...
typedef MC0_CH0_CR_QUEUE_ENTRY_DISABLE_WPQ_HIGH_STRUCT MC1_BC_CR_QUEUE_ENTRY_DISABLE_WPQ_HIGH_STRUCT;

typedef MC0_CH0_CR_QUEUE_ENTRY_DISABLE_IPQ_STRUCT MC1_BC_CR_QUEUE_ENTRY_DISABLE_IPQ_STRUCT;

typedef MC0_CH0_CR_QUEUE_ENTRY_DISABLE_WPQ_LOW_STRUCT MC1_BC_CR_QUEUE_ENTRY_DISABLE_WPQ_LOW_STRUCT;

typedef MC0_CH0_CR_SC_WDBWM_STRUCT MC1_BC_CR_SC_WDBWM_STRUCT;

typedef MC0_CH0_CR_TC_CAS_STRUCT MC1_BC_CR_TC_CAS_STRUCT;

typedef MC0_CH0_CR_MCSCHEDS_SPARE_STRUCT MC1_BC_CR_MCSCHEDS_SPARE_STRUCT;

typedef MC0_CH0_CR_TC_MPC_STRUCT MC1_BC_CR_TC_MPC_STRUCT;
...
typedef MC0_CH0_CR_SC_GS_CFG_UARCH_STRUCT MC1_BC_CR_SC_GS_CFG_UARCH_STRUCT;
...
typedef MC0_CH0_CR_REUT_CH_MISC_CKE_CS_CTRL_STRUCT MC1_BC_CR_REUT_CH_MISC_CKE_CS_CTRL_STRUCT;
...
typedef MC0_MCMAINS_GLOBAL_DRIVER_GATE_CFG_STRUCT MC1_BC_CR_MCSCHEDS_GLOBAL_DRIVER_GATE_CFG_STRUCT;
...
typedef MC0_CH0_CR_TR_RRDVALID_CTRL_STRUCT MC1_BC_CR_TR_RRDVALID_CTRL_STRUCT;

typedef MC0_CH0_CR_TR_RRDVALID_DATA_STRUCT MC1_BC_CR_TR_RRDVALID_DATA_STRUCT;

typedef MC0_CH0_CR_TC_WCK_STRUCT MC1_BC_CR_TC_WCK_STRUCT;

typedef MC0_CH0_CR_WMM_READ_CONFIG_STRUCT MC1_BC_CR_WMM_READ_CONFIG_STRUCT;

typedef MC0_CH0_CR_MC2PHY_BGF_CTRL_STRUCT MC1_BC_CR_MC2PHY_BGF_CTRL_STRUCT;

typedef MC0_CH0_CR_SC_ADAPTIVE_PCIT_STRUCT MC1_BC_CR_SC_ADAPTIVE_PCIT_STRUCT;

typedef MC0_CH0_CR_ROWHAMMER_CTL_STRUCT MC1_BC_CR_ROWHAMMER_CTL_STRUCT;

typedef MC0_CH0_CR_MERGE_REQ_READS_PQ_STRUCT MC1_BC_CR_MERGE_REQ_READS_PQ_STRUCT;

typedef MC0_CH0_CR_DFI_CTL_STRUCT MC1_BC_CR_DFI_CTL_STRUCT;

typedef MC0_CH0_CR_AUTO_PRE_CONTROL_STRUCT MC1_BC_CR_AUTO_PRE_CONTROL_STRUCT;
...
typedef MC0_CH0_CR_SC_WDBWM_UARCH_STRUCT MC1_BC_CR_SC_WDBWM_UARCH_STRUCT;

typedef MC0_CH0_CR_ROWHAMMER_CTL_UARCH_STRUCT MC1_BC_CR_ROWHAMMER_CTL_UARCH_STRUCT;

typedef MC0_CH0_CR_RH_TRR_CONTROL_STRUCT MC1_BC_CR_RH_TRR_CONTROL_STRUCT;
...
typedef MC0_CH0_CR_TC_REFM_STRUCT MC1_BC_CR_TC_REFM_STRUCT;

typedef MC0_CH0_CR_RH_TRR_CONTROL_UARCH_STRUCT MC1_BC_CR_RH_TRR_CONTROL_UARCH_STRUCT;

typedef MC0_CH0_CR_DDR_MR_COMMAND_STRUCT MC1_BC_CR_DDR_MR_COMMAND_STRUCT;

typedef MC0_CH0_CR_SCH0_DDR_MR_RESULT_LOW_STRUCT MC1_BC_CR_SCH0_DDR_MR_RESULT_LOW_STRUCT;

typedef MC0_CH0_CR_SCH0_DDR_MR_RESULT_HIGH_STRUCT MC1_BC_CR_SCH0_DDR_MR_RESULT_HIGH_STRUCT;

typedef MC0_CH0_CR_SCH0_DDR_MR_RESULT_ECC_STRUCT MC1_BC_CR_SCH0_DDR_MR_RESULT_ECC_STRUCT;

typedef MC0_CH0_CR_RANK_TEMPERATURE_STRUCT MC1_BC_CR_RANK_TEMPERATURE_STRUCT;

typedef MC0_CH0_CR_PM_CONFIG_THERM_STATUS_STRUCT MC1_BC_CR_PM_CONFIG_THERM_STATUS_STRUCT;

typedef MC0_CH0_CR_MC_RDB_CREDITS_STRUCT MC1_BC_CR_MC_RDB_CREDITS_STRUCT;

typedef MC0_CH0_CR_RH_TRR_ADDRESS_STRUCT MC1_BC_CR_RH_TRR_ADDRESS_STRUCT;

typedef MC0_CH0_CR_MC_INIT_STATE_UARCH_STRUCT MC1_BC_CR_MC_INIT_STATE_UARCH_STRUCT;

typedef MC0_CH0_CR_RFP_STRUCT MC1_BC_CR_RFP_STRUCT;

typedef MC0_CH0_CR_RFP_UARCH_STRUCT MC1_BC_CR_RFP_UARCH_STRUCT;
...
typedef MC0_CH0_CR_ZQCAL_CONTROL_STRUCT MC1_BC_CR_ZQCAL_CONTROL_STRUCT;

typedef MC0_CH0_CR_SCH0_DDR_MR_RESULT_LOW_STRUCT MC1_BC_CR_SCH1_DDR_MR_RESULT_LOW_STRUCT;
...
typedef MC0_CH0_CR_PM_SREF_CONTROL_STRUCT MC1_BC_CR_PM_SREF_CONTROL_STRUCT;
...
typedef MC0_CH0_CR_SCH0_BIT_DESWIZZLE_STRUCT MC1_BC_CR_SCH0_BIT_DESWIZZLE_STRUCT;

typedef MC0_CH0_CR_SCH0_BIT_DESWIZZLE_STRUCT MC1_BC_CR_SCH1_BIT_DESWIZZLE_STRUCT;

typedef MC0_CH0_CR_SC_PBR_STRUCT MC1_BC_CR_SC_PBR_STRUCT;

typedef MC0_CH0_CR_DVFSQ_CTL_STRUCT MC1_BC_CR_DVFSQ_CTL_STRUCT;

typedef MC0_CH0_CR_TC_MR_STRUCT MC1_BC_CR_TC_MR_STRUCT;

typedef MC0_CH0_CR_SCH0_DDR_MR_RESULT_HIGH_STRUCT MC1_BC_CR_SCH1_DDR_MR_RESULT_HIGH_STRUCT;

typedef MC0_CH0_CR_SCH0_DDR_MR_RESULT_ECC_STRUCT MC1_BC_CR_SCH1_DDR_MR_RESULT_ECC_STRUCT;

typedef MC0_CH0_CR_TC_RFTP_STRUCT MC1_BC_CR_TC_RFTP_STRUCT;

typedef MC0_CH0_CR_MRS_CR_MAILBOX_STRUCT MC1_BC_CR_MRS_CR_MAILBOX_STRUCT;

typedef MC0_CH0_CR_SCH0_BYTE_DESWIZZLE_STRUCT MC1_BC_CR_SCH0_BYTE_DESWIZZLE_STRUCT;

typedef MC0_CH0_CR_SCH0_BYTE_DESWIZZLE_STRUCT MC1_BC_CR_SCH1_BYTE_DESWIZZLE_STRUCT;

typedef MC0_CH0_CR_TC_SREXITTP_STRUCT MC1_BC_CR_TC_SREXITTP_STRUCT;

typedef MC0_CH0_CR_RETRAINING_OSCL_PARAMS_STRUCT MC1_BC_CR_RETRAINING_OSCL_PARAMS_STRUCT;

typedef MC0_CH0_CR_MRH_GENERIC_COMMAND_STRUCT MC1_BC_CR_MRH_GENERIC_COMMAND_STRUCT;

typedef MC0_CH0_CR_TC_RETRAINING_OSCL_STRUCT MC1_BC_CR_TC_RETRAINING_OSCL_STRUCT;

typedef MC0_CH0_CR_FORCE_DRAM_MNT_FLOW_STRUCT MC1_BC_CR_FORCE_DRAM_MNT_FLOW_STRUCT;
...
typedef MC0_CH0_CR_WDB_CAPTURE_STATUS_STRUCT MC1_BC_CR_WDB_CAPTURE_STATUS_STRUCT;

typedef MC0_CH0_CR_WDB_CAPTURE_CTL_STRUCT MC1_BC_CR_WDB_CAPTURE_CTL_STRUCT;

typedef MC0_CH0_CR_MRH_CONFIG_STRUCT MC1_BC_CR_MRH_CONFIG_STRUCT;

typedef MC0_CH0_CR_PAGEOPEN_POLICY_LIMIT_STRUCT MC1_BC_CR_PAGEOPEN_POLICY_LIMIT_STRUCT;

typedef MC0_CH0_CR_RH_TRR_LFSR0_STRUCT MC1_BC_CR_RH_TRR_LFSR0_STRUCT;

typedef MC0_CH0_CR_RH_TRR_LFSR0_STRUCT MC1_BC_CR_RH_TRR_LFSR1_STRUCT;

typedef MC0_CH0_CR_MRS_FSM_CONTROL_STRUCT MC1_BC_CR_MRS_FSM_CONTROL_STRUCT;

typedef MC0_CH0_CR_MRS_FSM_CONTROL_UARCH_STRUCT MC1_BC_CR_MRS_FSM_CONTROL_UARCH_STRUCT;
...
typedef MC0_CH0_CR_MCMNTS_SPARE2_STRUCT MC1_BC_CR_MCMNTS_SPARE2_STRUCT;

typedef MC0_CH0_CR_MCMNTS_SPARE_STRUCT MC1_BC_CR_MCMNTS_SPARE_STRUCT;

typedef MC0_CH0_CR_ZQCAL_CONTROL_UARCH_STRUCT MC1_BC_CR_ZQCAL_CONTROL_UARCH_STRUCT;
