...
#define MRC_EARLY_RXDQS_VOC             (0xDD04)
...
#define MRC_READ_DCA_LP5                (0xDD14)
...
#define MRC_DVFSQ_CHECK_RMT_RESULT      (0xDD37)
...
#define MRC_VCC_LVR_INIT                (0xDD49)
...
#define MRC_TXDQS_DCC                   (0xDD68)
#define MRC_FILL_BDAT_STRUCTURE         (0xDD69)
#define MRC_WCK_LEVELING                (0xDD6A)
#define MRC_DUNIT_TAT_OPTIMIZATION      (0xDD6B)
