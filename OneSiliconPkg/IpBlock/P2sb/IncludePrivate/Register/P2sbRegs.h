...
// Definition for SBI
//
#define R_P2SB_CFG_SBIADDR                    0x000000d0U      ///< SBI Address
...
#define R_P2SB_CFG_SBIDATA                    0x000000d4U      ///< SBI Data
                                                               /* Provides mechanism to send message on IOSFSB
                                                                */
#define R_P2SB_CFG_SBISTAT                    0x000000d8U      ///< SBI Status
                                                               /* Provides mechanism to send message on IOSFSB
                                                                */
#define B_P2SB_CFG_SBISTAT_INITRDY            BIT0             ///< Initiate/ Ready
                                                                ...
                                                                * register.
                                                                */
#define B_P2SB_CFG_SBISTAT_RESPONSE           ( BIT2 | BIT1 )  ///< Response Status
                                                               /* 00 - Successful
...
#define B_P2SB_CFG_SBISTAT_OPCODE             ( BIT15 | BIT14 | BIT13 | BIT12 | BIT11 | BIT10 | BIT9 | BIT8 ) ///< SBI Opcode
                                                               /* This is the Opcode sent in the IOSF
                                                                * sideband message.
                                                                */
#define N_P2SB_CFG_SBISTAT_OPCODE             8
#define R_P2SB_CFG_SBIRID                     0x000000daU      ///< SBI Routing Identification
                                                               /* Provides mechanism to send message on IOSFSB
                                                                */
...
#define R_P2SB_CFG_SBIEXTADDR                 0x000000dcU      ///< SBI Extended Address
                                                               /* Provides mechanism to send message on IOSFSB
                                                                */
...
#define R_P2SB_CFG_SAIPOLWAC0                 0x00000248U      ///< SAI Policy Write Access Control 0

#define R_P2SB_CFG_SAIPOLRAC0                 0x00000250U      ///< SAI Policy Read Access Control 0
