...
#include <Register/SerialIoI2cRegsVer2.h>
  ...
  )
{
  ...
  EnableStatus.Data32 = MmioRead32 ((UINTN) MmioBase + R_SERIAL_IO_I2C_MEM_IC_ENABLE_STATUS);
  ...
  )
{
  ...
  SERIAL_IO_PWRMG_CONTROL_AND_STATUS  I2cPwrMgmControlStsReg;

  *BaseAddress = (UINTN) ((PciSegmentRead32 ((UINTN) (PciCfgBase + 0x10)) & 0xFFFFF000) + LShiftU64 (PciSegmentRead32 ((UINTN) (PciCfgBase + 0x10 + 4)), 32));
  if (((UINT64) *BaseAddress == 0xFFFFFFFFFFFFF000) || (*BaseAddress == 0x0)) {
  ...
  I2cPwrMgmControlStsReg.Data32 = PciSegmentRead32 (PciCfgBase + R_SERIAL_IO_CFG_PMECTRLSTATUS);
  I2cPwrMgmControlStsReg.Fields.PwrState = 0x0; // Place Device in D0 State
  PciSegmentWrite32 (PciCfgBase + R_SERIAL_IO_CFG_PMECTRLSTATUS, I2cPwrMgmControlStsReg.Data32);
  PciSegmentRead8 (PciCfgBase + R_SERIAL_IO_CFG_PMECTRLSTATUS); // Dummy Read after modifying PME

  I2cResets.Data32 = MmioRead32 (*BaseAddress + R_SERIAL_IO_MEM_RESETS);
  if (I2cResets.Fields.ResetI2C == 0 && I2cResets.Fields.ResetDma == 0) {
    ...
    MmioWrite32 (*BaseAddress + R_SERIAL_IO_MEM_RESETS, I2cResets.Data32);
    MmioRead32 (*BaseAddress + R_SERIAL_IO_MEM_RESETS);

    I2cGeneral.Data32 = MmioRead32 (*BaseAddress + R_SERIAL_IO_I2C_MEM_GENERAL);
  ...
  )
{
  ...
  I2cResets.Data32 = MmioRead32 ((UINTN) BaseAddress + R_SERIAL_IO_MEM_RESETS);
  I2cResets.Fields.ResetI2C = 0;
  I2cResets.Fields.ResetDma = 0;
  MmioWrite32 ((UINTN) BaseAddress + R_SERIAL_IO_MEM_RESETS, I2cResets.Data32);

  //
  // Set D3
  //
  I2cPwrMgmControlStsReg.Data32 = PciSegmentRead32 (PciCfgBase + R_SERIAL_IO_CFG_PMECTRLSTATUS);
  I2cPwrMgmControlStsReg.Fields.PwrState = 0x3; // Place Device in D3 State
  PciSegmentWrite32 (PciCfgBase + R_SERIAL_IO_CFG_PMECTRLSTATUS, I2cPwrMgmControlStsReg.Data32);
  PciSegmentRead8 (PciCfgBase + R_SERIAL_IO_CFG_PMECTRLSTATUS); // Dummy Read after modifying PME
  ...
  )
{
  ...
  MmioWrite32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_ENABLE, MemEnable.Data32);
...
{
  MmioRead32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_CLR_INTR);
  MmioRead32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_CLR_TX_ABRT);
}
  ...
  )
{
  ...
  if (*Frequency < 400) {
    ...
    MmioWrite32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_SDA_HOLD, SdaHold.Data32);
    MmioWrite32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_SS_SCL_HCNT, SsSclHcnt.Data32);
    MmioWrite32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_SS_SCL_LCNT, SsSclLcnt.Data32);
    return;
  } else if (*Frequency < 3400) {
    //
    ...
    MmioWrite32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_SDA_HOLD, SdaHold.Data32);
    MmioWrite32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_FS_SCL_HCNT, FsSclHcnt.Data32);
    MmioWrite32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_FS_SCL_LCNT, FsSclLcnt.Data32);
    return;
  } else {
    //
    ...
    *Frequency = 3400;
    ...
    MmioWrite32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_SDA_HOLD, SdaHold.Data32);
    MmioWrite32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_HS_SCL_HCNT, HsSclHcnt.Data32);
    MmioWrite32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_HS_SCL_LCNT, HsSclLcnt.Data32);
  }
}
  ...
  )
{
  ...
  MmioWrite32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_TAR, MemTar.Data32);
}
  ...
  )
{
  ...
  MemCon.Data32 = MmioRead32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_CON);
  ...
  MmioWrite32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_CON, MemCon.Data32);
}
  ...
  )
{
  ...
  MemStatus.Data32 = MmioRead32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_STATUS);
  ...
  )
{
  ...
  //
  I2cTransmitFifo.Data32 = MmioRead32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_TXFLR);
  ...
  MmioWrite32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_DATA_CMD, I2cDataCmd.Data32);
  *WriteBuffer += 1;
  *WriteLength -= 1;
  ...
  )
{
  ...
  MemStatus.Data32      = MmioRead32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_STATUS);
  I2cReceiveFifo.Data32 = MmioRead32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_RXFLR);
  ...
  while (Timeout > 0) {
    ...
    if (MemStatus.Fields.RFNE) {
      I2cDataCmd.Data32 = MmioRead32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_DATA_CMD);
  ...
  )
{
  ...
  //
  Data32 = MmioRead32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_CON);
...
{
  SdaHold->Data32 = MmioRead32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_SDA_HOLD);
...
/**
  ...
  @param[in]        MmioBase    MMIO Base Address of specified I2C controller
  @param[in][out]   SsSclHcnt   Pointer to register union for R_SERIAL_IO_I2C_MEM_IC_SS_SCL_HCNT
  @param[in][out]   SsSclLcnt   Pointer to register union for R_SERIAL_IO_I2C_MEM_IC_SS_SCL_LCNT
  @param[in]        Frequency   Pointer to bus clock frequency (in kHz)
**/
VOID
SerialIoI2cGetSsScl (
...
{
  SsSclLcnt->Data32 = MmioRead32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_SS_SCL_LCNT);
  SsSclHcnt->Data32 = MmioRead32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_SS_SCL_HCNT);
...
/**
  ...
  @param[in]        MmioBase    MMIO Base Address of specified I2C controller
  @param[in][out]   FsSclHcnt   Pointer to register union for R_SERIAL_IO_I2C_MEM_IC_FS_SCL_HCNT
  @param[in][out]   FsSclLcnt   Pointer to register union for R_SERIAL_IO_I2C_MEM_IC_FS_SCL_LCNT
  @param[in]        Frequency   Pointer to bus clock frequency (in kHz)
**/
VOID
SerialIoI2cGetFsScl (
...
{
  FsSclHcnt->Data32 = MmioRead32 (MmioBase +  R_SERIAL_IO_I2C_MEM_IC_FS_SCL_HCNT);
  FsSclLcnt->Data32 = MmioRead32 (MmioBase +  R_SERIAL_IO_I2C_MEM_IC_FS_SCL_LCNT);
...
/**
  ...
  @param[in]        MmioBase    MMIO Base Address of specified I2C controller
  @param[in][out]   HsSclHcnt   Pointer to register union for R_SERIAL_IO_I2C_MEM_IC_HS_SCL_HCNT
  @param[in][out]   HsSclLcnt   Pointer to register union for R_SERIAL_IO_I2C_MEM_IC_HS_SCL_LCNT
  @param[in]        Frequency   Pointer to bus clock frequency (in kHz)
**/
VOID
SerialIoI2cGetHsScl (
...
{
  HsSclHcnt->Data32 = MmioRead32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_HS_SCL_HCNT);
  HsSclLcnt->Data32 = MmioRead32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_HS_SCL_LCNT);
  ...
  )
{
  ...
  InterruptStatus.Data32 = MmioRead32 (MmioBase + R_SERIAL_IO_I2C_MEM_IC_INTR_STAT);
