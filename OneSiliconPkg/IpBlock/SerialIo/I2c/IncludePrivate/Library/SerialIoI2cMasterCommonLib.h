/** @file
  SerialIo I2C Initiator Common Lib
...
#ifndef _SERIAL_IO_I2C_HOST_COMMON_LIB_H_
#define _SERIAL_IO_I2C_HOST_COMMON_LIB_H_
...
typedef struct {
  ...
  //
  // I2C Initiator mmio addresses cached to speed up operation
  //
  UINT64                          MmioAddress;
...
#endif // _SERIAL_IO_I2C_HOST_COMMON_LIB_H_
