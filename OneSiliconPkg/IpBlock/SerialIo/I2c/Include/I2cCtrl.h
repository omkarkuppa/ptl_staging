...
@par Specification
**/
#ifndef _SERIAL_IO_I2C_HANDLE_H_
#define _SERIAL_IO_I2C_HANDLE_H_
...
typedef struct {
  /**
    I2C controller PCI config space address
    in PCI Segment Library representation.
  **/
  UINT64                      PciCfgBaseAddr;
  /**
    I2C controller PCI Segment
  **/
  UINT8                       Segment;
  /**
    I2C controller PCI Bus
  **/
  UINT8                       Bus;
  /**
    I2C controller PCI Device
  **/
  UINT8                       Device;
  /**
    I2C controller PCI Function
  **/
  UINT8                       Function;
  /**
  ...
  **/
  ...
  REGISTER_ACCESS                *I2cPcrAccess;
} SERIAL_IO_I2C_CONTROLLER;

#endif // _SERIAL_IO_I2C_HANDLE_H_
