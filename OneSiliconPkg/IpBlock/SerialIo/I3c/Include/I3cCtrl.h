...
@par Specification
**/
#ifndef _SERIAL_IO_I3C_HANDLE_H_
#define _SERIAL_IO_I3C_HANDLE_H_
...
typedef struct {
  /**
    I3C controller PCI config space address
    in PCI Segment Library representation.
  **/
  UINT64                      PciCfgBaseAddr;
  /**
    I3C controller PCI Segment
  **/
  UINT8                       Segment;
  /**
    I3C controller PCI Bus
  **/
  UINT8                       Bus;
  /**
    I3C controller PCI Device
  **/
  UINT8                       Device;
  /**
    I3C controller PCI Function
  **/
  UINT8                       Function;
  ...
  **/
  ...
  REGISTER_ACCESS                *I3cPcrAccess;
} SERIAL_IO_I3C_CONTROLLER;

#endif // _SERIAL_IO_I3C_HANDLE_H_
