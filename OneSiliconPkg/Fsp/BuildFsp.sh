...
function USAGE()
{
  ...
  echo  "=========================================================================================================================================="
  echo  "= Usage:                                                                                                                                 ="
  echo  "=   BuildFsp.sh [package name] [platform name ^optional] [compiler name] [-r | -rp | -tr | -d] [-clean] [-header] [chksize <threshold>]  ="
  echo  "=               [fsp64] [fspsigned] [-h | -?]                                                                                            ="
  echo  "=========================================================================================================================================="
  echo  "=========================================================================================================================================="
  echo  "= Example build for PantherLakeFspPkg:                                                                                                   ="
  echo  "=   ./Intel/OneSiliconPkg/Fsp/BuildFsp.sh PantherLakeFspPkg GCC -d                                                                       ="
  echo  "=========================================================================================================================================="
