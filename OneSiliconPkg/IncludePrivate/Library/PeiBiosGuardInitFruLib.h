/** @file
  PEI Bios Guard Init FRU Lib header file
...
**/
#ifndef _PEI_BIOS_GUARD_INIT_FRU_LIB_H_
#define _PEI_BIOS_GUARD_INIT_FRU_LIB_H_
...
#endif //_PEI_BIOS_GUARD_INIT_FRU_LIB_H_
