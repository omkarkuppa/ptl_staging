...
DEFINE DSC_SIPKG_FEATURE_BUILD_OPTIONS = $(BDAT_BUILD_OPTION) $(DEBUG_BUILD_OPTIONS) $(RELEASE_CATALOG_BUILD_OPTIONS) $(PTLS_BUILD_OPTION) $(MAX_SOCKET_OPTION)
...
!if (gSiPkgTokenSpaceGuid.PcdSiCatalogDebugEnable == TRUE)
  *_VS2017_IA32_CC_PATH = $(PYTHON_COMMAND) $(REPLACECL_PATH)\ReplaceClTool.py VS2017_x86
  *_VS2017_X64_CC_PATH  = $(PYTHON_COMMAND) $(REPLACECL_PATH)\ReplaceClTool.py VS2017_x64

  *_VS2019_IA32_CC_PATH = $(PYTHON_COMMAND) $(REPLACECL_PATH)\ReplaceClTool.py VS2019_x86
  *_VS2019_X64_CC_PATH  = $(PYTHON_COMMAND) $(REPLACECL_PATH)\ReplaceClTool.py VS2019_x64
!endif
...
#
CLANGPDB:*_*_IA32_CC_FLAGS    = $(DSC_SIPKG_FEATURE_BUILD_OPTIONS) -D -Wno-enum-conversion -Wno-incompatible-pointer-types-discards-qualifiers -Wno-sometimes-uninitialized -Wno-braced-scalar-init -Wno-nonportable-include-path -Wno-misleading-indentation
GCC:   *_*_IA32_PP_FLAGS      = $(DSC_SIPKG_FEATURE_BUILD_OPTIONS)
MSFT:  *_*_IA32_ASM_FLAGS     = $(DSC_SIPKG_FEATURE_BUILD_OPTIONS)
MSFT:  *_*_IA32_CC_FLAGS      = $(DSC_SIPKG_FEATURE_BUILD_OPTIONS) $(OPTIMIZE_DISABLE_OPTIONS) -D /w34668
...
#
CLANGPDB:*_*_X64_CC_FLAGS     = $(DSC_SIPKG_FEATURE_BUILD_OPTIONS) -D -Wno-enum-conversion -Wno-main-return-type -Wno-incompatible-pointer-types -Wno-implicit-function-declaration -Wno-unused-variable -Wno-incompatible-pointer-types-discards-qualifiers -Wno-ignored-pragma-optimize -Wno-bitwise-op-parentheses  -Wno-sometimes-uninitialized -Wno-unused-function -Wno-misleading-indentation
