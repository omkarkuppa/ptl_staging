/** @file
  Core PostCodeMap implementation.
...
#include "CoreStatusCodesInternal.h"
#include <IntelRcStatusCode.h>

STATUS_CODE_TO_POST_CODE_MAP mCorePostCodeProgressMap[] = {
  //
  // PEI
  //
  //Regular boot
...
STATUS_CODE_TO_POST_CODE_MAP mCorePostCodeErrorMap[] = {
  //
  // PEI
  //
  //Regular boot
...
STATUS_CODE_TO_POST_CODE_MAP *mCorePostCodeStatusCodesMap[] = {
  //#define EFI_PROGRESS_CODE 0x00000001
  mCorePostCodeProgressMap,
  //#define EFI_ERROR_CODE 0x00000002
  mCorePostCodeErrorMap
...
/**
  Get Core PostCode from status code type and value.
  ...
  )
{
  ...
  if (CodeTypeIndex >= sizeof (mCorePostCodeStatusCodesMap) / sizeof(mCorePostCodeStatusCodesMap[0])) {
    return 0;
  }

  return FindCorePostCodeData (mCorePostCodeStatusCodesMap[CodeTypeIndex], Value);
}
