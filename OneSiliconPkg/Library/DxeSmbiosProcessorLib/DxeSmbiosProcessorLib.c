...
GLOBAL_REMOVE_IF_UNREFERENCED SMBIOS_TABLE_TYPE4 SmbiosTableType4Data = {
  ...
  TO_BE_FILLED,             ///< ProcessorManufacturer
  {                         ///< ProcessorId
    { TO_BE_FILLED },
    { TO_BE_FILLED }
  },
...
GLOBAL_REMOVE_IF_UNREFERENCED SMBIOS_TYPE4_STRING_ARRAY SmbiosTableType4Strings = {
  ...
  TO_BE_FILLED_STRING,      ///< ProcessorManufacturer
  ...
  )
{
  ...
  for (Hob.Raw = GetHobList (); !END_OF_HOB_LIST(Hob); Hob.Raw = GET_NEXT_HOB (Hob)) {
    if ((GET_HOB_TYPE (Hob) == EFI_HOB_TYPE_GUID_EXTENSION) && (CompareGuid (&Hob.Guid->Name, &gSmbiosProcessorInfoHobGuid))) {
      ...
      // For processor family enumerations from 100h to FFFDh, Processor Family has a value of FEh and
      // Processor Family 2 has the enumerated value.
      //
      if (ProcessorInfo->ProcessorFamily >= 0x100) {
        SmbiosTableType4Data.ProcessorFamily = 0xFE;
      } else {
        SmbiosTableType4Data.ProcessorFamily = (UINT8) ProcessorInfo->ProcessorFamily;
      }

      if (ProcessorInfo->ProcessorManufacturerStrIndex == 1) {
        SmbiosTableType4Strings.ProcessorManufacturer = (CHAR8 *)(ProcessorInfo + 1);
        SmbiosTableType4Data.ProcessorManufacturer = AssignStringNumber (SmbiosTableType4Strings.ProcessorManufacturer, &StringNumber);

        String1Size = AsciiStrSize ((CHAR8 *)(ProcessorInfo + 1)); // Size includes the trailing /0
        SmbiosTableType4Strings.ProcessorVersion = (CHAR8 *)(SmbiosTableType4Strings.ProcessorManufacturer + String1Size);
        ...
        String1Size = AsciiStrSize ((CHAR8 *)(ProcessorInfo + 1)); // Size includes the trailing /0
        SmbiosTableType4Strings.ProcessorManufacturer = (CHAR8 *)(SmbiosTableType4Strings.ProcessorVersion + String1Size);
        SmbiosTableType4Data.ProcessorManufacturer = AssignStringNumber(SmbiosTableType4Strings.ProcessorManufacturer, &StringNumber);
      } else {
        SmbiosTableType4Strings.ProcessorManufacturer = NULL;
        SmbiosTableType4Data.ProcessorManufacturer = 0;
      ...
      *(UINT8 *) &SmbiosTableType4Data.Voltage = ProcessorInfo->Voltage;
      ...
      SmbiosTableType4Data.MaxSpeed = ProcessorInfo->MaxSpeedInMHz;
