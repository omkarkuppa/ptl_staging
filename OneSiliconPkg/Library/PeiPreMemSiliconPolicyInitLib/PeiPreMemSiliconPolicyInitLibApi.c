/** @file
  This library initialize Silicon Policy for PreMemory in FSP API mode
...
{
/**
  The implementation of silicon policy initialization was moved to SiliconPolicyUpdatePreMemLoadDefaultUpd
  and gets called in SiliconPolicyUpdatePreMem in bootloader for FSP API mode due to package dependency.
**/
  Policy = NULL;
  return Policy;
}
