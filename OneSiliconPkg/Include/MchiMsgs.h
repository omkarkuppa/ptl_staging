...
typedef enum {
  ...
  McaStatusInvalidManifestInput                         = 0x3D,
  McaStatusVerifyWrongArbSvnConfiguration               = 0x44,
  ...
  McaStatusVerifyBrandEntitlementsWrongParam            = 0x62,
  McaStatusVerifyBrandEntitlementsDisabledByOemConfig   = 0x63,
  McaStatusVerifyBrandEntitlementsVproNotCapable        = 0x64,
  McaStatusVerifyBrandEntitlementsIcpsAndIcpsIcmEnabled = 0x65,
