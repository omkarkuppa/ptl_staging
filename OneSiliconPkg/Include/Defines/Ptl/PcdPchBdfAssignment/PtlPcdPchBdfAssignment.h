...
**/
#ifndef _PTLPCD_PCH_BDF_ASSIGNMENT_H_
#define _PTLPCD_PCH_BDF_ASSIGNMENT_H_
...
// SSE HECI #1
//
#define PCI_DEVICE_NUMBER_SOC_M_SSE_HECI1             24
#define PCI_FUNCTION_NUMBER_SOC_M_SSE_HECI1           0

//
// SSE HECI #2
//
#define PCI_DEVICE_NUMBER_SOC_M_SSE_HECI2             24
#define PCI_FUNCTION_NUMBER_SOC_M_SSE_HECI2           1

//
// SSE HECI #3
//
#define PCI_DEVICE_NUMBER_SOC_M_SSE_HECI3             24
#define PCI_FUNCTION_NUMBER_SOC_M_SSE_HECI3           2
...
#endif // _PTLPCD_PCH_BDF_ASSIGNMENT_H_
