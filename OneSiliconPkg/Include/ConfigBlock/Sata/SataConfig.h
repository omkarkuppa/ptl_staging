...
typedef struct {
  ...
  **/
  ...
  UINT32  RsvdBits0         :  4;                 ///< Reserved fields for future expansion w/o protocol change
  UINT32                    DevSlpGpioPinMux;     /// Muxed GPIO details. Refer GPIO_*_MUXING_SATA_DEVSLP_x*
...
typedef struct {
  ...
  **/
  ...
  UINT8                         LtrEnable;   ///< Latency Tolerance Reporting Mechanism , 0: Platform POR; 1: Enable; 2: Disable.
  UINT8                         TestLtrConfigLock;
  UINT8                         LtrOverride;
