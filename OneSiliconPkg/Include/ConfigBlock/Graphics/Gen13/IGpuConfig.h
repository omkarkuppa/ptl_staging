...
typedef struct {
  ...
  **/
  ...
  /**
    Offset 29
    Intel Gfx Support. It controls enabling/disabling IGPU device.
  ...
  **/
  ...
  UINT8                TestRsvd0[7];        ///< Offset 69 Reserved for 8 bytes alignment
...
typedef struct {
  ...
  UINT8        PeiGraphicsPeimInit;  ///< This policy is used to enable/disable Intel Gfx PEIM.<b>0- Disable</b>, 1- Enable
