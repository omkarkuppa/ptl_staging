...
#define PCH_PM_CONFIG_REVISION 4
extern EFI_GUID gPmConfigGuid;

#define BCLK_CONFIG_REVISION  1
extern EFI_GUID gBclkConfigGuid;
...
typedef struct {
  ...
  **/
  UINT32                  PsOnEnable                   :  1;
  /**
    Decide if CPPM Force Alignment is to be enabled. When enabled, PMC allows
  ...
  **/
  UINT32                  LatchEventsC10Exit           :  1;
    /**
    Enable/Disable PMC Watch Dog Timer. When this bit is set to 1,
    timers are enabled that can trigger a system reset.
    0: Disable; <b>1: Enable</b>.
  **/
  ...
  */
  ...
  /*
    Set true to enable Demoted (Dirty) Warm reset.
    <b>0: Disable</b>, 1: Enable
  */
  UINT32                  DirtyWarmResetEnable         : 1;
  /*
    Set true to enable CF9h Global Reset Lockdown.
    <b>0: Disable</b>, 1: Enable
  */
  UINT32                  Cf9LockdownEnable            : 1;
  UINT32                  Rsvdbits2                    : 28;
  ...
  */
  ...
  /**
    PMC Therm Timer Delay Register (THERM_TIMER_DELAY). Unit in us(microseconds).
    Adding delay time between CPU thermal trip propagating through PCH and PCH generating a Global Reset
    <b>Default is 500</b>
  **/
  UINT32                  ThermTimerDelay          :  10;
  UINT32                  PmErDebugMode            :  1;        ///< Energy Reporting Debug Mode
  UINT32                  Rsvdbits3                :  21;
} PCH_PM_CONFIG;

/**
  BCLK configuration. Only available on projects with SOC and CPU BCLK supported.
**/
typedef struct {
  CONFIG_BLOCK_HEADER     Header;  ///< Config Block Header
  ...
  /**
    ...
    <b>0: HW default</b>, 1: Force enable, 2: Force disable
  **/
  UINT8  SocBclkPllOn;
  /**
