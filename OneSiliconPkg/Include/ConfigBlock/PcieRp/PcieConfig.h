...
enum PCIE_COMPLETION_TIMEOUT {
  PcieCompletionTO_Default   = 0x00,
  PcieCompletionTO_50_100us  = 0x01,
  PcieCompletionTO_1_10ms    = 0x02,
  PcieCompletionTO_16_55ms   = 0x05,
  PcieCompletionTO_65_210ms  = 0x06,
  PcieCompletionTO_260_900ms = 0x09,
  PcieCompletionTO_1_3P5s    = 0x0A,
  PcieCompletionTO_4_13s     = 0x0D,
  PcieCompletionTO_17_64s    = 0x0E,
  PcieCompletionTO_Disabled  = 0x10
};
...
typedef struct {
  ...
  **/
  ...
  /**
    ASPM Optionality Compliance - This bit must be set to 1b in
    all Functions. Components implemented against certain earlier
    ...
    compliance tests.
  **/
  UINT32   AspmOptionalityCompliance;
