...
/**
  ...
  It contains SMI types of BiosWr, EcAssertedVw, and eSPI Initiator asserted SMIs
**/
struct _PCH_ESPI_SMI_DISPATCH_PROTOCOL {
  ...
  **/
  ...
  /**
    Register a SMI handler for Espi Peripheral
    ...
    (implementation specific for each Peripheral) in order to identify and service the cause.
    After servicing it, it has to clear the Peripherals' internal SMI# status registers
  **/
  PCH_ESPI_SMI_REGISTER   EspiPeripheralSmiRegister;
};
