...
typedef enum {
  ...
  EspiSerialIrq,        ///< eSPI Initiator Asserted SMI
...
typedef struct _ESPI_SMI_INSTANCE {
  ...
  ///
  /// This is an internal counter to track the number of eSPI initiator events have been registered.
