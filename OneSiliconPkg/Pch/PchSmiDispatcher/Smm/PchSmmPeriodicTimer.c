    ...
    {
      {
        ...
        S_ACPI_IO_SMI_STS,
        N_ACPI_IO_SMI_STS_PERIODIC_STS
      }
    },
    {
      {
    ...
    {
      {
        ...
        S_ACPI_IO_SMI_STS,
        N_ACPI_IO_SMI_STS_SWSMI_TMR_STS
      }
    },
    {
      {
  ...
  )
{
  ...
  if (mTimers[PERIODIC_TIMER].NumChildren > 0) {
    ...
    ///
    if (SrcDesc->Sts[0].Bit == N_ACPI_IO_SMI_STS_PERIODIC_STS) {
  ...
  if (mTimers[SWSMI_TIMER].NumChildren > 0) {
    ...
    ///
    if (SrcDesc->Sts[0].Bit == N_ACPI_IO_SMI_STS_SWSMI_TMR_STS) {
