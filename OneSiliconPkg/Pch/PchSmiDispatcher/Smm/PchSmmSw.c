  ...
  )
{
  ...
  //
  // Locate PI SMM CPU protocol each time when PchSwSmiDispatcher happen because
  // we need consider the SMM runtime updateable case, so need locate the new
  // mSmmCpuProtocol instance.
  //
