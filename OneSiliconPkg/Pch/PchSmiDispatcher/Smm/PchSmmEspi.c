...
GLOBAL_REMOVE_IF_UNREFERENCED ESPI_DESCRIPTOR mEspiDescriptor[EspiSmiTypeMax] = {
  ...
  //
  {
    ...
    //
    B_ESPI_CFG_ESPI_BC_BWPDS | B_ESPI_CFG_ESPI_BC_LE,
    B_ESPI_CFG_ESPI_BC_BWPDS | B_ESPI_CFG_ESPI_BC_LE,
    //
    // ClearStatusAndMask and ClearStatusOrMask
    //
    (UINT32) ~B_ESPI_CFG_ESPI_BC_BWRS,
    B_ESPI_CFG_ESPI_BC_BWPDS
  },
  //
  // BiosWrReport
  //
  {
    ...
    B_ESPI_CFG_ESPI_BC_BWRS | B_ESPI_CFG_ESPI_BC_BWRE,
    B_ESPI_CFG_ESPI_BC_BWRS | B_ESPI_CFG_ESPI_BC_BWRE,
    (UINT32) ~B_ESPI_CFG_ESPI_BC_BWPDS,
    B_ESPI_CFG_ESPI_BC_BWRS
  },
  //
  // PcNonFatalErr
  //
  {
    {
      PCR_ADDR_TYPE,
      {PCH_PCR_ADDRESS (PID_ESPISPI_DEPRECATED, R_ESPI_PCR_PCERR_SLV0) }
    },
    (B_ESPI_PCR_XERR_SLVX_XNFES | B_ESPI_PCR_XERR_SLVX_XNFEE),
    (B_ESPI_PCR_XERR_SLVX_XNFES | (V_ESPI_PCR_XERR_SLVX_XNFEE_SMI << N_ESPI_PCR_XERR_SLVX_XNFEE)),
    (UINT32) ~(B_ESPI_PCR_PCERR_SLV0_PCURD | B_ESPI_PCR_XERR_SLVX_XFES),
    B_ESPI_PCR_XERR_SLVX_XNFES
  },
  //
  // PcFatalErr
  //
  {
    ...
    (B_ESPI_PCR_XERR_SLVX_XFES | B_ESPI_PCR_XERR_SLVX_XFEE),
    (B_ESPI_PCR_XERR_SLVX_XFES | (V_ESPI_PCR_XERR_SLVX_XFEE_SMI << N_ESPI_PCR_XERR_SLVX_XFEE)),
    (UINT32) ~(B_ESPI_PCR_PCERR_SLV0_PCURD | B_ESPI_PCR_XERR_SLVX_XNFES),
    B_ESPI_PCR_XERR_SLVX_XFES
  },
  //
  // VwNonFatalErr
  //
  {
    {
      PCR_ADDR_TYPE,
      {PCH_PCR_ADDRESS (PID_ESPISPI_DEPRECATED, R_ESPI_PCR_VWERR_SLV0) }
    },
    (B_ESPI_PCR_XERR_SLVX_XNFES | B_ESPI_PCR_XERR_SLVX_XNFEE),
    (B_ESPI_PCR_XERR_SLVX_XNFES | (V_ESPI_PCR_XERR_SLVX_XNFEE_SMI << N_ESPI_PCR_XERR_SLVX_XNFEE)),
    (UINT32) ~B_ESPI_PCR_XERR_SLVX_XFES,
    B_ESPI_PCR_XERR_SLVX_XNFES
  },
  //
  // VwFatalErr
  //
  {
    ...
    (B_ESPI_PCR_XERR_SLVX_XFES | B_ESPI_PCR_XERR_SLVX_XFEE),
    (B_ESPI_PCR_XERR_SLVX_XFES | (V_ESPI_PCR_XERR_SLVX_XFEE_SMI << N_ESPI_PCR_XERR_SLVX_XFEE)),
    (UINT32) ~B_ESPI_PCR_XERR_SLVX_XNFES,
    B_ESPI_PCR_XERR_SLVX_XFES
  },
  //
  // FlashNonFatalErr
  //
  {
    {
      PCR_ADDR_TYPE,
      {PCH_PCR_ADDRESS (PID_ESPISPI_DEPRECATED, R_ESPI_PCR_FCERR_SLV0) }
    },
    (B_ESPI_PCR_XERR_SLVX_XNFES | B_ESPI_PCR_XERR_SLVX_XNFEE),
    (B_ESPI_PCR_XERR_SLVX_XNFES | (V_ESPI_PCR_XERR_SLVX_XNFEE_SMI << N_ESPI_PCR_XERR_SLVX_XNFEE)),
    (UINT32) ~B_ESPI_PCR_XERR_SLVX_XFES,
  ...
  //
  {
    {
      PCR_ADDR_TYPE,
      {PCH_PCR_ADDRESS (PID_ESPISPI_DEPRECATED, R_ESPI_PCR_LNKERR_SLV0) }
    },
  ...
  switch (EspiSmiType) {
    ...
    case BiosWrReport:
      ...
      PciSegmentAndThenOr32 (
        PciBaseAddress + R_ESPI_CFG_ESPI_BC,
        (UINT32) ~(B_ESPI_CFG_ESPI_BC_BWRS | B_ESPI_CFG_ESPI_BC_BWPDS),
        B_ESPI_CFG_ESPI_BC_BWRE
        );
      break;
    case PcNonFatalErr:
      PchPcrAndThenOr32 (
        PID_ESPISPI_DEPRECATED,
        (UINT16) R_ESPI_PCR_PCERR_SLV0,
        (UINT32) ~(B_ESPI_PCR_PCERR_SLV0_PCURD | B_ESPI_PCR_XERR_SLVX_XNFES | B_ESPI_PCR_XERR_SLVX_XFES),
        B_ESPI_PCR_XERR_SLVX_XNFEE
        );
      break;
  ...
  )
{
  ...
  switch (EspiSmiType) {
    ...
    case BiosWrReport:
      //
      // Skip this ASSERT in Mm Runtime Update progress, because the SMI will be registered again
    ...
    case PcNonFatalErr:
      PchPcrAndThenOr32 (
        PID_ESPISPI_DEPRECATED,
        (UINT16) R_ESPI_PCR_PCERR_SLV0,
        (UINT32) ~(B_ESPI_PCR_PCERR_SLV0_PCURD | B_ESPI_PCR_XERR_SLVX_XNFES | B_ESPI_PCR_XERR_SLVX_XFES | B_ESPI_PCR_XERR_SLVX_XNFEE),
        0
        );
      break;
    ...
    case PcFatalErr:
      PchPcrAndThenOr32 (
        PID_ESPISPI_DEPRECATED,
        (UINT16) R_ESPI_PCR_PCERR_SLV0,
        (UINT32) ~(B_ESPI_PCR_PCERR_SLV0_PCURD | B_ESPI_PCR_XERR_SLVX_XNFES | B_ESPI_PCR_XERR_SLVX_XFES | B_ESPI_PCR_XERR_SLVX_XFEE),
        0
        );
      break;
    ...
    case VwNonFatalErr:
      PchPcrAndThenOr32 (
        PID_ESPISPI_DEPRECATED,
        (UINT16) R_ESPI_PCR_VWERR_SLV0,
        (UINT32) ~(B_ESPI_PCR_XERR_SLVX_XNFES | B_ESPI_PCR_XERR_SLVX_XFES | B_ESPI_PCR_XERR_SLVX_XNFEE),
        0
        );
      break;
    ...
    case VwFatalErr:
      PchPcrAndThenOr32 (
        PID_ESPISPI_DEPRECATED,
        (UINT16) R_ESPI_PCR_VWERR_SLV0,
        (UINT32) ~(B_ESPI_PCR_XERR_SLVX_XNFES | B_ESPI_PCR_XERR_SLVX_XFES | B_ESPI_PCR_XERR_SLVX_XFEE),
        0
        );
      break;
...
// EspiDevice srcdesc
//
GLOBAL_REMOVE_IF_UNREFERENCED CONST PCH_SMM_SOURCE_DESC mSrcDescEspiDevice = {
  PCH_SMM_NO_FLAGS,
  {
    {
      {
  ...
  {
    {
      ...
      S_ACPI_IO_SMI_STS,
      N_ACPI_IO_SMI_STS_ESPI_SMI_STS
    }
  },
  {
    {
...
/**
  ...
  the SMI handler itself needs to inspect all the eSPI devices' interrupt status registers
  ...
  )
{
  ...
  Status = PchSmiRecordInsert (
             ...
             PchEspiSmiEspiDeviceType,
             DispatchHandle
             );
  PchSmmClearSource (&mSrcDescEspiDevice);
  PchSmmEnableSource (&mSrcDescEspiDevice);
  ...
  )
{
  ...
  ESPI_TOP_LEVEL_TYPE EspiTopLevelType;
  ESPI_SMI_TYPE       EspiSmiType;
  ESPI_SMI_TYPE       EspiSmiTypeToUnregister;
  ...
  for (EspiSmiType = 0; EspiSmiType < EspiSmiTypeMax; ++EspiSmiType) {
    ...
    while (!IsNull (&mEspiSmiInstance.CallbackDataBase[EspiSmiType], LinkInDb)) {
      if (LinkInDb != (LIST_ENTRY *) DispatchHandle) {
        ...
        SmiHandlerProfileUnregisterHandler (&gPchEspiSmiDispatchProtocolGuid, (EFI_SMM_HANDLER_ENTRY_POINT2)RecordPointer->Callback, NULL, 0);
...
EspiSmiUnRegisterEnd:
  EspiSmiTypeToUnregister = EspiSmiType;
  ...
  for (EspiTopLevelType = 0; EspiTopLevelType < EspiTopLevelTypeMax; ++EspiTopLevelType) {
    ...
    //
    // Only check the top level PchSmiDispatch handle that the chlid handle belongs to.
    //
    if (EspiSmiTypeToUnregister < mEspiSmiInstance.Barrier[EspiTopLevelType].Start ||
        EspiSmiTypeToUnregister > mEspiSmiInstance.Barrier[EspiTopLevelType].End) {
      continue;
    }
...
/**
  ...
  @param[in]  DeviceId                Target ID of which channel is to be reset
  @param[in]  ChannelBaseAddress      Base address
  @param[in]  ChannelNumber           Channel number (0 for PC, 1 for VW, 2 for OOB, 3 for FA)
**/
VOID
CheckDeviceChannelErrorAndReset (
  ...
  )
{
  ...
  if (!IsEspiDeviceChannelSupported (DeviceId, ChannelNumber, (REGISTER_ACCESS *) &EspiPcrAccess)) {
    DEBUG ((DEBUG_WARN, "Channel %d is not supported by Target device\n", ChannelNumber));
    return;
  }

  // Calculate channel address based on Target id (different spacing for CS#2 and up)
  if (DeviceId < EspiDeviceCS2) {
    ChannelAddress = (UINT16) (ChannelBaseAddress + (DeviceId * S_ESPI_PCR_XERR_SLVX));
  } else {
    // Subtracting 2 from DeviceId so the offset is calculated correctly and not increased too much
    ChannelAddress = (UINT16) (ChannelBaseAddress + ((DeviceId - 2) * S_ESPI_PCR_XERR_SLV_EXT_X));
  }

  // Reading channel error register data
  Data32 = PchPcrRead32 (PID_ESPISPI_DEPRECATED, ChannelAddress);
  ...
  if ((Data32 & B_ESPI_PCR_XERR_SLVX_XFES) != 0) {
    Status = PchEspiDeviceChannelReset (DeviceId, ChannelNumber, (REGISTER_ACCESS *) &EspiPcrAccess);
  ...
  )
{
  ...
  for (DeviceId = EspiDeviceCS0; DeviceId < PCH_MAX_ESPI_DEVICES; DeviceId++) {
    //
    // Check if device is enabled in straps
    //
    if (!IsEspiDeviceSupported (DeviceId, (REGISTER_ACCESS *)&EspiPcrAccess)) {
      continue;
    }

    //
    // Check if Target has SLCRR bit set. If it does it means it needs recovery.
    // For CS#2 and up different spacing of registers
    //
    if (DeviceId < EspiDeviceCS2) {
      RegisterOffset = (UINT16) (R_ESPI_PCR_LNKERR_SLV0 + (DeviceId * S_ESPI_PCR_XERR_SLVX));
    } else {
      // Subtracting 2 from DeviceId so the offset is calculated correctly and not increased too much
      RegisterOffset = (UINT16) (R_ESPI_PCR_LNKERR_SLV_EXT_2 + ((DeviceId - 2) * S_ESPI_PCR_XERR_SLV_EXT_X));
    }
    Data32 = PchPcrRead32 (PID_ESPISPI_DEPRECATED, RegisterOffset);
    ...
    if ((Data32 & B_ESPI_PCR_LNKERR_SLV0_SLCRR) != 0) {
      ...
      PchEspiDeviceInBandReset (DeviceId, (REGISTER_ACCESS *) &EspiPcrAccess);

      // 2. Channels reset (different registers base offsets for CS#2 and up)
      if (DeviceId < EspiDeviceCS2) {
        CheckDeviceChannelErrorAndReset (DeviceId, R_ESPI_PCR_PCERR_SLV0, 0); // Peripheral channel reset
        CheckDeviceChannelErrorAndReset (DeviceId, R_ESPI_PCR_VWERR_SLV0, 1); // Virtual Wire channel reset
      } else {
        CheckDeviceChannelErrorAndReset (DeviceId, R_ESPI_PCR_PCERR_SLV_EXT_2, 0); // Peripheral channel reset
        CheckDeviceChannelErrorAndReset (DeviceId, R_ESPI_PCR_VWERR_SLV_EXT_2, 1); // Virtual Wire channel reset
      }

      // Flash Access channel is only supported on CS#0
      if (DeviceId == 0) {
        CheckDeviceChannelErrorAndReset (DeviceId, R_ESPI_PCR_FCERR_SLV0, 3); // Flash Access channel reset
      }
