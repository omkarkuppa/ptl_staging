  ...
  )
{
  ...
  if (!SciEn) {
    //
    // Clear SWGPE_CTRL and SWGPE_EN in case they are not handled.
    //
    IoAnd32 ((UINTN) mABase + R_ACPI_IO_GPE_CTRL, (UINT32) ~B_ACPI_IO_GPE_CTRL_SWGPE_CTRL);
    IoAnd32 ((UINTN) mABase + R_ACPI_IO_GPE0_EN_127_96, (UINT32) ~(LShiftU64 (1, N_ACPI_IO_GPE0_EN_127_96_SWGPE_EN)));
    //
    ...
    IoWrite32 (
      ...
      (UINT32)( B_ACPI_IO_GPE0_STS_127_96_USB_CON_DSX_STS |
                B_ACPI_IO_GPE0_STS_127_96_LANWAKE_STS |
                B_ACPI_IO_GPE0_STS_127_96_PME_B0_STS |
    ...
    //
    IoAnd32 ((UINTN) mABase + R_ACPI_IO_GPE0_EN_127_96, (UINT32) ~B_ACPI_IO_GPE0_EN_127_96_WADT_EN);
  }

  IoWrite32 ((UINTN) mABase + R_ACPI_IO_DEVTRAP_STS, 0x0000FFFF);
  ...
  //
  Data |= B_ACPI_IO_SMI_EN_GBL_SMI_EN | B_ACPI_IO_SMI_EN_APMC_EN;
  //
