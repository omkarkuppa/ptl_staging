  ...
  )
{
  ...
  LpcIoDecondeRangeSet = (UINT16) MmioRead16 (LpcBaseAddr + R_ESPI_CFG_ESPI_IOD_IOE);
  LpcIoDecoodeSet = (UINT16) MmioRead16 (LpcBaseAddr + R_ESPI_CFG_ESPI_IOE);
  MmioWrite16 ((LpcBaseAddr + R_ESPI_CFG_ESPI_IOD_IOE), (LpcIoDecondeRangeSet | ((V_ESPI_CFG_ESPI_IOD_IOE_CB_2F8 << N_ESPI_CFG_ESPI_IOD_IOE_CB) | V_ESPI_CFG_ESPI_IOD_IOE_CA_3F8)));
  MmioWrite16 ((LpcBaseAddr + R_ESPI_CFG_ESPI_IOE), (LpcIoDecoodeSet | (V_ESPI_CFG_ESPI_IOE_SE | V_ESPI_CFG_ESPI_IOE_CBE | V_ESPI_CFG_ESPI_IOE_CAE|V_ESPI_CFG_ESPI_IOE_KE)));
