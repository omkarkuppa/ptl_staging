...
# Build option for PTL SOC Core Boot
...
DEFINE DSC_SIPKG_FEATURE_BUILD_OPTIONS = $(BDAT_BUILD_OPTION) $(DEBUG_BUILD_OPTIONS) $(RELEASE_CATALOG_BUILD_OPTIONS) $(MAX_SOCKET_OPTION)
