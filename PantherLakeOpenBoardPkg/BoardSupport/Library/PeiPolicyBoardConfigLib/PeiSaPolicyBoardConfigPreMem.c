  ...
  )
{
  ...
  COMPARE_AND_UPDATE_POLICY (((FSPM_UPD *) FspmUpd)->FspmConfig.DdrFreqLimit, MemConfig->ExternalInputs.DdrFreqLimit,    0);
  ...
  ///
  UPDATE_POLICY (((FSPS_UPD *) FspsUpd)->FspsConfig.VtdDisable, VtdConfig->VtdDisable, 1);
