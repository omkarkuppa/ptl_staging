 ...
 )
{
  ...
  ReadNvmEerd (Hw, IGC_FLASH_SIZE_WORD, &Size, TRUE);
  Size &= IGC_FLASH_SIZE_MASK;
  if (Size == IGC_FLASH_SIZE_BIT_1M) {
    return IGC_SHARED_FLASH_1M;
  }
  else if (Size == IGC_FLASH_SIZE_BIT_2M) {
    return IGC_SHARED_FLASH_2M;
  }
  else {
    return IGC_UNKOWN_FLASH_SIZE;
  }
}
 ...
 )
{
  ...
  if (ModuleOffset != NULL) {
    ...
    else if (Module == IGC_FLASH_MODULE_EMP_IMAGE)
    {
      ...
      if (FlashSize > IGC_SHARED_FLASH_1M) {
 ...
 )
{
  ...
  do {
    ...
    {
      /* Do not override some  of the offests since
 ...
 )
{
  ...
  Status = ReadNvmEerd (Hw, IGC_DEV_STARTER_WORD, NVMVersion, TRUE);
...
/**
  ...
  are not segnificant and this needs to be considered as a black box.
 ...
 )
{
  ...
  DEBUG ((DEBUG_INFO, "Enter IgcResetPHWFW\n"));
