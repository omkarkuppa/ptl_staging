...
Device (HDC2)
{
  ...
  } // If HDAC_I2S_ALC5682I_VD
  If ( LOr(LEqual(I2SC, HDAC_I2S_EVEREST8326), LOr(LEqual(I2SC, HDAC_I2S_EVEREST8316), LEqual(I2SC, HDAC_I2S_EVEREST8336))) ) {
     Device(ESSX)
     {
       ...
       Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
       {
         ...
         ElseIf (LEqual(I2SC, HDAC_I2S_EVEREST8326))
         {
           Name (SBF2, ResourceTemplate () {
             I2cSerialBusV2 (0x18, ControllerInitiated, 0x00061A80, AddressingMode7Bit, "\\_SB.PC00.I2C3", 0x00, ResourceConsumer, ISBB, Exclusive,)
           })

           CreateWordField (SBF2, ISBB._ADR, SBSA)
           Store(EVSA, SBSA)
       ...
       Method (_DSM, 4, NotSerialized)  // _DSM: Device-Specific Method
       {
         If ((Arg0 == ToUUID ("A9800C04-E016-343E-41F4-6BCCE70F4332")))
         {
           ...
           If ((Arg2 == EVEREST_I2S_BUS_NUMBER))
           {
             ...
             Return (EVEREST_PTL_I2S1_BUS_NUMBER)
           }
