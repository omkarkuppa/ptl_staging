...
{
  Store ("[PTL UH LP5 AEP RTD3 SSDT][AcpiTableEntry]", Debug)
  Store (Timer, Debug)
  ACPI_DEBUG_EXTERNAL_REFERENCE
  ADBG ("[PTL UH LP5 AEP RTD3 SSDT][AcpiTableEntry]")
  ...
  //
  // PCIE RTD3 RP 03 - Bayhub uSD controller (BH770GG7)
  //
  If (CondRefOf (P1RN)) {
    If (LEqual (P1RN ,0x3)) {
  ...
  ADBG ("[PTL UH LP5 AEP RTD3 SSDT][AcpiTableExit]")
  Store ("[PTL UH LP5 AEP RTD3 SSDT][AcpiTableExit]", Debug)
  Store (Timer, Debug)
} // End SSDT
