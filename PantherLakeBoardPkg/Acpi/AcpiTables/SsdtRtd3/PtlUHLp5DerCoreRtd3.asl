/** @file
  Intel Derivative Core Board RTD3 code
...
{
  Store ("[PTL UH LP5 Derivative Core Board RTD3 SSDT][AcpiTableEntry]", Debug)
  Store (Timer, Debug)
  ACPI_DEBUG_EXTERNAL_REFERENCE
  ADBG ("[PTL UH LP5 Derivative Core Board RTD3 SSDT][AcpiTableEntry]")
  ...
  ADBG ("[PTL UH LP5 Derivative Core Board RTD3 SSDT][AcpiTableExit]")
  Store ("[PTL UH LP5 Derivative Core Board RTD3 SSDT][AcpiTableExit]", Debug)
  Store (Timer, Debug)
} // End SSDT
