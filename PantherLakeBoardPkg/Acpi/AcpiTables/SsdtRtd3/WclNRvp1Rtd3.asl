...
// |   RP06    |   x1   | Gbe / CEM Slot / WWAN (M.2)              |   5     |  No           |
// __________________________________________________________________________________________|
//
  Store ("[Wcl N Rvp1 RTD3 SSDT][AcpiTableEntry]", Debug)
  Store (Timer, Debug)
  ...
  ADBG ("[Wcl N Rvp2 RTD3 SSDT][AcpiTableEntry]")
  ...
  Store ("[Wcl N Rvp1 RTD3 SSDT][AcpiTableExit]", Debug)
  Store (Timer, Debug)
} // End SSDT
