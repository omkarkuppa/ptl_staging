/** @file
  Header file for Platform wrapper library for handling GPIO access with different
...
**/
#ifndef _PLATFORM_GPIOV2_WRAPPER_LIB_H_
#define _PLATFORM_GPIOV2_WRAPPER_LIB_H_
...
#endif // _PLATFORM_GPIOV2_WRAPPER_LIB_H_
