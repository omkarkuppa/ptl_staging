...
#####################################################################
#  PTL UH LP5x Aep
#     Board ID: 0x07 (BoardIdPtlUHLp5Aep)
#     Bom ID  : 0x01 (BomIdPtlUHLp5Aep)
#   Display ID: 0x00
#       SKU ID: 0x00010007 (SkuIdPtlUHLp5AepBom)
#####################################################################
[PcdsDynamicExVpd.common.SkuIdPtlUHLp5AepBom]
...
# uSD Card RTD3
  ...
  // Connectable,   Visibility, ConnectorType, UsbOcPinType, UsbOcPin, Usb2Controller, Usb2PortNum, Usb3Controller, Usb3PortNum
    ...
    {CONNECTABLE,   INVISIBLE,  0x00,          0,            0,        PCH_USB2,       PORT4,       0,              0    }, // Altek
  ...
  gBoardModuleTokenSpaceGuid.VpdPcdBoardRtd3TableSignature|*|{'P', 't', 'l', 'U', 'H', 'A', 'e', 'p'}
  ...
  // uSD card
  //
    {GPIOV2_PTL_PCD_XXGPP_A_8,   {GpioV2PadModeGpio,   GpioV2HostOwnAcpi,    GpioV2DirOut,    GpioV2StateHigh,    GpioV2IntDis,                 GpioV2ResetHost,      GpioV2TermDefault}}, // GPP_A8_SD_PWR_EN
    {GPIOV2_PTL_PCD_XXGPP_A_12,  {GpioV2PadModeGpio,   GpioV2HostOwnAcpi,    GpioV2DirInInv,  GpioV2StateDefault, GpioV2IntLevel|GpioV2IntSci,  GpioV2ResetDefault,  GpioV2TermDefault,  GpioV2Unlock,  GpioV2Lock}},  // SD_CARD_PRSNT_N
  ...
  // Audio
  //
    {GPIOV2_PTL_PCD_XXGPP_E_7,  {GpioV2PadModeGpio, GpioV2HostOwnAcpi, GpioV2DirOut,  GpioV2StateHigh,    GpioV2IntDis,  GpioV2ResetHost,  GpioV2TermDefault}},  // GPP_E7_BEEP_RST
    {GPIOV2_PTL_PCD_XXGPP_E_19, {GpioV2PadModeGpio, GpioV2HostOwnAcpi, GpioV2DirOut,  GpioV2StateHigh,    GpioV2IntDis,  GpioV2ResetHost,  GpioV2TermDefault}},  // GPP_E19_HS_CODEC_EN
  ...
  gBoardModuleTokenSpaceGuid.VpdPcdMrcSpdData|*|{CODE(
  {
    ...
    // Non-Monolithic DRAM Device, 2 dies, 2 Channels per package
     ...
     {0x23,                                 ///< 0   384 SPD bytes used, 512 total
      ...
      0x08,                                 ///< 18  tCKAVGmin =  1.067 ns (LPDDR5X-7500 4:1)
      ...
      0x00, 0x00, 0x00, 0x00, 0x00,         ///< 329 - 333 Module Part Number: Unused bytes coded as ASCII Blanks (0x20)
      0x00, 0x00, 0x00, 0x00, 0x00,         ///< 334 - 338 Module Part Number
      0x00, 0x00, 0x00, 0x00, 0x00,         ///< 339 - 343 Module Part Number
  ...
  //
  // PTL-H AEP DQS byte swizzling between CPU and DRAM
  //
  // Ch 0     1         2         3
...
[PcdsDynamicHii.common.SkuIdPtlUHLp5AepBom.STANDARD, PcdsDynamicHii.common.SkuIdPtlUHLp5AepBom32Gb.STANDARD]
  ...
  gStructPcdTokenSpaceGuid.PcdSetup.PowermeterDeviceEnable|0x1                                       # Enable PowerMeter
  gStructPcdTokenSpaceGuid.PcdSetup.TelemetryDeviceEnable|0x1                                        # Enable Telemetry

#####################################################################
#  PTL UH LP5x AEP MEM 32GB
#     Board ID: 0x07
#     Bom ID: 0x02 (BomIdPtlUHLp5Aep32Gb)
#   Display ID: 0x00
#       SKU ID: 0x00020007 (SkuIdPtlUHLp5AepBom32Gb)
#####################################################################
[PcdsDynamicExVpd.common.SkuIdPtlUHLp5AepBom32Gb]
...
#####################################################################
#  PTL UH LP5x AEP MEM 64GB 9600 Speed
#     Board ID: 0x07
#     Bom ID: 0x00
#   Display ID: 0x00
#       SKU ID: 0x00000007 (SkuIdPtlUHLp5Aep)
#####################################################################
[PcdsDynamicExVpd.common.SkuIdPtlUHLp5Aep]
  ...
  gBoardModuleTokenSpaceGuid.VpdPcdMrcSpdData|*|{CODE(
  {
    ...
    // Non-Monolithic DRAM Device, 2 dies, 2 Channels per package
     ...
     {0x23,                                 ///< 0   384 SPD bytes used, 512 total
      ...
      0x00,                                 ///< 10  Reserved
      0x00,                                 ///< 11  Module Nominal Voltage: Reserved
      0x09,                                 ///< 12  Module Organization: 2 Rank, x16 Device Width per Channel
      0x01,                                 ///< 13  Module Memory Bus width: 1 Channels, 16 bits channel width, no ECC
      0x00,                                 ///< 14  Module Thermal Sensor: none
      0x00,                                 ///< 15  Extended Module Type: Reserved
      0x00,                                 ///< 16  Signal Loading: Data/Strobe/Mask: 2 loads, CAC: 2 loads, CS: 1 load
