...
#####################################################################
#  PTL UH LP5x T3 - mRVP
#     Board ID: 0x05 (BoardIdPtlUHLp5MemSktmRvp)
#   Display ID: 0x00
#       SKU ID: 0x00000005 (SkuIdPtlUHLp5MemSktmRvp)
#####################################################################
[PcdsDynamicExVpd.common.SkuIdPtlUHLp5MemSktmRvp]
  ...
  # MRC BoardStackUp
  gBoardModuleTokenSpaceGuid.VpdPcdMrcBoardStackUp|*|0x0 # this means no speed limit to 7467
  ...
  gBoardModuleTokenSpaceGuid.VpdPcdM2Ssd1PowerEnableGpio|*|{CODE(
   { GPIOV2_PTL_PCD_XXGPP_B_10 }  // GEN4_SSD_PWREN
  )}
  gBoardModuleTokenSpaceGuid.VpdPcdM2Ssd1RstGpio|*|{CODE(
   { GPIOV2_PTL_PCD_XXGPP_B_9 }  // M2_GEN4_SSD_RESET_N
  )}
  ...
  gBoardModuleTokenSpaceGuid.VpdPcdGpioLidStatus|*|{CODE(
   { GPIOV2_PTL_PCD_XXGPP_F_23 }  // SMC_LID
  )}
  ...
  // TCSS
  //
    {GPIOV2_PTL_PCD_XXGPP_A_11, {GpioV2PadModeGpio, GpioV2HostOwnGpio, GpioV2DirNone, GpioV2StateDefault, GpioV2IntDefault, GpioV2ResetResume,  GpioV2TermNone}}, // TCP_RT_S0IX_ENTRY_EXIT_N
  ...
  //
    ...
    {GPIOV2_PTL_PCD_XXGPP_V_17, {GpioV2PadModeGpio, GpioV2HostOwnGpio, GpioV2DirNone, GpioV2StateDefault, GpioV2IntDefault, GpioV2ResetDefault, GpioV2TermNone}}, // NC
  ...
  {{  5,   6,   7,  4,  2,  3,  1,  0  },   // Byte 6
   {  11,  8,   10, 9,  15, 12, 14, 13 }},  // Byte 7

  //Controller 1
  {{  2,   1,   3,  0,  5,  7,  4,  6  },   // Byte 0
   {  15,  14,  12, 13, 9,  11, 10, 8  }},  // Byte 1
  {{  5,   6,   4,  7,  1,  2,  0,  3  },   // Byte 2
   {  9,   10,  11, 8,  13, 14, 12, 15 }},  // Byte 3
...
[PcdsDynamicHii.common.SkuIdPtlUHLp5MemSktmRvp.STANDARD]
