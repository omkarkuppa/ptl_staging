...
#####################################################################
#  PTL UH LP5x T4 - RVP3
#     Board ID: 0x03 (BoardIdPtlUHLp5Rvp3)
#   Display ID: 0x00
#       SKU ID: 0x00000003 (SkuIdPtlUHLp5Rvp3)
#####################################################################
[PcdsDynamicExVpd.common.SkuIdPtlUHLp5Rvp3]
  ...
  gBoardModuleTokenSpaceGuid.VpdPcdM2Ssd1PowerEnableGpio|*|{CODE(
   { GPIOV2_PTL_PCD_XXGPP_B_11 } // GEN4_SSD_PWREN
  )}
  gBoardModuleTokenSpaceGuid.VpdPcdM2Ssd1RstGpio|*|{CODE(
   { GPIOV2_PTL_PCD_XXGPP_E_8 } // M2_GEN4_SSD_RESET_N
  )}
  ...
  // ModularIoSupported, EdpModularIoSupported, RetimerCount, PcieSupported, DpAltModeSupported, Usb4Supported, Tbt3Supported, PdNum,    AuxDpMode, TbtControllerType, TbtControllerNum, DmaPortNum, PcieType, PcieRootPortNum
    ...
    {FIXED_IO,           0,                     1,            1,             1,                  1,             1,             USBC_PD3, 0,         ITBT_DMA,          TBT_CONTROLLER2,  DMA_PORT1,  0,        0}, // TCP2
    {FIXED_IO,           0,                     1,            1,             1,                  1,             1,             USBC_PD3, 0,         ITBT_DMA,          TBT_CONTROLLER2,  DMA_PORT2,  0,        0}, // TCP3
    {0x0}  // terminator
  })}
  ...
  // M.2 SSD Gen4
  //
    {GPIOV2_PTL_PCD_XXGPP_B_11,   {GpioV2PadModeGpio, GpioV2HostOwnAcpi,    GpioV2DirOut,    GpioV2StateHigh,     GpioV2IntDis,      GpioV2ResetHost,  GpioV2TermDefault}}, // M2_GEN4_SSD_PWR_DIS
    {GPIOV2_PTL_PCD_XXGPP_E_8,    {GpioV2PadModeGpio, GpioV2HostOwnAcpi,    GpioV2DirOut,    GpioV2StateHigh,    GpioV2IntDis,      GpioV2ResetHost,  GpioV2TermDefault}},  // M2_GEN4_SSD_RESET_N
  ...
  //
  // PTL-UH LPDDR5x T4 DQS byte swizzling between CPU and DRAM
  //
  // Ch 0     1         2         3
  ...
  //
  // PTL-UH Lp5x T4 DQ bit swizzling between CPU and DRAM
  //

  //Controller 0
   {{ 10, 8,  11, 9,  15, 12, 14, 13 },  // Byte 0
   {  6,  7,  5,  4,  3,  1,  0,  2  }}, // Byte 1
  {{  1,  0,  3,  2,  7,  6,  5,  4  },  // Byte 2
   {  14, 13, 12, 15, 11, 9,  8,  10 }}, // Byte 3
  {{  13, 14, 12, 15, 8,  10, 9,  11 },  // Byte 4
   {  6,  7,  5,  4,  1,  3,  2,  0  }}, // Byte 5
  {{  6,  5,  7,  4,  3,  2,  0,  1  },  // Byte 6
   {  14, 13, 12, 15, 11, 9,  8,  10 }}, // Byte 7

  //Controller 1
  {{  10, 8,  9,  11, 13, 12, 14, 15 },  // Byte 0
   {  1,  3,  0,  2,  4,  7,  5,  6  }}, // Byte 1
  {{  1,  0,  2,  3,  7,  6,  5,  4  },  // Byte 2
   {  10, 8,  11, 9,  13, 12, 14, 15 }}, // Byte 3
  {{  10, 8,  11, 9,  13, 12, 14, 15 },  // Byte 4
   {  6,  5,  7,  4,  0,  1,  2,  3  }}, // Byte 5
  {{  1,  0,  2,  3,  7,  4,  6,  5  },  // Byte 6
   {  14, 13, 15, 12, 10, 11, 9,  8  }}  // Byte 7
  }})}
  ...
  gBoardModuleTokenSpaceGuid.VpdPcdBoardGpioTablePreMem|*|{CODE({
    ...
    // TCSS
    //
    // If not added in Pre Mem Table, it may lead to incorrect GPIO programming to GPP_D1 when eDP module is attached to TCP0
    {GPIOV2_PTL_PCD_XXGPP_D_1,  {GpioV2PadModeGpio, GpioV2HostOwnAcpi, GpioV2DirOut,  GpioV2StateHigh,   GpioV2IntDis,  GpioV2ResetHostDeep,  GpioV2TermDefault}}, // MOD_TCSS2_TYP_A_VBUS_EN_EDP_BKLT_EN
    {GPIOV2_PTL_PCD_XXGPP_F_11, {GpioV2PadModeGpio, GpioV2HostOwnAcpi, GpioV2DirOut,  GpioV2StateHigh,   GpioV2IntDis,  GpioV2ResetHostDeep,  GpioV2TermDefault}}, // MOD_TCSS1_TYP_A_VBUS_EN
    {0x0}  // terminator
  })}
...
[PcdsDynamicHii.common.SkuIdPtlUHLp5Rvp3.STANDARD]
...
#####################################################################
#  PTL UH LP5x T4 - RVP3 BOM
#     Board ID: 0x03
#     Bom ID  : 0x06 (BomIdPtlUHLp5Rvp)
#   Display ID: 0x00
#       SKU ID: 0x00060003 (SkuIdPtlUHLp5Rvp3Bom)
#####################################################################
[PcdsDynamicExVpd.common.SkuIdPtlUHLp5Rvp3Bom]
  ...
  // x4 Slot
  //
    {GPIOV2_PTL_PCD_XXGPP_C_6,   {GpioV2PadModeGpio, GpioV2HostOwnAcpi,    GpioV2DirOut,    GpioV2StateLow,    GpioV2IntDis,                 GpioV2ResetHost,      GpioV2TermDefault}}, // X4_PCIE_SLOT_PWR_EN
    {GPIOV2_PTL_PCD_XXGPP_C_7,   {GpioV2PadModeGpio, GpioV2HostOwnAcpi,    GpioV2DirOut,    GpioV2StateHigh,    GpioV2IntDis,                 GpioV2ResetHost,      GpioV2TermDefault}}, // X4_DT_PCIE_RST_N
  ...
  // Camera Conn 2
  //
    {GPIOV2_PTL_PCD_XXGPP_C_8,  {GpioV2PadModeGpio,   GpioV2HostOwnAcpi,  GpioV2DirOut,    GpioV2StateHigh,    GpioV2IntDis,     GpioV2ResetHost,  GpioV2TermDefault}},  // CRD2_PWREN
    {GPIOV2_PTL_PCD_XXGPP_E_1,  {GpioV2PadModeGpio,   GpioV2HostOwnAcpi,  GpioV2DirOut,    GpioV2StateHigh,   GpioV2IntDis,      GpioV2ResetHost,  GpioV2TermDefault}},  // CRD2_RST_N
    {GPIOV2_PTL_PCD_XXGPP_F_19, {GpioV2PadModeGpio,   GpioV2HostOwnAcpi,  GpioV2DirOut,    GpioV2StateLow,    GpioV2IntDis,      GpioV2ResetHost,  GpioV2TermDefault}},  // GPP_PRIVACY_LED_CAM2
   ...
   gBoardModuleTokenSpaceGuid.VpdPcdRootPortPewakeConfig|*|{CODE(
  {
    ...
    0,                           // PEWAKE Pin for RP10
    GPIOV2_PTL_PCD_XXGPP_D_24,   // PEWAKE Pin for RP11
    GPIOV2_PTL_PCD_XXGPP_D_25,   // PEWAKE Pin for RP12
    0xFFFFFFFF                   // terminator
  })}

  # PCIE SLOT 3 - X4 CONNECTOR RTD3
  gBoardModuleTokenSpaceGuid.VpdPcdPcieSlot3RootPort|*|0xC
  gBoardModuleTokenSpaceGuid.VpdPcdPcieSlot3PwrEnableGpioNo|*|{CODE(
   { GPIOV2_PTL_PCD_XXGPP_C_6 } // X4_PCIE_SLOT_PWR_EN
  )}
  gBoardModuleTokenSpaceGuid.VpdPcdPcieSlot3HoldRstGpioNo|*|{CODE(
   { GPIOV2_PTL_PCD_XXGPP_C_7 } // X2_DT_PCIE_RST_N
  )}
  ...
  gBoardModuleTokenSpaceGuid.VpdPcdPcieClkUsageMap|*|{CODE(
  {{
    PCIE_PCH + 10,  // x4 over x8 CEM Slot
    PCIE_PCH + 8,   // Gen5 SSD
    PCIE_PCH,       // x2 Pcie Slot (LR)
    LAN_CLOCK,      // GBE LAN
    NOT_USED,
...
#####################################################################
# PTL UH LP5x T4 MEMSD
#     Board ID: 0x03
#     Bom ID: 0x01  (BomIdPtlUHLp5MemSdRvp)
#   Display ID: 0x00
#       SKU ID: 0x00010003 (SkuIdPtlUHLp5MemSdRvp3)
#####################################################################
[PcdsDynamicExVpd.common.SkuIdPtlUHLp5MemSdRvp3]
