...
#####################################################################
#  PTL H LP5 Gcs1
#     Board ID: 0x11       (BoardIdPtlHLp5Gcs1)
#   Display ID: 0x00
#       SKU ID: 0x00000011 (SkuIdPtlHLp5Gcs1)
#####################################################################
[PcdsDynamicExVpd.common.SkuIdPtlHLp5Gcs1]
  ...
  { 6,    // DeviceSize
    '3',  // I2C_Scope
    {
     ...
     {    0x10,     {{"SNS_V1P8A",            5}, {"SNS_V3P3A_DP",          1}, {"VBATA_VCCGT_SENSE",     2}, {"SNS_V3P3X_SSD",        5}}},
     {    0x13,     {{"VBATA_VCCSA_SENSE",    2}, {"VBATA_VCCIO_SENSE",     5}, {"VBATA_LP_ECORE_SENSE",  2}, {"VBATA_VNNAON_SENSE",   2}}},
     {    0x12,     {{"SNS_V5P0A_DP",         2}, {"SNS_V3P3A_EDP",        10}, {"SNS_V3P3A_LIDBRD_DP",  10}, {"SNS_VCC_EDP_BKLT_DP", 10}}},
     {    0x14,     {{"SNS_V_BATT_OUT_FET",   5}, {"SNS_V_CHGR_EMI_VIN_P", 10}, {"V3P3A_KBC_EC_CS",       5}, {"SNS_V3P3A_WLAN_DP",    1}}},
     {    0x17,     {{"NA",                   0}, {"NA",                    0}, {"SENSE_3P3A_RGB_CAM_DP", 5}, {"SENSE_3P3A_IR_CAM_DP", 5}}},
    }
  })}
  ...
  // Camera Conn 2
  //
    {GPIOV2_PTL_PCD_XXGPP_C_5,  {GpioV2PadModeGpio, GpioV2HostOwnAcpi, GpioV2DirOut,   GpioV2StateLow,     GpioV2IntDis,      GpioV2ResetHost,      GpioV2TermDefault}},  // RGB_PWRDN
  ...
  // TCSS
  //
    {GPIOV2_PTL_PCD_XXGPP_V_17, {GpioV2PadModeGpio, GpioV2HostOwnGpio, GpioV2DirOut, GpioV2StateHigh, GpioV2IntDis, GpioV2ResetHostDeep,  GpioV2TermDefault}}, // GPP_V17_TCP_RT_S0IX_ENTRY_EXIT_N
  ...
  # GCS1 Hynix H58G66BK8BX067, mLpddr5xQdp16Gb315b8533Spd
...
#####################################################################
#  PTL UH LP5x GCS MEM  9600 Speed
#     Board ID: 0x18
#     Display ID: 0x00
#     SKU ID: 0x00000018 (SkuIdPtlUHLp5Gcs9600)
#####################################################################
[PcdsDynamicExVpd.common.SkuIdPtlUHLp5Gcs9600]
