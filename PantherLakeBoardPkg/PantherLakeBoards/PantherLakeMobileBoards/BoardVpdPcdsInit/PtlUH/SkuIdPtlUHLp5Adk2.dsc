...
#####################################################################
#  PTL UH LP5x Adk2
#     Board ID: 0x16       (BoardIdPtlUHLp5Adk2)
#   Display ID: 0x00
#       SKU ID: 0x00000015 (SkuIdPtlUHLp5Adk2)
#####################################################################
[PcdsDynamicExVpd.common.SkuIdPtlUHLp5Adk2]
  ...
  // ModularIoSupported, EdpModularIoSupported, RetimerCount, PcieSupported, DpAltModeSupported, Usb4Supported, Tbt3Supported, PdNum,    AuxDpMode, TbtControllerType, TbtControllerNum, DmaPortNum, PcieType, PcieRootPortNum
    ...
    {0,                  0,                     0,            0,             0,                  0,             0,             0,        0,         ITBT_DMA,          TBT_CONTROLLER2,  DMA_PORT2,  0,        0}, // NA
    {0x0}  // terminator
  })}
