  ...
  )
{
  ...
  for (UfsIndex = 0; UfsIndex < PchGetMaxUfsNum (); UfsIndex++) {
    ...
    UPDATE_POLICY(((FSPS_UPD *) FspsUpd)->FspsConfig.UfsDeviceConnected[UfsIndex], UfsConfig->UfsControllerConfig[UfsIndex].UfsDeviceConnected, PcdGetBool (PcdUfsDeviceDetected));
  ...
  )
{
  ...
  for (ThcIndex = 0; ThcIndex < PCH_MAX_THC_CONTROLLERS; ThcIndex++) {
    ...
    COMPARE_UPDATE_POLICY_ARRAY (((FSPS_UPD *) FspsUpd)->FspsConfig.ThcHidI2cMaxFrameSize[ThcIndex],                                       ThcConfig->ThcPort[ThcIndex].FrameSizeAndIntDelay.MaxFrameSize,                                      PchSetup->ThcHidI2cMaxFrameSize[ThcIndex],                                   ThcIndex);
    COMPARE_UPDATE_POLICY_ARRAY (((FSPS_UPD *) FspsUpd)->FspsConfig.ThcHidI2cMaxFrameSizeValue[ThcIndex],                                  ThcConfig->ThcPort[ThcIndex].FrameSizeAndIntDelay.MaxFrameSizeValue,                                 PchSetup->ThcHidI2cMaxFrameSizeValue[ThcIndex],                              ThcIndex);
    COMPARE_UPDATE_POLICY_ARRAY (((FSPS_UPD *) FspsUpd)->FspsConfig.ThcHidI2cIntDelay[ThcIndex],                                           ThcConfig->ThcPort[ThcIndex].FrameSizeAndIntDelay.IntDelay,                                          PchSetup->ThcHidI2cIntDelay[ThcIndex],                                       ThcIndex);
    COMPARE_UPDATE_POLICY_ARRAY (((FSPS_UPD *) FspsUpd)->FspsConfig.ThcHidI2cIntDelayValue[ThcIndex],                                      ThcConfig->ThcPort[ThcIndex].FrameSizeAndIntDelay.IntDelayValue,                                     PchSetup->ThcHidI2cIntDelayValue[ThcIndex],                                  ThcIndex);
  }
}
