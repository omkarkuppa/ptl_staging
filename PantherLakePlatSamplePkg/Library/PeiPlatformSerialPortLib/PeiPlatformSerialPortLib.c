/** @file
  Serial I/O Port library functions with with BIOS Setup Check
...
{
  BOOLEAN                      AllowDebugPrint;

  AllowDebugPrint = FALSE;
  if ((GetDebugInterface() & STATUS_CODE_USE_ISA_SERIAL) || (GetDebugInterface() & STATUS_CODE_USE_SERIALIO)) {
