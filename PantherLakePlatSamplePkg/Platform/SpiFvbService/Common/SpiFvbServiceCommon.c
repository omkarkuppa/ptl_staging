...
FV_INFO mPlatformBiosGuardEnabledFvBaseAddress [] = {
    {FixedPcdGet32(PcdFlashFvMicrocodeBase), FixedPcdGet32(PcdFlashFvMicrocodeSize)},
};
UINTN   mPlatformBiosGuardEnabledFvBaseAddressCount = ARRAY_SIZE (mPlatformBiosGuardEnabledFvBaseAddress);

FV_INFO mPlatformBiosGuardEnabledDefaultBaseAddress [] = {
  {FixedPcdGet32(PcdFlashFvMicrocodeBase), FixedPcdGet32(PcdFlashFvMicrocodeSize)}
};
UINTN mPlatformBiosGuardEnabledDefaultBaseAddressCount = ARRAY_SIZE (mPlatformBiosGuardEnabledDefaultBaseAddress);
