...
typedef struct {
  ...
  // SerialIouartDebug Configuration
...
#define BOARD_INFO_SETUP_VARSTORE\
    efivarstore BOARD_INFO_SETUP, varid = 7,\
        attribute = 0x7, name = BoardInfoSetup, guid = BOARD_INFO_SETUP_GUID;
#define OC_SETUP_VARSTORE\
    efivarstore OC_SETUP, varid = AUTO_ID(OC_SETUP_VAR_ID),\
        attribute = 0x7, name = OcSetup, guid = OC_SETUP_GUID;
