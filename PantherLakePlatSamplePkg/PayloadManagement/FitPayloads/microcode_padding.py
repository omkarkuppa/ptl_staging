#  @file
#  Add and restore microcode padding for PantherLake platform.
#
#  @copyright
#  INTEL CONFIDENTIAL
...
#
# Returns the real file path based on the given path parameter
# Replace macros like $(PLATFORM_BIN_PACKAGE) defined in DSC file with the real path
#
...
if __name__ == "__main__":
  ...
  parser.add_argument ("--fdf", dest = 'Fdf', type = ValidateFdf, required = True,
