/**@file
    Unit test cases of DisableAtaPassword.
...
#include "DisableAtaPasswordMock.h"
  ...
  )
{
  ...
  Status = DisableAtaPassword (AtaDevice, 1, 0xffff, ATA_SECURITY_ERASE_IDENTIFY_MASTER_PASSWORD, DefaultPassStr);
  UT_ASSERT_EQUAL (Status, EFI_DEVICE_ERROR);
  UT_ASSERT_MEM_EQUAL(gMasterPassword, (VOID*)&DefaultPassStr[0], AsciiStrLen(DefaultPassStr));
