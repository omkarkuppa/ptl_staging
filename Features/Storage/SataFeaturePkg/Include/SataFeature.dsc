...
[Packages]
  SataFeaturePkg/SataFeaturePkg.dec
...
[LibraryClasses]
  ...
  # SataFeature Package
  #######################################
  AhciPcieRpLib|SataFeaturePkg/Library/AhciPcieRpLibNull/AhciPcieRpLibNull.inf
...
!if gSataFeaturePkgTokenSpaceGuid.PcdSataPciScanEnable == TRUE
...
[Components.X64]
  ...
  #####################################
!if gSataFeaturePkgTokenSpaceGuid.PcdSataFeatureEnable == TRUE
!if gSataFeaturePkgTokenSpaceGuid.PcdSataEraseEnable == TRUE
