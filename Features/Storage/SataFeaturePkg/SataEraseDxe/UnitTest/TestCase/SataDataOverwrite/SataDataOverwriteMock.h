/**@file
    Unit test case mock header for SataDataOverwrite.
...
@par Specification
**/
#ifndef _DATA_OVERWRITE_MOCK_H_
#define _DATA_OVERWRITE_MOCK_H_
...
/**
  Unit test for SataDataOverwrite.
...
UNIT_TEST_STATUS
EFIAPI
UnitTestSataDataOverwrite (
  IN UNIT_TEST_CONTEXT  Context
  );

#endif /*_DATA_OVERWRITE_MOCK_H_*/
