/**@file
    Unit test case mock header for GetSataEraseInfo.
...
@par Specification
**/
#ifndef _GET_SATA_ERASE_RESULT_MOCK_H_
#define _GET_SATA_ERASE_RESULT_MOCK_H_
...
#endif /*_GET_SATA_ERASE_RESULT_MOCK_H_*/
