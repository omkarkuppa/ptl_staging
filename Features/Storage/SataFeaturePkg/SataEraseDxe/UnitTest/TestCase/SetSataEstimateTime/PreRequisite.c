/**@file
    Unit test case Prerequisite of SetSataEstimateTime.
...
ATA_IDENTIFY_DATA           *mIdentifyData = NULL;
  ...
  )
{
  ...
  mIdentifyData = IdentifyDataConstructMock ();
  mIdentifyData->time_for_security_erase_unit = 1;
