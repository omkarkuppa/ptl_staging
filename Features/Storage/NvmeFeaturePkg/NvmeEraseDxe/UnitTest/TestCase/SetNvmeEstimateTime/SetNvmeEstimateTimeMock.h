/**@file
    Unit test case mock header for SetNvmeEstimateTime.
...
extern NVME_ADMIN_CONTROLLER_DATA  *mIdentifyData;
/**
...
/**
  Unit-Test SetNvmeEstimateTime CleanUp Function. Clean the parameter for mock

  @param[in]  Context    Input context for mock.

**/
VOID
CleanUpSetNvmeEstimateTime (
  IN UNIT_TEST_CONTEXT  Context
  );
