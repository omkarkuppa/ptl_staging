...
//
typedef struct {
  EFI_STATUS  Status;       // Status of LocateHandle for EFI_NVM_EXPRESS_PASS_THRU_PROTOCOL
  UINTN       HandleCount;  // Handle count of EFI_NVM_EXPRESS_PASS_THRU_PROTOCOL
...
typedef struct {
  ...
  EFI_NVM_EXPRESS_PASS_THRU_PROTOCOL *PassThru;              // Point to EFI_NVM_EXPRESS_PASS_THRU_PROTOCOL
