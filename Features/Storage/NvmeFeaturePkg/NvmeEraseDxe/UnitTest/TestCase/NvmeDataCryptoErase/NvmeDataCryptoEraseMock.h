/**@file
    Unit test case mock header for NvmeDataCryptoErase.
...
@par Specification
**/
#ifndef _DATA_CRYPTO_ERASE_MOCK_H_
#define _DATA_CRYPTO_ERASE_MOCK_H_
...
UNIT_TEST_STATUS
EFIAPI
PreDataCryptoErase_F (
  IN UNIT_TEST_CONTEXT  Context
  );

/**
  Unit-Test NvmeDataCryptoErase CleanUp Function. Clean the parameter for mock
...
#endif /*_DATA_CRYPTO_ERASE_MOCK_H_*/
