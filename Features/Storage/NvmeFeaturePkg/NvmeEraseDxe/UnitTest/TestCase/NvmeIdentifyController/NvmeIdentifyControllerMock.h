/**@file
    Unit test case mock header for NvmeIdentifyController.
...
@par Specification
**/
#ifndef _IDENTIFY_CONTROLLER_MOCK_H_
#define _IDENTIFY_CONTROLLER_MOCK_H_
...
UNIT_TEST_STATUS
EFIAPI
PreIdentifyController_S (
  IN UNIT_TEST_CONTEXT  Context
  );

/**
  Unit-Test NvmeIdentifyController CleanUp Function. Clean the parameter for mock

  @param[in]  Context    Input context for mock.

**/
VOID
CleanUpIdentifyController (
  IN UNIT_TEST_CONTEXT  Context
  );
...
#endif /*_IDENTIFY_CONTROLLER_MOCK_H_*/
