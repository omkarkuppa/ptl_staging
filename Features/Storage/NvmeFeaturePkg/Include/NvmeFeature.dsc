## @file
# This is a build description for the NVMe feature.
#
#  @copyright
#  INTEL CONFIDENTIAL
...
###################################################################################################
[Packages]
  NvmeFeaturePkg/NvmeFeaturePkg.dec
...
!if gNvmeFeaturePkgTokenSpaceGuid.PcdNvmePciScanEnable == TRUE
  NvmeFeaturePkg/NvmePciHcPei/NvmePciHcPei.inf
!endif
!endif
...
!if gNvmeFeaturePkgTokenSpaceGuid.PcdNvmePlnEnable == TRUE
  NvmeFeaturePkg/PowerLossNotifyDxe/PowerLossNotifyDxe.inf
!endif
!if gNvmeFeaturePkgTokenSpaceGuid.PcdNvmeEraseEnable == TRUE
  NvmeFeaturePkg/NvmeEraseDxe/NvmeEraseDxe.inf
!endif
!endif
