/**@file
    Unit test main of the Ufs Erase Dxe driver.
...
#define UNIT_TEST_NAME     "UfsEraseDxe Unit Test"
...
UNIT_TEST_CASE_STRUCT mUnitTestCasesStruct [] = {
  { "Test-GetUfsEstimateTime",             "GetUfsEstimateTime",        UnitTestGetUfsEstimateTime, NULL,                          NULL,                       NULL, 0,            0},
  { "Test-SetUfsEstimateTime",             "SetUfsEstimateTime",        UnitTestSetUfsEstimateTime, NULL,                          NULL,                       NULL, 0,            0},
};
/**
