/** @file
  Clean-up functions of the FvIntegrityCheck function.
...
#include "CleanUpFvIntegrityCheck.h"
#include "PrivateMock.h"

/**
  Clean up all variables used in testing FvIntegrityCheck function.

  @retval EFI_SUCCESS  - Clean up success.
**/
EFI_STATUS
EFIAPI
CleanFvIntegrityCheckEnvironment (
  VOID
  )
{
  gIbbTestIndex = 0;
...
UNIT_TEST_STATUS
EFIAPI
CleanUpFvIntegrityCheck (
  IN UNIT_TEST_CONTEXT  Context
  )
{
  EFI_STATUS  Status;

  Status = CleanFvIntegrityCheckEnvironment ();
