/** @file
  Clean-up functions of the IbbCacheabilityType function.
...
#include "CleanUpIbbCacheabilityType.h"
#include "PrivateMock.h"

/**
  Clean up all variables used in testing IbbCacheabilityType function.

  @retval EFI_SUCCESS  - Clean up success.
**/
EFI_STATUS
EFIAPI
CleanIbbCacheabilityTypeEnvironment (
  VOID
  )
{
  gIbbTestIndex = 0;
...
UNIT_TEST_STATUS
EFIAPI
CleanUpIbbCacheabilityType (
  IN UNIT_TEST_CONTEXT  Context
  )
{
  EFI_STATUS  Status;

  Status = CleanIbbCacheabilityTypeEnvironment ();
