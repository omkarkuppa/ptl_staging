/** @file
  Unit test case of the EndOfIbbNotifyCallback function.
...
#include "TestCaseEndOfIbbNotifyCallback.h"
#include "PrivateMock.h"

/**
  Unit Test case for EndOfIbbNotifyCallback function.
...
UNIT_TEST_STATUS
EFIAPI
UnitTestEndOfIbbNotifyCallback (
