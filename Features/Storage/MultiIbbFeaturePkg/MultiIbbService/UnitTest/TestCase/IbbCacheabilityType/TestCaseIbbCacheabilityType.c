/** @file
  Unit test case of the IbbCacheabilityType function.
...
#include "TestCaseIbbCacheabilityType.h"
#include "PrivateMock.h"

/**
  Unit Test case for IbbCacheabilityType function.
