/** @file
  Unit test case of the AdjustInitNemRange function.
...
#include "TestCaseAdjustInitNemRange.h"
#include "PrivateMock.h"

/**
  Unit Test case for AdjustInitNemRange function.
