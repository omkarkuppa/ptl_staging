/** @file
  Unit test main of the Dmar Dxe driver.
...
#define UNIT_TEST_NAME     "DmarDxe Unit Test"
...
UNIT_TEST_CASE_STRUCT mUnitTestCasesStruct [] = {
  //
  // Tests for CalculateDmarLength() function
  //
  { "UnitTestCalculateDmarLengthInvalidParameters", "CalculateDmarLengthInvalidParameters", UnitTestCalculateDmarLengthInvalidParameters,   NULL,                    NULL,              NULL,              0,         0},
  { "UnitTestCalculateDmarLengthDrhd",              "CalculateDmarLengthDrhd",              UnitTestCalculateDmarLengthDrhd,                NULL,                    NULL,              NULL,              0,         0},
  { "UnitTestCalculateDmarLengthDrhdAndRmrr",       "CalculateDmarLengthDrhdAndRmrr",       UnitTestCalculateDmarLengthDrhdAndRmrr,         NULL,                    NULL,              NULL,              0,         0},
  { "UnitTestCalculateDmarLengthDrhdAndOemRmrr",    "CalculateDmarLengthDrhdAndOemRmrr",    UnitTestCalculateDmarLengthDrhdAndOemRmrr,      NULL,                    NULL,              NULL,              0,         0},
  { "UnitTestCalculateDmarLengthDrhdAndSatc",       "CalculateDmarLengthDrhdAndSatc",       UnitTestCalculateDmarLengthDrhdAndSatc,         NULL,                    NULL,              NULL,              0,         0},
  { "UnitTestCalculateDmarLengthDrhdAndSidp",       "CalculateDmarLengthDrhdAndSidp",       UnitTestCalculateDmarLengthDrhdAndSidp,         NULL,                    NULL,              NULL,              0,         0},
  { "UnitTestCalculateDmarLengthDrhdAndRhsa",       "CalculateDmarLengthDrhdAndRhsa",       UnitTestCalculateDmarLengthDrhdAndRhsa,         NULL,                    NULL,              NULL,              0,         0},
  { "UnitTestCalculateDmarLengthDrhdAndAtsr",       "CalculateDmarLengthDrhdAndAtsr",       UnitTestCalculateDmarLengthDrhdAndAtsr,         NULL,                    NULL,              NULL,              0,         0},
  { "UnitTestCreateDmarAcpiHeader",                 "CreateHeader",                         UnitTestCreateHeader,                           NULL,                    NULL,              NULL,              0,         0},
  { "UnitTestAddDrhd",                              "AddDrhd",                              UnitTestAddDrhd,                                NULL,                    NULL,              NULL,              0,         0},
  { "UnitTestAddRmrrInvalidParameters",             "AddRmrrInvalidParameters",             UnitTestAddRmrrInvalidParameters,               NULL,                    NULL,              NULL,              0,         0},
  { "UnitTestAddRmrrBasicFlow",                     "AddRmrrBasicFlow",                     UnitTestAddRmrrBasicFlow,                       NULL,                    NULL,              NULL,              0,         0},
  { "UnitTestAddSatc",                              "AddSatc",                              UnitTestAddSatc,                                NULL,                    NULL,              NULL,              0,         0},
  { "UnitTestAddSidp",                              "AddSidp",                              UnitTestAddSidp,                                NULL,                    NULL,              NULL,              0,         0},
  //
  // RHSA
  //
  { "UnitTestAddRhsaInvalidParameters",             "AddRhsaInvalidParameters",             UnitTestAddRhsaInvalidParameters,               NULL,                    NULL,              NULL,              0,         0},
  { "UnitTestAddRhsaUnsupported",                   "AddRhsaUnsupported",                   UnitTestAddRhsaUnsupported,                     NULL,                    NULL,              NULL,              0,         0},
  { "UnitTestAddRhsaBasicFlow",                     "AddRhsaBasicFlow",                     UnitTestAddRhsaBasicFlow,                       NULL,                    NULL,              NULL,              0,         0},
  //
  // ATSR
  //
  { "UnitTestAddAtsrInvalidParameters",             "AddAtsrInvalidParameters",             UnitTestAddAtsrInvalidParameters,               NULL,                    NULL,              NULL,              0,         0},
  { "UnitTestAddAtsrUnsupported",                   "AddAtsrUnsupported",                   UnitTestAddAtsrUnsupported,                     NULL,                    NULL,              NULL,              0,         0},
  { "UnitTestAddAtsrBasicFlow",                     "AddAtsrBasicFlow",                     UnitTestAddAtsrBasicFlow,                       NULL,                    NULL,              NULL,              0,         0},
};
  ...
  )
{
  ...
  UNIT_TEST_SUITE_HANDLE        UnitTestDmarDxe;
  UINTN                         Index;
  ...
  Status = CreateUnitTestSuite (
             &UnitTestDmarDxe,         // SuiteHandle  : Unit test suite to create
  ...
  for (Index = 0; Index < ARRAY_SIZE (mUnitTestCasesStruct); Index++) {
    Status = AddTestCase (
               UnitTestDmarDxe,                           // SuiteHandle        : Unit test suite to add test to
