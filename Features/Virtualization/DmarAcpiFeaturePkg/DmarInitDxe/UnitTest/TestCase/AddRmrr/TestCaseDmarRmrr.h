...
} EFI_ACPI_RMRR1_STRUCT;

typedef struct {
  EFI_ACPI_DMAR_RMRR_HEADER       RmrrHeader;
  EFI_ACPI_DEV_SCOPE_STRUCTURE    DeviceScope[1];
} EFI_ACPI_RMRR2_STRUCT;

typedef struct {
  EFI_ACPI_DMAR_RMRR_HEADER       RmrrHeader;
  EFI_ACPI_DEV_SCOPE_STRUCTURE    DeviceScope[1];
} EFI_ACPI_OEM_RMRR1_STRUCT;

typedef struct {
  EFI_ACPI_RMRR1_STRUCT        Rmrr1;
  EFI_ACPI_RMRR2_STRUCT        Rmrr2;
  EFI_ACPI_OEM_RMRR1_STRUCT    OemRmrr1;
} UNIT_TEST_RMRR_TABLE_STRUCTURE;
