...
} EFI_ACPI_SATC1_STRUCT;

typedef struct {
  EFI_ACPI_DMAR_SATC_HEADER     SatcHeader;
  EFI_ACPI_DEV_SCOPE_STRUCTURE  DeviceScope[2];
} EFI_ACPI_SATC2_STRUCT;

typedef struct {
  EFI_ACPI_DMAR_SATC_HEADER     SatcHeader;
  EFI_ACPI_DEV_SCOPE_STRUCTURE  DeviceScope[1];
} EFI_ACPI_SATC3_STRUCT;

typedef struct {
  EFI_ACPI_SATC1_STRUCT  Satc1;
  EFI_ACPI_SATC2_STRUCT  Satc2;
  EFI_ACPI_SATC3_STRUCT  Satc3;
} UNIT_TEST_SATC_TABLE_STRUCTURE;
