...
class NvmStallNvmAccessTest : public Test {
  protected:
    EFI_STATUS              Status;
...
//
TEST_F (NvmStallNvmAccessTest, case_2) {
  cout << "[---------- Case 2 ----------]"<< endl;
  EXPECT_CALL (PdBridgeProtocolMock, PdBridgeProtocol_ExecuteVendorCmd)
  ...
  cout << "NvmStallNvmAccess Done." << endl;
}
