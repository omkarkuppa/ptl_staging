...
class NvmAuthenticateWriteTest : public Test {
  protected:
    EFI_STATUS              Status;
...
//
TEST_F (NvmAuthenticateWriteTest, case_2) {
  cout << "[---------- Case 2 ----------]"<< endl;
  EXPECT_CALL (PdBridgeProtocolMock, PdBridgeProtocol_ExecuteVendorCmd)
  ...
  cout << "NvmAuthenticateWrite Done." << endl;
}
