/** @file
  Google test for DriveToFwUpdateMode function.
...
// **********************************************************
// DriveToFwUpdateMode Unit Test                            *
// **********************************************************
class DriveToFwUpdateModeTest : public Test {
  protected:
    EFI_STATUS                      Status;
...
//
TEST_F (DriveToFwUpdateModeTest, 1) {
  cout << "[---------- Case 1 ----------]"<< endl;
  ...
  Status = DriveToFwUpdateMode (&LocalURP, RetimerGuid);
...
//
TEST_F (DriveToFwUpdateModeTest, 2) {
  cout << "[---------- Case 2 ----------]"<< endl;
...
// Expected Result - Status will return EFI_INVALID_PARAMETER
//
TEST_F (DriveToFwUpdateModeTest, 3) {
  cout << "[---------- Case 3 ----------]"<< endl;
...
//
TEST_F (DriveToFwUpdateModeTest, 4) {
  cout << "[---------- Case 4 ----------]"<< endl;
