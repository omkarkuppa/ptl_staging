...
///
#define LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_PD_BRIDGE_ERROR_CODE_VALUE               0x1A00
...
enum LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_EXPANDED_ERROR_LIST
{
  ...
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_TBT_RETIMER_ERROR_DEVICE_HANDLE_NOT_FOUND                     , // 0X1910
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_TBT_RETIMER_ERROR_TOO_FEW_RETIMER_INSTANCES                   , // 0X1911
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_TBT_RETIMER_ERROR_SEND_OFFLINE_MODE_FAILED                    , // 0X1912
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_TBT_RETIMER_ERROR_ASSERT_RETIMER_FORCE_POWER_FAILED           , // 0X1913
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_TBT_RETIMER_ERROR_DEASSERT_RETIMER_FORCE_POWER_FAILED         , // 0X1914
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_TBT_RETIMER_ERROR_INIT_HW_FAILED                              , // 0X1915
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_TBT_RETIMER_ERROR_TERMINATED_HW_FAILED                        , // 0X1916
  ...
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_PD_BRIDGE_ERROR_IMAGE_PARAMETER_IS_NULL            , // 0x1A01
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_PD_BRIDGE_ERROR_SIGNATURE_IS_NOT_DETECTED          , // 0x1A02
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_PD_BRIDGE_ERROR_PAYLOAD_COUNT_IS_ZERO              , // 0x1A03
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_PD_BRIDGE_ERROR_PAYLOAD_SIZE_TOO_SMALL             , // 0x1A04
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_PD_BRIDGE_ERROR_PAYLOAD_IS_OUT_OF_BOUNDS           , // 0x1A05
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_PD_BRIDGE_ERROR_IMAGE_NOT_PROVIDED                 , // 0x1A06
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_PD_BRIDGE_ERROR_PROGRESS_CALLBACK_ERROR            , // 0x1A07
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_PD_BRIDGE_ERROR_USBC_PD_BRIDGE_PROTOCOL_NOT_FOUND  , // 0x1A08
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_PD_BRIDGE_ERROR_PAYLOAD_IS_OUT_OF_BOUNDS_2         , // 0x1A09
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_PD_BRIDGE_ERROR_UNSUPPORT_FIRMWARE_TYPE            , // 0x1A0A
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_PD_BRIDGE_ERROR_INVALID_SHARE_FLASH_MODE_VALUE     , // 0x1A0B
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_PD_BRIDGE_ERROR_INVALID_PD_BRIDGE_TYPE_VALUE       , // 0x1A0C
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_PD_BRIDGE_ERROR_NVM_SET_OFFSET_FAILED              , // 0x1A0D
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_PD_BRIDGE_ERROR_NVM_WRITE_FAILED                   , // 0x1A0E
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_PD_BRIDGE_ERROR_NVM_STALL_NVM_ACCESS_FAILED        , // 0x1A0F
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_PD_BRIDGE_ERROR_NVM_AUTH_WRITE_FAILED              , // 0x1A10
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_PD_BRIDGE_ERROR_NVM_RESET_FAILED                   , // 0x1A11
  LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_PD_BRIDGE_ERROR_ENTER_NVM_UPDATE_MODE_FAILED         // 0x1A12
};
