...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_CHECKIMAGE                         ((EVT_ID_FMP_DEV_PD_BRIDGE_CHECKIMAGE << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_CHECKIMAGE))
...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_CHECKIMAGE_POINTER_NULL            ((EVT_ID_FMP_DEV_PD_BRIDGE_CHECKIMAGE_POINTER_NULL << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_CHECKIMAGE_POINTER_NULL))
...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_SIGNATURE_NOT_DETECTED             ((EVT_ID_FMP_DEV_PD_BRIDGE_SIGNATURE_NOT_DETECTED << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_SIGNATURE_NOT_DETECTED))
...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_PAYLOAD_ZERO                       ((EVT_ID_FMP_DEV_PD_BRIDGE_PAYLOAD_ZERO << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_PAYLOAD_ZERO))
...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_PAYLOAD_SIZE_SMALL                 ((EVT_ID_FMP_DEV_PD_BRIDGE_PAYLOAD_SIZE_SMALL << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_PAYLOAD_SIZE_SMALL))
...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_PAYLOAD_OUT_BOUNDS1                ((EVT_ID_FMP_DEV_PD_BRIDGE_PAYLOAD_OUT_BOUNDS1 << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_PAYLOAD_OUT_BOUNDS1))
...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_GET_VERSION_VARIABLE_FAILED        ((EVT_ID_FMP_DEV_PD_BRIDGE_GET_VERSION_VARIABLE_FAILED << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_GET_VERSION_VARIABLE_FAILED))
...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_SET_IMAGE_START                    ((EVT_ID_FMP_DEV_PD_BRIDGE_SET_IMAGE_START << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_SET_IMAGE_START))
...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_IMAGE_NULL                         ((EVT_ID_FMP_DEV_PD_BRIDGE_IMAGE_NULL << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_IMAGE_NULL))
...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_PROGRESS_IS_NULL                   ((EVT_ID_FMP_DEV_PD_BRIDGE_PROGRESS_IS_NULL << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_PROGRESS_IS_NULL))
...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_PROGRESS_CALLBACK_FAILED           ((EVT_ID_FMP_DEV_PD_BRIDGE_PROGRESS_CALLBACK_FAILED << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_PROGRESS_CALLBACK_FAILED))
...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_UPDATE_START                       ((EVT_ID_FMP_DEV_PD_BRIDGE_UPDATE_START << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_UPDATE_START))
...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_LOCATE_PROTOCOL_FAILED             ((EVT_ID_FMP_DEV_PD_BRIDGE_LOCATE_PROTOCOL_FAILED << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_LOCATE_PROTOCOL_FAILED))
...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_PAYLOAD_COUNT                      ((EVT_ID_FMP_DEV_PD_BRIDGE_PAYLOAD_COUNT << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_PAYLOAD_COUNT))
...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_PAYLOAD_IMAGE_OFFSET_SIZE          ((EVT_ID_FMP_DEV_PD_BRIDGE_PAYLOAD_IMAGE_OFFSET_SIZE << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_PAYLOAD_IMAGE_OFFSET_SIZE))
#define STR_ID_FMP_DEV_PD_BRIDGE_PAYLOAD_IMAGE_OFFSET_SIZE            "ImageOffset=0x%x, size=0x%x\n"
///
/// FmpDeviceSetImageWithStatus - PdCntrlIndex=0x%x, ShareFlashMode=0x%x
///
#define EVT_ARGS_FMP_DEV_PD_BRIDGE_PAYLOAD_CNTRL_INDEX_SHARE_FLASH_MODE  2
#define EVT_CODE_FMP_DEV_PD_BRIDGE_PAYLOAD_CNTRL_INDEX_SHARE_FLASH_MODE  ((EVT_ID_FMP_DEV_PD_BRIDGE_PAYLOAD_CNTRL_INDEX_SHARE_FLASH_MODE << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_PAYLOAD_CNTRL_INDEX_SHARE_FLASH_MODE))
#define STR_ID_FMP_DEV_PD_BRIDGE_PAYLOAD_CNTRL_INDEX_SHARE_FLASH_MODE    "PdCntrlIndex=0x%x, ShareFlashMode=0x%x"
///
/// FmpDeviceSetImageWithStatus - PdBridgeType=0x%x\n
///
#define EVT_ARGS_FMP_DEV_PD_BRIDGE_PAYLOAD_PD_BRIDGE_TYPE             1
#define EVT_CODE_FMP_DEV_PD_BRIDGE_PAYLOAD_PD_BRIDGE_TYPE             ((EVT_ID_FMP_DEV_PD_BRIDGE_PAYLOAD_PD_BRIDGE_TYPE << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_PAYLOAD_PD_BRIDGE_TYPE))
...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_PAYLOAD_OUT_BOUNDS2                ((EVT_ID_FMP_DEV_PD_BRIDGE_PAYLOAD_OUT_BOUNDS2 << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_PAYLOAD_OUT_BOUNDS2))
...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_UNSUPPORT_FW_TYPE                  ((EVT_ID_FMP_DEV_PD_BRIDGE_UNSUPPORT_FW_TYPE << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_UNSUPPORT_FW_TYPE))
...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_INVALID_SHARE_FLASH_MODE_VALUE     ((EVT_ID_FMP_DEV_PD_BRIDGE_INVALID_SHARE_FLASH_MODE_VALUE << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_INVALID_SHARE_FLASH_MODE_VALUE))
...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_INVALID_PD_BRIDGE_TYPE_VALUE       ((EVT_ID_FMP_DEV_PD_BRIDGE_INVALID_PD_BRIDGE_TYPE_VALUE << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_INVALID_PD_BRIDGE_TYPE_VALUE))
...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_INIT_VENDOR_CMD_DATA_FAILED        ((EVT_ID_FMP_DEV_PD_BRIDGE_INIT_VENDOR_CMD_DATA_FAILED << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_INIT_VENDOR_CMD_DATA_FAILED))
...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_FW_VERSION_INDEX                   ((EVT_ID_FMP_DEV_PD_BRIDGE_FW_VERSION_INDEX << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_FW_VERSION_INDEX))
#define STR_ID_FMP_DEV_PD_BRIDGE_FW_VERSION_INDEX                     "[USBC] PD%d "
///
/// FmpDeviceSetImageWithStatus - Version is %08x.%08x
///
#define EVT_ARGS_FMP_DEV_PD_BRIDGE_FW_VERSION                         2
#define EVT_CODE_FMP_DEV_PD_BRIDGE_FW_VERSION                         ((EVT_ID_FMP_DEV_PD_BRIDGE_FW_VERSION << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_FW_VERSION))
...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_UPDATE_FAILED_AT_INDEX             ((EVT_ID_FMP_DEV_PD_BRIDGE_UPDATE_FAILED_AT_INDEX << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_UPDATE_FAILED_AT_INDEX))
...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_SET_IMAGE_END                      ((EVT_ID_FMP_DEV_PD_BRIDGE_SET_IMAGE_END << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_SET_IMAGE_END))
...
#define EVT_CODE_FMP_DEV_PD_BRIDGE_LOCK                               ((EVT_ID_FMP_DEV_PD_BRIDGE_LOCK << 2) | (EVT_ARGS_FMP_DEV_PD_BRIDGE_LOCK))
