...
#define EVT_CODE_DTBT_CHECKIMAGE_UPDATABLE_NULL                ((EVT_ID_DTBT_CHECKIMAGE_UPDATABLE_NULL << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_DTBT_CHECKIMAGE_UPDATABLE_NULL << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_DTBT_CHECKIMAGE_POINTER_NULL                  ((EVT_ID_DTBT_CHECKIMAGE_POINTER_NULL << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_DTBT_CHECKIMAGE_POINTER_NULL << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_DTBT_CHECKIMAGE_PAYLOAD_SIGNATURE_UNDETECTED  ((EVT_ID_DTBT_CHECKIMAGE_PAYLOAD_SIGNATURE_UNDETECTED << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_DTBT_CHECKIMAGE_PAYLOAD_SIGNATURE_UNDETECTED << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_DTBT_CHECKIMAGE_PAYLOAD_HEADER_ZERO           ((EVT_ID_DTBT_CHECKIMAGE_PAYLOAD_HEADER_ZERO << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_DTBT_CHECKIMAGE_PAYLOAD_HEADER_ZERO << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_DTBT_CHECKIMAGE_PAYLOAD_COUNT_INVALID         ((EVT_ID_DTBT_CHECKIMAGE_CHECKIMAGE_PAYLOAD_COUNT_INVALID << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_DTBT_CHECKIMAGE_PAYLOAD_COUNT_INVALID  << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_DTBT_CHECKIMAGE_PAYLOAD_SIZE_TOO_SMALL        ((EVT_ID_DTBT_CHECKIMAGE_CHECKIMAGE_PAYLOAD_SIZE_TOO_SMALL << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_DTBT_CHECKIMAGE_PAYLOAD_SIZE_TOO_SMALL << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_DTBT_CHECKIMAGE_PAYLOAD_OUT_BOUNDS            ((EVT_ID_DTBT_CHECKIMAGE_CHECKIMAGE_PAYLOAD_OUT_BOUNDS << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_DTBT_CHECKIMAGE_PAYLOAD_OUT_BOUNDS << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_DTBT_FMP_UPDATE_START                         ((EVT_ID_DTBT_FMP_UPDATE_START << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_DTBT_FMP_UPDATE_START << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_DTBT_FMP_UPDATE_PROGRESS_NULL                 ((EVT_ID_DTBT_FMP_UPDATE_PROGRESS_NULL << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_DTBT_FMP_UPDATE_PROGRESS_NULL << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_DTBT_FMP_UPDATE_PROGRESS_FAIL                 ((EVT_ID_DTBT_FMP_UPDATE_PROGRESS_FAIL << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_DTBT_FMP_UPDATE_PROGRESS_FAIL << EVT_CODE_ARG_NUM_OFFSET) | EVT_CODE_ARG0_STATUS)
...
#define EVT_CODE_DTBT_FMP_UPDATE_DTBT_START                    ((EVT_ID_DTBT_FMP_UPDATE_DTBT_START << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_DTBT_FMP_UPDATE_DTBT_START << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_DTBT_PAYLOAD_OUT_BOUNDS                       ((EVT_ID_DTBT_PAYLOAD_OUT_BOUNDS << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_DTBT_PAYLOAD_OUT_BOUNDS << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_DTBT_UPDATE                                   ((EVT_ID_DTBT_UPDATE << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_DTBT_UPDATE << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_DTBT_PAYLOAD_OFFSET_SIZE                      ((EVT_ID_DTBT_PAYLOAD_OFFSET_SIZE << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_DTBT_PAYLOAD_OFFSET_SIZE << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_DTBT_DISCONNECT_CONTROLLER                    ((EVT_ID_DTBT_DISCONNECT_CONTROLLER << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_DTBT_DISCONNECT_CONTROLLER << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_DTBT_PCIE_TYPE_RP                             ((EVT_ID_DTBT_PCIE_TYPE_RP << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_DTBT_PCIE_TYPE_RP << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_DTBT_FIRMWARETYPE_ERROR                       ((EVT_ID_DTBT_FIRMWARETYPE_ERROR << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_DTBT_FIRMWARETYPE_ERROR << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_DTBT_CREATE_DEV_INST                          ((EVT_ID_DTBT_CREATE_DEV_INST << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_DTBT_CREATE_DEV_INST << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_DTBT_INITIALIZE_FAIL                          ((EVT_ID_DTBT_INITIALIZE_FAIL << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_DTBT_INITIALIZE_FAIL << EVT_CODE_ARG_NUM_OFFSET) | EVT_CODE_ARG0_STATUS)
...
#define EVT_CODE_DTBT_UPDATE_NVM_FW                            ((EVT_ID_DTBT_UPDATE_NVM_FW << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_DTBT_UPDATE_NVM_FW << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_DTBT_INSTANCE_UPDATE_FAIL                     ((EVT_ID_DTBT_INSTANCE_UPDATE_FAIL << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_DTBT_INSTANCE_UPDATE_FAIL << EVT_CODE_ARG_NUM_OFFSET) | EVT_CODE_ARG0_STATUS)
#define STR_ID_DTBT_INSTANCE_UPDATE_FAIL                       "UsbC dTBT Capsule - Update failed (%r) at image index %d.\n"
///
/// FmpDeviceSetImageWithStatus: FmpDeviceSetImageWithStatus (Discrete TBT) - End
///
#define EVT_ARGS_DTBT_FMP_UPDATE_END                           0
#define EVT_CODE_DTBT_FMP_UPDATE_END                           ((EVT_ID_DTBT_FMP_UPDATE_END << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_DTBT_FMP_UPDATE_END << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_DTBT_FMP_DEVICE_LOCK                          ((EVT_ID_DTBT_FMP_DEVICE_LOCK  << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_DTBT_FMP_DEVICE_LOCK << EVT_CODE_ARG_NUM_OFFSET))
