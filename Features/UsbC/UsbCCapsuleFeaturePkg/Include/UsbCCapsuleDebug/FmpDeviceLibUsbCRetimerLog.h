...
#define EVT_CODE_GETVERSION_FAIL_GET_SETUP_VARIABLE            ((EVT_ID_GETVERSION_FAIL_GET_SETUP_VARIABLE << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_GETVERSION_FAIL_GET_SETUP_VARIABLE << EVT_CODE_ARG_NUM_OFFSET) | EVT_CODE_ARG0_STATUS)
...
#define EVT_CODE_CHECKIMAGE_UPDATABLE_NULL                     ((EVT_ID_CHECKIMAGE_UPDATABLE_NULL << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_CHECKIMAGE_UPDATABLE_NULL << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_CHECKIMAGE_POINTER_NULL                       ((EVT_ID_CHECKIMAGE_POINTER_NULL << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_CHECKIMAGE_POINTER_NULL << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_CHECKIMAGE_PAYLOAD_SIGNATURE_NOT_DETECTED     ((EVT_ID_CHECKIMAGE_PAYLOAD_SIGNATURE_NOT_DETECTED << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_CHECKIMAGE_PAYLOAD_SIGNATURE_NOT_DETECTED << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_CHECKIMAGE_PAYLOAD_HEADER_ZERO                ((EVT_ID_CHECKIMAGE_PAYLOAD_HEADER_ZERO << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_CHECKIMAGE_PAYLOAD_HEADER_ZERO << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_CHECKIMAGE_PAYLOAD_SIZE_TOO_SMALL             ((EVT_ID_CHECKIMAGE_PAYLOAD_SIZE_TOO_SMALL << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_CHECKIMAGE_PAYLOAD_SIZE_TOO_SMALL << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_CHECKIMAGE_PAYLOAD_OUT_BOUNDS                 ((EVT_ID_CHECKIMAGE_PAYLOAD_OUT_BOUNDS << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_CHECKIMAGE_PAYLOAD_OUT_BOUNDS << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_CONSTRUCT_INSTANCE_TOTAL_PAYLOAD              ((EVT_ID_CONSTRUCT_INSTANCE_TOTAL_PAYLOAD << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_CONSTRUCT_INSTANCE_TOTAL_PAYLOAD << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_CONSTRUCT_INSTANCE_MAX_INSTANCE_TOO_SMALL     ((EVT_ID_CONSTRUCT_INSTANCE_MAX_INSTANCE_TOO_SMALL << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_CONSTRUCT_INSTANCE_MAX_INSTANCE_TOO_SMALL << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_CONSTRUCT_INSTANCE_ADDRESS_BUS_DEVICE         ((EVT_ID_CONSTRUCT_INSTANCE_ADDRESS_BUS_DEVICE << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_CONSTRUCT_INSTANCE_ADDRESS_BUS_DEVICE << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_CONSTRUCT_INSTANCE_ADDRESS_FUNC               ((EVT_ID_CONSTRUCT_INSTANCE_ADDRESS_FUNC << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_CONSTRUCT_INSTANCE_ADDRESS_FUNC << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_CONSTRUCT_INSTANCE_ADDRESS_PORT_INDEX         ((EVT_ID_CONSTRUCT_INSTANCE_ADDRESS_PORT_INDEX << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_CONSTRUCT_INSTANCE_ADDRESS_PORT_INDEX << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_CONSTRUCT_INSTANCE_PCIE_TYPE_RP               ((EVT_ID_CONSTRUCT_INSTANCE_PCIE_TYPE_RP << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_CONSTRUCT_INSTANCE_PCIE_TYPE_RP << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_CONSTRUCT_INSTANCE_FIRMWARETYPE_ERROR         ((EVT_ID_CONSTRUCT_INSTANCE_FIRMWARETYPE_ERROR << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_CONSTRUCT_INSTANCE_FIRMWARETYPE_ERROR << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_CONSTRUCT_INSTANCE_CREATE_RETIMER_FAIL        ((EVT_ID_CONSTRUCT_INSTANCE_CREATE_RETIMER_FAIL << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_CONSTRUCT_INSTANCE_CREATE_RETIMER_FAIL << EVT_CODE_ARG_NUM_OFFSET) | EVT_CODE_ARG0_STATUS)
...
#define EVT_CODE_CONSTRUCT_INSTANCE_CREATE_HR_FAIL             ((EVT_ID_CONSTRUCT_INSTANCE_CREATE_HR_FAIL << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_CONSTRUCT_INSTANCE_CREATE_HR_FAIL << EVT_CODE_ARG_NUM_OFFSET) | EVT_CODE_ARG0_STATUS)
...
#define EVT_CODE_FMP_UPDATE_START                              ((EVT_ID_FMP_UPDATE_START << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_START << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_FMP_UPDATE_PROGRESS_NULL                      ((EVT_ID_FMP_UPDATE_PROGRESS_NULL << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_PROGRESS_NULL << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_FMP_UPDATE_PROGRESS_FAIL                      ((EVT_ID_FMP_UPDATE_PROGRESS_FAIL << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_PROGRESS_FAIL << EVT_CODE_ARG_NUM_OFFSET) | EVT_CODE_ARG0_STATUS)
...
#define EVT_CODE_FMP_UPDATE_LOCATE_USBCRETIMER_PROTOCOL_FAIL   ((EVT_ID_FMP_UPDATE_LOCATE_USBCRETIMER_PROTOCOL_FAIL << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_LOCATE_USBCRETIMER_PROTOCOL_FAIL << EVT_CODE_ARG_NUM_OFFSET) | EVT_CODE_ARG0_STATUS)
...
#define EVT_CODE_FMP_UPDATE_LOCATE_USBCPROGRESS_PROTOCOL_FAIL  ((EVT_ID_FMP_UPDATE_LOCATE_USBCPROGRESS_PROTOCOL_FAIL << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_LOCATE_USBCPROGRESS_PROTOCOL_FAIL << EVT_CODE_ARG_NUM_OFFSET) | EVT_CODE_ARG0_STATUS)
...
#define EVT_CODE_FMP_UPDATE_CONSTRUCT_RETIMER_INSTANCE_FAILED  ((EVT_ID_FMP_UPDATE_CONSTRUCT_RETIMER_INSTANCE_FAILED << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_CONSTRUCT_RETIMER_INSTANCE_FAILED << EVT_CODE_ARG_NUM_OFFSET) | EVT_CODE_ARG0_STATUS)
...
#define EVT_CODE_FMP_UPDATE_DISCONNECT_CONTROLLER_START        ((EVT_ID_FMP_UPDATE_DISCONNECT_CONTROLLER_START << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_DISCONNECT_CONTROLLER_START << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_FMP_UPDATE_DISCONNECT_CONTROLLER_HANDLEINDEX   ((EVT_ID_FMP_UPDATE_DISCONNECT_CONTROLLER_HANDLEINDEX << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_DISCONNECT_CONTROLLER_HANDLEINDEX << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_FMP_UPDATE_SEND_OFFLINEMODE_FAIL               ((EVT_ID_FMP_UPDATE_SEND_OFFLINEMODE_FAIL << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_SEND_OFFLINEMODE_FAIL << EVT_CODE_ARG_NUM_OFFSET) | EVT_CODE_ARG0_STATUS)
...
#define EVT_CODE_FMP_UPDATE_DRIVE_TBTMODE_START                 ((EVT_ID_FMP_UPDATE_DRIVE_TBTMODE_START << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_DRIVE_TBTMODE_START << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_FMP_UPDATE_DRIVE_TBTMODE_FAIL                  ((EVT_ID_FMP_UPDATE_DRIVE_TBTMODE_FAIL << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_DRIVE_TBTMODE_FAIL << EVT_CODE_ARG_NUM_OFFSET) | EVT_CODE_ARG0_STATUS)
...
#define EVT_CODE_FMP_UPDATE_WAIT_FOR_RETIMER_DEVICE             ((EVT_ID_FMP_UPDATE_WAIT_FOR_RETIMER_DEVICE << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_WAIT_FOR_RETIMER_DEVICE << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_FMP_UPDATE_ASSERT_RETIMER_FP_GPIO              ((EVT_ID_FMP_UPDATE_ASSERT_RETIMER_FP_GPIO  << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_ASSERT_RETIMER_FP_GPIO << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_FMP_UPDATE_ASSERT_RETIMER_FP_GPIO_FAILED       ((EVT_ID_FMP_UPDATE_ASSERT_RETIMER_FP_GPIO_FAILED   << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_ASSERT_RETIMER_FP_GPIO_FAILED << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_FMP_UPDATE_RETIMER_START                       ((EVT_ID_FMP_UPDATE_RETIMER_START << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_RETIMER_START << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_FMP_UPDATE_TOTAL_RETIMER_PAYLOAD               ((EVT_ID_FMP_UPDATE_TOTAL_RETIMER_PAYLOAD << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_TOTAL_RETIMER_PAYLOAD << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_FMP_UPDATE_UPDATE_RETIMER_PAYLOAD              ((EVT_ID_FMP_UPDATE_UPDATE_RETIMER_PAYLOAD << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_UPDATE_RETIMER_PAYLOAD << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_FMP_UPDATE_PAYLOAD_OFFSET_SIZE                 ((EVT_ID_FMP_UPDATE_PAYLOAD_OFFSET_SIZE << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_PAYLOAD_OFFSET_SIZE << EVT_CODE_ARG_NUM_OFFSET))
#define STR_ID_FMP_UPDATE_PAYLOAD_OFFSET_SIZE                   "UsbC Retimer Capsule - ImageOffset=0x%x, size=0x%x\n"
///
/// UsbC Retimer Capsule - FmpDeviceSetImageWithStatus: InitRetimerHW Fail (%r)
///
#define EVT_ARGS_FMP_UPDATE_INIT_RETIMER_HW_FAIL                1
#define EVT_CODE_FMP_UPDATE_INIT_RETIMER_HW_FAIL                ((EVT_ID_FMP_UPDATE_INITRETIMERHW_FAIL << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_INIT_RETIMER_HW_FAIL << EVT_CODE_ARG_NUM_OFFSET) | EVT_CODE_ARG0_STATUS)
...
#define EVT_CODE_FMP_UPDATE_NVM_VERSION                         ((EVT_ID_FMP_UPDATE_NVM_VERSION << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_NVM_VERSION << EVT_CODE_ARG_NUM_OFFSET) | EVT_CODE_ARG1_STATUS)
...
#define EVT_CODE_FMP_UPDATE_NVM_VERSION1                        ((EVT_ID_FMP_UPDATE_NVM_VERSION1 << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_NVM_VERSION1 << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_FMP_UPDATE_TERMINATE_RETIMER_HW_FAIL           ((EVT_ID_FMP_UPDATE_TERMINATE_RETIMER_HW_FAIL << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_TERMINATE_RETIMER_HW_FAIL << EVT_CODE_ARG_NUM_OFFSET) | EVT_CODE_ARG0_STATUS)
...
#define EVT_CODE_FMP_UPDATE_DEASSERT_RETIMER_FP_GPIO            ((EVT_ID_FMP_UPDATE_DEASSERT_RETIMER_FP_GPIO  << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_DEASSERT_RETIMER_FP_GPIO << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_FMP_UPDATE_DEASSERT_RETIMER_FP_GPIO_FAILED     ((EVT_ID_FMP_UPDATE_DEASSERT_RETIMER_FP_GPIO_FAILED   << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_DEASSERT_RETIMER_FP_GPIO_FAILED << EVT_CODE_ARG_NUM_OFFSET) | EVT_CODE_ARG0_STATUS)
...
#define EVT_CODE_FMP_UPDATE_RESTORE_TBTMODE_FAIL                ((EVT_ID_FMP_UPDATE_RESTORE_TBTMODE_FAIL   << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_RESTORE_TBTMODE_FAIL << EVT_CODE_ARG_NUM_OFFSET) | EVT_CODE_ARG0_STATUS)
...
#define EVT_CODE_FMP_UPDATE_CONNECT_CONTROLLER_USB2HC           ((EVT_ID_FMP_UPDATE_CONNECT_CONTROLLER_USB2HC << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_CONNECT_CONTROLLER_USB2HC << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_FMP_UPDATE_DESTORY_RETIMER_INSTANCE            ((EVT_ID_FMP_UPDATE_DESTORY_RETIMER_INSTANCE  << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_DESTORY_RETIMER_INSTANCE << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_FMP_UPDATE_END                                 ((EVT_ID_FMP_UPDATE_END << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_UPDATE_END << EVT_CODE_ARG_NUM_OFFSET))
...
#define EVT_CODE_FMP_DEVICE_LOCK                                ((EVT_ID_FMP_DEVICE_LOCK << EVT_CODE_EVT_ID_OFFSET) | (EVT_ARGS_FMP_DEVICE_LOCK << EVT_CODE_ARG_NUM_OFFSET))
