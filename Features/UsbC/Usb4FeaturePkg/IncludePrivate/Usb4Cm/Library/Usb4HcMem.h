/** @file
  This file contains the definitions for host controller memory management routines.
...
#ifndef _EFI_USB4_MEM_H_
#define _EFI_USB4_MEM_H_
...
//
// USBHC_MEM_POOL is used to manage the memory used by USB4 controller
// host . USB4 requires the control memory and transfer
 ...
 *@param  PciIo               The PciIo that can be used to access the USB4 host controller after PCI bus enumeration
