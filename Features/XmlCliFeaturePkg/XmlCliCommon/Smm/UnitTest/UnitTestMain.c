/**@file
    Unit test main of the XmlCliSmm driver.
...
//
#include "TestCase/XmlCliCommonSmmTestCase.h"

#define UNIT_TEST_NAME     "XmlCliCommonSmm Unit Test"
  ...
  )
{
  ...
  UNIT_TEST_SUITE_HANDLE        UnitTestXmlCliCommonSmm;
  UINTN                         Index;
  ...
  Status = CreateUnitTestSuite (
             &UnitTestXmlCliCommonSmm,  // SuiteHandle  : Unit test suite to create
  ...
  for (Index = 0; Index < ARRAY_SIZE (mUnitTestCasesStruct); Index++) {
    Status = AddTestCase (
               UnitTestXmlCliCommonSmm,                  // SuiteHandle        : Unit test suite to add test to
