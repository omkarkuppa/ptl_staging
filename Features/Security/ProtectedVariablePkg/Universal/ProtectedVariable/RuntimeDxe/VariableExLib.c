  ...
  )
{
  ...
  VarInfo.NameSize               = NameSizeOfVariable (Variable.CurrPtr, mVariableModuleGlobal->VariableGlobal.AuthFormat);
  ...
  if (Status == EFI_BUFFER_TOO_SMALL) {
    VarInfo.Buffer        = Variable.CurrPtr;
    VarInfo.PlainData     = AllocatePool(VarInfo.PlainDataSize);
  ...
  )
{
  ...
  VarInfo.NameSize               = NameSizeOfVariable (VariablePtr, mVariableModuleGlobal->VariableGlobal.AuthFormat);
