...
/**
  This service retrieves a variable's value.

  If variable protection is used, get the protected variable's value by name.
  Otherwise, call standard PeiGetVariable() to get the variable's value.
...
/**
  ...
  If variable protection is used, get the next variable through ProtectedVariableLib.
  Otherwise, call standard PeiGetNextVariableName() to get the variable's info.
