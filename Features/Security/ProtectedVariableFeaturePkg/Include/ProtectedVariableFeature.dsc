## @file
# Description (DSC) File for Protected Variable Feature.
#
#  @copyright
#  INTEL CONFIDENTIAL
...
###################################################################################################
[Components.$(FSP_ARCH)]
  ProtectedVariableFeaturePkg/KeyService/Pei/KeyServicePei.inf
  ProtectedVariableFeaturePkg/ProtectedVariableRecovery/Pei/PeiProtectedVariableRecovery.inf

[Components.X64]
  ProtectedVariableFeaturePkg/TrustedChannel/Smm/TrustedChannelSmm.inf
