/**@file
  Unit test main of the Mipi Camera Install Table Dxe driver.
...
#define UNIT_TEST_NAME     "MipiCamInstallTableDxe Unit Test"
...
UNIT_TEST_CASE_STRUCT mUnitTestCasesStruct [] = {
  {"Test-InitializeMipiCam-Case1",  "InitializeMipiCam",       UnitTestInitializeMipiCam,  PreInitializeMipiCam,   CleanUpInitializeMipiCam,  NULL,    0x00,        0},
};
  ...
  )
{
  ...
  UNIT_TEST_SUITE_HANDLE      UnitTestMipiCamInstallTableDxe;
  UINTN                       Index;
  ...
  Status = CreateUnitTestSuite (
             &UnitTestMipiCamInstallTableDxe,  // SuiteHandle  : Unit test suite to create
  ...
  for (Index = 0; Index < ARRAY_SIZE (mUnitTestCasesStruct); Index++) {
    Status = AddTestCase (
               UnitTestMipiCamInstallTableDxe,           // SuiteHandle        : Unit test suite to add test to
