...
0x1000
 ...
 External (\_SB.PC0X.I2C0, DeviceObj)
 External (\_SB.PC0X.I2C1, DeviceObj)
 External (\_SB.PC0X.I2C2, DeviceObj)
    ...
    If (LEqual (Arg0, 0)) { // If Control Logic Device0 is to be used
      If (LEqual (C0TP, 1)) { // If Type of control logic is Discrete
        Switch (ToInteger (L0BS)) { // I2C bus
          case (0) { Return (Package () {\_SB.DSC0, \_SB.PC0X.I2C0}) }
          case (1) { Return (Package () {\_SB.DSC0, \_SB.PC0X.I2C1}) }
          case (2) { Return (Package () {\_SB.DSC0, \_SB.PC0X.I2C2}) }
          case (3) { Return (Package () {\_SB.DSC0, \_SB.PC0X.I2C3}) }
          case (4) { Return (Package () {\_SB.DSC0, \_SB.PC0X.I2C4}) }
          case (5) { Return (Package () {\_SB.DSC0, \_SB.PC0X.I2C5}) }
          default { Return (Package () {\_SB.DSC0}) }
        }
      }
      If (LGreater (C0TP, 1)) { Return (Package () {\_SB.CLP0}) } // when Control Logic Type is of type PMIC add dependency on CLP0
    }
    If (LEqual (Arg0, 1)) { // If Control Logic Device1 is to be used
      If (LEqual (C1TP, 1)) { // If Type of control logic is Discrete
        Switch (ToInteger (L1BS)) { // I2C bus
          case (0) { Return (Package () {\_SB.DSC1, \_SB.PC0X.I2C0}) }
          case (1) { Return (Package () {\_SB.DSC1, \_SB.PC0X.I2C1}) }
          case (2) { Return (Package () {\_SB.DSC1, \_SB.PC0X.I2C2}) }
          case (3) { Return (Package () {\_SB.DSC1, \_SB.PC0X.I2C3}) }
          case (4) { Return (Package () {\_SB.DSC1, \_SB.PC0X.I2C4}) }
          case (5) { Return (Package () {\_SB.DSC1, \_SB.PC0X.I2C5}) }
          default { Return (Package () {\_SB.DSC1}) }
        }
      }
      If (LGreater (C1TP, 1)) { Return (Package () {\_SB.CLP1}) } // when Control Logic Type is of type PMIC add dependency on CLP1
    }
    If (LEqual (Arg0, 2)) { // If Control Logic Device2 is to be used
      If (LEqual (C2TP, 1)) { // If Type of control logic is Discrete
        Switch (ToInteger (L2BS)) { // I2C bus
          case (0) { Return (Package () {\_SB.DSC2, \_SB.PC0X.I2C0}) }
          case (1) { Return (Package () {\_SB.DSC2, \_SB.PC0X.I2C1}) }
          case (2) { Return (Package () {\_SB.DSC2, \_SB.PC0X.I2C2}) }
          case (3) { Return (Package () {\_SB.DSC2, \_SB.PC0X.I2C3}) }
          case (4) { Return (Package () {\_SB.DSC2, \_SB.PC0X.I2C4}) }
          case (5) { Return (Package () {\_SB.DSC2, \_SB.PC0X.I2C5}) }
          default { Return (Package () {\_SB.DSC2}) }
        }
      }
      If (LGreater (C2TP, 1)) { Return (Package () {\_SB.CLP2}) } // when Control Logic Type is of type PMIC add dependency on CLP2
    }
    If (LEqual (Arg0, 3)) { // If Control Logic Device3 is to be used
      If (LEqual (C3TP, 1)) { // If Type of control logic is Discrete
        Switch (ToInteger (L3BS)) { // I2C bus
          case (0) { Return (Package () {\_SB.DSC3, \_SB.PC0X.I2C0}) }
          case (1) { Return (Package () {\_SB.DSC3, \_SB.PC0X.I2C1}) }
          case (2) { Return (Package () {\_SB.DSC3, \_SB.PC0X.I2C2}) }
          case (3) { Return (Package () {\_SB.DSC3, \_SB.PC0X.I2C3}) }
          case (4) { Return (Package () {\_SB.DSC3, \_SB.PC0X.I2C4}) }
          case (5) { Return (Package () {\_SB.DSC3, \_SB.PC0X.I2C5}) }
          default { Return (Package () {\_SB.DSC3}) }
        }
      }
      If (LGreater (C3TP, 1)) { Return (Package () {\_SB.CLP3}) } // when Control Logic Type is of type PMIC add dependency on CLP2
    }
    If (LEqual (Arg0, 4)) { // If Control Logic Device4 is to be used
      If (LEqual (C4TP, 1)) { // If Type of control logic is Discrete
        Switch (ToInteger (L4BS)) { // I2C bus
          case (0) { Return (Package () {\_SB.DSC4, \_SB.PC0X.I2C0}) }
          case (1) { Return (Package () {\_SB.DSC4, \_SB.PC0X.I2C1}) }
          case (2) { Return (Package () {\_SB.DSC4, \_SB.PC0X.I2C2}) }
          case (3) { Return (Package () {\_SB.DSC4, \_SB.PC0X.I2C3}) }
          case (4) { Return (Package () {\_SB.DSC4, \_SB.PC0X.I2C4}) }
          case (5) { Return (Package () {\_SB.DSC4, \_SB.PC0X.I2C5}) }
          default { Return (Package () {\_SB.DSC4}) }
        }
      }
      If (LGreater (C4TP, 1)) { Return (Package () {\_SB.CLP4}) } // when Control Logic Type is of type PMIC add dependency on CLP2
    }
    If (LEqual (Arg0, 5)) { // If Control Logic Device5 is to be used
      If (LEqual (C5TP, 1)) { // If Type of control logic is Discrete
        Switch (ToInteger (L5BS)) { // I2C bus
          case (0) { Return (Package () {\_SB.DSC5, \_SB.PC0X.I2C0}) }
          case (1) { Return (Package () {\_SB.DSC5, \_SB.PC0X.I2C1}) }
          case (2) { Return (Package () {\_SB.DSC5, \_SB.PC0X.I2C2}) }
          case (3) { Return (Package () {\_SB.DSC5, \_SB.PC0X.I2C3}) }
          case (4) { Return (Package () {\_SB.DSC5, \_SB.PC0X.I2C4}) }
          case (5) { Return (Package () {\_SB.DSC5, \_SB.PC0X.I2C5}) }
          default { Return (Package () {\_SB.DSC5}) }
        }
      }
      If (LGreater (C5TP, 1)) { Return (Package () {\_SB.CLP5}) } // when Control Logic Type is of type PMIC add dependency on CLP2
    }
    ...
    Method (_DEP, 0, NotSerialized) {  // _DEP: Operation Region Dependencies
      If (CL00) { // If CLP0 device is to be enabled
        If (LEqual (C0IB, 2)) { // If PMIC needs I2C2 controller
          Return (Package () {\_SB.PC0X.I2C2})
        }
        If (LEqual (C0IB, 3)) { // If PMIC needs I2C3 controller
          Return (Package () {\_SB.PC0X.I2C3})
        }
      }
      Return (Package () {\_SB.PC0X})
    }
