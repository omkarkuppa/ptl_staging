/**@file
    Unit test main of the Firmware Volume Copy Lib driver.
...
#define UNIT_TEST_NAME     "FirmwareVolumeCopyLib Unit Test"
...
// Description-------------------------------------------------------Name-----------------------------------------------------------------------------Function---------------------------------------------------------------------- Prerequisite---------------------------CleanUpFunction----------------------Context---------Attribute-----Reserved
  { "UnitTestFirmwareVolumeCopyWithoutSpiDma",                       "FirmwareVolumeCopyWithoutSpiDma",                                               UnitTestFirmwareVolumeCopyWithoutSpiDma,                                       NULL,                                  NULL,                                NULL,           0,            0},
  { "UnitTestFirmwareVolumeCopyWithSpiDma",                          "FirmwareVolumeCopyWithSpiDma",                                                  UnitTestFirmwareVolumeCopyWithSpiDmaEnabled,                                   NULL,                                  NULL,                                NULL,           0,            0},
  { "FreeSpaceSkipEntryPointFvShadowPpiandSpiDmaPpiFound",           "FreeSpaceSkipEntryPointFvShadowPpiandSpiDmaPpiFound",                           UnitTestFreeSpaceSkipEntryPointFvShadowPpiandSpiDmaPpiFound,                   NULL,                                  NULL,                                NULL,           0,            0},
#if FixedPcdGetBool(PcdSpiDmaEnable) == 1
  { "FreeSpaceSkipEntryFvShadowNotFoundbutSpiDmaFound",              "FreeSpaceSkipEntryPointFvShadowPpiNotFoundandSpiDmaPpiFound",                   UnitTestFreeSpaceSkipEntryPointFvShadowPpiNotFoundandSpiDmaPpiFound,           NULL,                                  NULL,                                NULL,           0,            0},
#endif
};
