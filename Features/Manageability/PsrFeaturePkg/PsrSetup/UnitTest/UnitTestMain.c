...
#define UNIT_TEST_NAME     "PsrSetup Unit Test"
...
UNIT_TEST_CASE_STRUCT mUnitTestCasesStruct [] = {
  { "Test-PsrSetupInit",              "Test PsrSetupInit",              UnitTestPsrSetupInit,              PrePsrSetupInit,              CleanUpPsrSetupInit,              NULL,           0,            0},
  { "Test-UpdatePsrCapabilitiesInfo", "Test UpdatePsrCapabilitiesInfo", UnitTestUpdatePsrCapabilitiesInfo, PreUpdatePsrCapabilitiesInfo, CleanUpUpdatePsrCapabilitiesInfo, NULL,           0,            0},
  { "Test-GetPsrEventSource",         "Test GetPsrEventSource",         UnitTestGetPsrEventSource,         PreGetPsrEventSource,         CleanUpGetPsrEventSource,         NULL,           0,            0},
  { "Test-GetPsrEventStatus",         "Test GetPsrEventStatus",         UnitTestGetPsrEventStatus,         PreGetPsrEventStatus,         CleanUpGetPsrEventStatus,         NULL,           0,            0},
  { "Test-GetPsrEventAction",         "Test GetPsrEventAction",         UnitTestGetPsrEventAction,         PreGetPsrEventAction,         CleanUpGetPsrEventAction,         NULL,           0,            0},
  { "Test-GetPsrEventName",           "Test GetPsrEventName",           UnitTestGetPsrEventName,           PreGetPsrEventName,           CleanUpGetPsrEventName,           NULL,           0,            0},
  { "Test-GetPsrLogState",            "Test GetPsrLogState",            UnitTestGetPsrLogState,            PreGetPsrLogState,            CleanUpGetPsrLogState,            NULL,           0,            0},
  { "Test-CountOfLeapYearsInRange",   "Test CountOfLeapYearsInRange",   UnitTestCountOfLeapYearsInRange,   PreCountOfLeapYearsInRange,   CleanUpCountOfLeapYearsInRange,   NULL,           0,            0},
  { "Test-UnixTimeStampToDate",       "Test UnixTimeStampToDate",       UnitTestUnixTimeStampToDate,       PreUnixTimeStampToDate,       CleanUpUnixTimeStampToDate,       NULL,           0,            0},
  { "Test-ConvertToString",           "Test ConvertToString",           UnitTestConvertToString,           PreConvertToString,           CleanUpConvertToString,           NULL,           0,            0},
  { "Test-StrTrim",                   "Test StrTrim",                   UnitTestStrTrim,                   PreStrTrim,                   CleanUpStrTrim,                   NULL,           0,            0},
  { "Test-PsrGetInfo",                "Test PsrGetInfo",                UnitTestPsrGetInfo,                PrePsrGetInfo,                CleanUpPsrGetInfo,                NULL,           0,            0},
};
  ...
  )
{
  ...
  UNIT_TEST_SUITE_HANDLE        UnitTestPsrSetup;
  UINTN                         Index;
  ...
  Status = CreateUnitTestSuite (
             &UnitTestPsrSetup,        // SuiteHandle  : Unit test suite to create
  ...
  for (Index = 0; Index < ARRAY_SIZE (mUnitTestCasesStruct); Index++) {
    Status = AddTestCase (
               UnitTestPsrSetup,                         // SuiteHandle        : Unit test suite to add test to
