/** @file
  Clean-up functions of the StrTrim function.
...
#include "CleanUpStrTrim.h"
#include "PrivateMock.h"

/**
  Clean up all variables used in testing StrTrim function.
  @retval     EFI_SUCCESS                 Clean up success.
**/
EFI_STATUS
EFIAPI
CleanStrTrimEnvironment (
  VOID
  )
{
  ...
  )
{
  ...
  Status = CleanStrTrimEnvironment ();
