  ...
  )
{
  ...
  //
  gReturnResult = AllocateZeroPool (sizeof (CHAR8) * MAX_POWER_SEC_DIGITS);
  ...
  )
{
  ...
  Status = SetupConvertToStringEnvironment ();
  UT_ASSERT_NOT_EFI_ERROR (Status);

  //
  // Running platform function
  //
  ConvertToString (123456789, (CHAR8*)gReturnResult);
