<!--
@file
 This file provide the details for Memory Telemetry feature.
...
* PeiMemoryTelemetry.inf
* DxeMemoryTelemetry.inf

## Configuration

* BIOS will implement feature as it is enabled by default.
* PCD for managing enablement: PcdMemoryTelemetryEnabled
...
* Driver is always enabled through PcdMemoryTelemetryEnabled
...
1. Add MemoryTelemetryFeaturePkg.dsc entry and path to the build file and check if all required packages/libraries exist for this package.
2. Add MemoryTelemetryPreMemFeaturePkg.fdf entry and path to the Pre-Memory flash map file.
3. Add MemoryTelemetryPostMemFeaturePkg.fdf entry and path to the Post-Memory flash map file.
