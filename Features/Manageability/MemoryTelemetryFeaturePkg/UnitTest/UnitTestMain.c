...
#define UNIT_TEST_NAME     "Memory Telemetry Unit Test"
#define UNIT_TEST_VERSION  "0.2"
...
UNIT_TEST_CASE_STRUCT mUnitTestCasesStruct [] = {
  {"Verify Memory Telemetry Table fill from MRC Data",         "VerifyUpdateMemoryTelemetryTable",       VerifyUpdateMemoryTelemetryTable,       NULL, NULL, NULL, 0,0},
  {"Test IsAmtPprSupported with PCD enabled",                  "TestIsAmtPprSupportedEnabled",           TestIsAmtPprSupportedEnabled,           NULL, NULL, NULL, 0,0},
  {"Test IsAmtPprSupported with PCD disabled",                 "TestIsAmtPprSupportedDisabled",          TestIsAmtPprSupportedDisabled,          NULL, NULL, NULL, 0,0},
  {"Test UpdatePprMrcPolicy with AMT and PPR enabled",         "TestUpdatePprMrcPolicyAmtPprEnabled",    TestUpdatePprMrcPolicyAmtPprEnabled,    NULL, NULL, NULL, 0,0},
  {"Test UpdatePprMrcPolicy with AMT enabled, PPR disabled",   "TestUpdatePprMrcPolicyAmtOnlyEnabled",   TestUpdatePprMrcPolicyAmtOnlyEnabled,   NULL, NULL, NULL, 0,0},
  {"Test UpdatePprMrcPolicy with AMT disabled",                "TestUpdatePprMrcPolicyAmtDisabled",      TestUpdatePprMrcPolicyAmtDisabled,      NULL, NULL, NULL, 0,0},
  {"Test UpdatePprMrcPolicy with NULL parameter",              "TestUpdatePprMrcPolicyNullParameter",    TestUpdatePprMrcPolicyNullParameter,   NULL, NULL, NULL, 0,0},
  {"Test GetAmtPprEnableVar variable structure exists",        "TestGetAmtPprEnableVarExists",           TestGetAmtPprEnableVarExists,          NULL, NULL, NULL, 0,0},
  {"Test GetAmtPprEnableVar variable structure not exists",    "TestGetAmtPprEnableVarNotExists",        TestGetAmtPprEnableVarNotExists,       NULL, NULL, NULL, 0,0}
};
  ...
  )
{
  ...
  UNIT_TEST_SUITE_HANDLE        UnitTestPsrDxe;
  UINTN                         Index;
  ...
  Status = CreateUnitTestSuite (
             &UnitTestPsrDxe,          // SuiteHandle  : Unit test suite to create
  ...
  for (Index = 0; Index < ARRAY_SIZE (mUnitTestCasesStruct); Index++) {
    Status = AddTestCase (
               UnitTestPsrDxe,                           // SuiteHandle        : Unit test suite to add test to
