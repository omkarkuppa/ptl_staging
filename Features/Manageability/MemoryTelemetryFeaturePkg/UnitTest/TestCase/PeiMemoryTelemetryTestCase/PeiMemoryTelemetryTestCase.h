/** @file
  Unit test case for PEI Memory Telemetry AMT PPR functionality.
...
#ifndef _PEI_AMT_PPR_TEST_CASE_H_
#define _PEI_AMT_PPR_TEST_CASE_H_
...
//
// Test context structure for AMT PPR tests
//
typedef struct {
  AMT_PPR_ENABLE           AmtPprVariable;
  MEMORY_CONFIG_NO_CRC     MemConfig;
  BOOLEAN                  PcdPprCapability;
  BOOLEAN                  VariableExists;
} AMT_PPR_TEST_CONTEXT;
...
#endif // _PEI_AMT_PPR_TEST_CASE_H_
