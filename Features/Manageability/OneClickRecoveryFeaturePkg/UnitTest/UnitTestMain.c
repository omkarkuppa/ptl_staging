/**@file
  Unit test main of the One Click Recovery Dxe driver.
...
#define UNIT_TEST_NAME     "One Click Recovery Unit Tests"
  ...
  )
{
  ...
  UNIT_TEST_SUITE_HANDLE        UnitTestOcrDxe;
  UINTN                         Index;
  ...
  Status = CreateUnitTestSuite (
             &UnitTestOcrDxe,          // SuiteHandle  : Unit test suite to create
