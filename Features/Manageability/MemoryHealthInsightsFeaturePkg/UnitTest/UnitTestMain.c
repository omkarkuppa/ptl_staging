/** @file
  Unit test main of the Memory Health Insights driver.
...
#define UNIT_TEST_NAME     "Memory Health Insights Unit Test"
...
UNIT_TEST_CASE_STRUCT mUnitTestCasesStruct [] = {
  {"Verify MHI Table fill from MRC Data",   "VerifyUpdateMhiTable", VerifyUpdateMhiTable, NULL, NULL, NULL, 0,0}
};
