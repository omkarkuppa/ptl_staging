/** @file
  ...
  express purpose of unit testing the Memory health insights
  feature.
...
//
#define MAX_RANK_IN_CHANNEL       (4)       ///< The maximum number of ranks per channel. NVL supports 2DPC DDR5
#define MAX_SDRAM_IN_DIMM         (5)       ///< The maximum number of SDRAMs per DIMM. NVL Supports ECC DDR5
