...
//
GLOBAL_REMOVE_IF_UNREFERENCED EFI_COMPONENT_NAME_PROTOCOL  gPlatformOpalComponentName = {
...
//
GLOBAL_REMOVE_IF_UNREFERENCED EFI_COMPONENT_NAME2_PROTOCOL gPlatformOpalComponentName2 = {
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_UNICODE_STRING_TABLE mPlatformOpalDriverNameTable[] = {
...
{
  return (PlatformGetControllerName ( ControllerHandle, ChildHandle, Language, ControllerName));
}
