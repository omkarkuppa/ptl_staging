/**@file
    Unit test case mock header for OpalDiskUpdateOwnerShip.
...
@par Specification
**/
#ifndef _OPAL_UPDATE_OWNERSHIP_MOCK_H_
#define _OPAL_UPDATE_OWNERSHIP_MOCK_H_
...
#endif /*_OPAL_UPDATE_OWNERSHIP_MOCK_H_*/
