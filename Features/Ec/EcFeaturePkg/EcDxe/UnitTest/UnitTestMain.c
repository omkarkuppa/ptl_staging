/**@file
    Unit test main of the Ec Dxe driver.
...
#define UNIT_TEST_NAME     "EcDxe Unit Test"
...
UNIT_TEST_CASE_STRUCT mUnitTestCasesStruct [] = {
  { "UnitTestUpdateAcpiDataTableSsdt",         "UpdateAcpiDataTable",     UnitTestUpdateAcpiDataTableSsdt,  NULL,                                  NULL,                                NULL,           0,            0},
  { "UnitTestUpdateAcpiDataTableEcdt",         "UpdateAcpiDataTable",     UnitTestUpdateAcpiDataTableEcdt,  NULL,                                  NULL,                                NULL,           0,            0},
  { "UnitTestInstallSsdtAcpiTableSsdt",        "InstallSsdtAcpiTable",    UnitTestInstallSsdtAcpiTableSsdt, NULL,                                  NULL,                                NULL,           0,            0},
  { "UnitTestInstallSsdtAcpiTableEcdt",        "InstallSsdtAcpiTable",    UnitTestInstallSsdtAcpiTableEcdt, NULL,                                  NULL,                                NULL,           0,            0},
  { "UnitTestInstallEcSsdt",                   "InstallEcSsdt",           UnitTestInstallEcSsdt,            NULL,                                  NULL,                                NULL,           0,            0},
  { "UnitTestEcDxeInitialize",                 "EcDxeInitialize",         UnitTestEcDxeInitialize,          NULL,                                  NULL,                                NULL,           0,            0},
};
