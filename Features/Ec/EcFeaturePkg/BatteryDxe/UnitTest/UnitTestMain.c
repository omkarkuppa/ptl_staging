/**@file
    Unit test main of the Battery Dxe driver.
...
#define UNIT_TEST_NAME     "BatteryDxe Unit Test"
...
UNIT_TEST_CASE_STRUCT mUnitTestCasesStruct [] = {
  { "UnitTestGetBatteryInformationRealBat",    "GetBatteryInformation",     UnitTestGetBatteryInformationRealBat,    NULL,                                  NULL,                                NULL,           0,            0},
  { "UnitTestGetBatteryInformationVirtualBat", "GetBatteryInformation",     UnitTestGetBatteryInformationVirtualBat, NULL,                                  NULL,                                NULL,           0,            0},
  { "UnitTestGetBatteryStatus",                "GetBatteryStatus",          UnitTestGetBatteryStatus,                NULL,                                  NULL,                                NULL,           0,            0},
  { "UnitTestBatteryEnableCharging",           "BatteryEnableCharging",     UnitTestBatteryEnableCharging,           NULL,                                  NULL,                                NULL,           0,            0},
  { "UnitTestInstallBatteryProtocol",          "InstallBatteryProtocol",    UnitTestInstallBatteryProtocol,          NULL,                                  NULL,                                NULL,           0,            0},
};
