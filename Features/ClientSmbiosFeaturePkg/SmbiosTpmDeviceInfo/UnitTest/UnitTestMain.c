/**@file
  Unit test case of the Smbios Tpm Device Info driver.
...
//
#include "TestCase/SmbiosTpmDeviceInfoTestCase.h"

#define UNIT_TEST_NAME     "SmbiosTpmDeviceInfo Unit Test"
  ...
  )
{
  ...
  UNIT_TEST_SUITE_HANDLE        UnitTestSmbiosTpmDeviceInfo;
  UINTN                         Index;
  ...
  Status = CreateUnitTestSuite (
             &UnitTestSmbiosTpmDeviceInfo,  // SuiteHandle  : Unit test suite to create
  ...
  for (Index = 0; Index < ARRAY_SIZE (mUnitTestCasesStruct); Index++) {
    Status = AddTestCase (
               UnitTestSmbiosTpmDeviceInfo,              // SuiteHandle        : Unit test suite to add test to
