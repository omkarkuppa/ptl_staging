...
#define UNIT_TEST_SMBIOS_STRING L"StringForSmbiosUnitTest"

extern EFI_SMBIOS_TABLE_HEADER  *gSmbiosTable[DEFAULT_SMBIOS_PLATFORM_INFO_SIZE];
extern EFI_SMBIOS_PROTOCOL      *gSmbiosProtocol;
extern UINTN                    gSmbiosTableIndex;
/**
