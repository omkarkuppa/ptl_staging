...
#define UNIT_TEST_NAME     "SmbiosMiscDxe Unit Test"
...
UNIT_TEST_CASE_STRUCT mUnitTestCasesStruct [] = {
  { "Test-AddSmbiosT24Callback",      "Test SmBios 24",                UnitTestAddSmbiosT24Callback,     PreAddSmbiosT24Callback,     CleanUpSmbiosType24,                 NULL,           0,            0},
  { "Test-AddSmbiosT14Callback",      "Test SmBios 14",                UnitTestAddSmbiosT14Callback,     PreAddSmbiosT14Callback,     CleanUpSmbiosType14,                 NULL,           0,            0},
  { "Test-AddSmbiosRecord",           "Test AddSmbiosRecord",          UnitTestAddSmbiosRecord,          PreAddSmbiosRecord,          CleanUpAddSmbiosRecord,              NULL,           0,            0},
  { "Test-UpdateMiscSmbios",          "Test UpdateMiscSmbios",         UnitTestUpdateMiscSmbios,         PreUpdateMiscSmbios,         CleanUpUpdateMiscSmbios,             NULL,           0,            0},
  { "Test-UpdateMiscSmbiosCallback",  "Test UpdateMiscSmbiosCallback", UnitTestUpdateMiscSmbiosCallback, PreUpdateMiscSmbiosCallback, CleanUpUpdateMiscSmbiosCallback,     NULL,           0,            0},
  { "Test-SmbiosStrInit",             "Test SmbiosStrInit",            UnitTestSmbiosStrInit,            NULL,                        NULL,                                NULL,           0,            0},
  { "Test-SmbiosStringsUpdate",       "Test SmbiosStringsUpdate",      UnitTestSmbiosStringsUpdate,      NULL,                        NULL,                                NULL,           0,            0},
  { "Test-SmbiosMiscEntryPoint",      "Test SmbiosMiscEntryPoint",     UnitTestSmbiosMiscEntryPoint,     PreSmbiosMiscEntryPoint,     CleanUpSmbiosMiscEntryPoint,         NULL,           0,            0},
  { "Test-MiscCommonSmbiosFunction",  "Test MiscCommonSmbiosFunction", UnitTestMiscCommonSmbiosFunction, PreMiscCommonSmbiosFunction, CleanUpMiscCommonSmbiosFunction,     NULL,           0,            0},
};
/**
  ...
  )
{
  ...
  UNIT_TEST_SUITE_HANDLE        UnitTestSmbiosMiscDxe;
  UINTN                         Index;
  ...
  Status = CreateUnitTestSuite (
             &UnitTestSmbiosMiscDxe,  // SuiteHandle  : Unit test suite to create
  ...
  for (Index = 0; Index < ARRAY_SIZE (mUnitTestCasesStruct); Index++) {
    Status = AddTestCase (
               UnitTestSmbiosMiscDxe,                    // SuiteHandle        : Unit test suite to add test to
