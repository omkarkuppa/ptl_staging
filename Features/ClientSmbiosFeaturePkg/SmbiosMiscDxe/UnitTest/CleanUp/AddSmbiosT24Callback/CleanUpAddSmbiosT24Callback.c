/** @file
  Clean-up functions of the AddSmbiosT24Callback function.
...
@par Specification
**/
#include "CleanUpAddSmbiosT24Callback.h"
...
/**
  Clean up all variables used in testing AddSmbiosT24Callback function.
  ...
  )
{
  ...
  Status = CleanSmbiosT24Environment ();
