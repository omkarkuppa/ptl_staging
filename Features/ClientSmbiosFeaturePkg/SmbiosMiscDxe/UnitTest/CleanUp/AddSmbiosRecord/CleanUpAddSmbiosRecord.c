/** @file
  Clean-up functions of the AddSmbiosRecord function.
...
@par Specification
**/
#include "CleanUpAddSmbiosRecord.h"
#include <Library/DebugLib.h>
#include <Library/MemoryAllocationLib.h>
#include <PrivateMock.h>

/**
  Clean up all variables used in testing AddSmbiosRecord function.
...
EFI_STATUS
EFIAPI
CleanAddSmbiosRecordEnvironment(
  )
{
  UINTN Index;
  ...
  )
{
  ...
  Status = CleanAddSmbiosRecordEnvironment ();
  if (EFI_ERROR (Status)) {
