/** @file
  Clean-up functions of the AddSmbiosT14Callback function.
...
@par Specification
**/
#include "CleanUpAddSmbiosT14Callback.h"
...
/**
  Clean up all variables used in testing AddSmbiosT14Callback function.
  ...
  )
{
  ...
  Status = CleanSmbiosT14Environment ();
  if (EFI_ERROR (Status)) {
