/** @file
  Clean-up functions of the UpdateMiscSmbios function.
...
@par Specification
**/
#include "CleanUpUpdateMiscSmbios.h"
...
/**
  Clean up all variables used in testing UpdateMiscSmbios function.
...
EFI_STATUS
EFIAPI
CleanUpdateMiscSmbiosEnvironment(
  )
{
  UINTN Index;
  ...
  )
{
  ...
  Status = CleanUpdateMiscSmbiosEnvironment ();
  if (EFI_ERROR (Status)) {
