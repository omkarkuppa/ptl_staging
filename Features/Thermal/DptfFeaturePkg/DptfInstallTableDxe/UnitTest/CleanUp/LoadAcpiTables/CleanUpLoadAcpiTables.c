/** @file
    Clean-up functions of the LoadAcpiTables function.
  @copyright
  INTEL CONFIDENTIAL
...
@par Specification
**/
#include "CleanUpLoadAcpiTables.h"
#include "PrivateMock.h"
#include <Library/BaseMemoryLib.h>
#include <Library/MemoryAllocationLib.h>

/**
  Clean up all variables used in testing LoadAcpiTables function.
  @retval     EFI_SUCCESS                 Clean up success.
**/
EFI_STATUS
EFIAPI
CleanLoadAcpiTablesEnvironment (
  )
{
...
UNIT_TEST_STATUS
EFIAPI
CleanUpLoadAcpiTables (
  IN UNIT_TEST_CONTEXT  Context
  )
{
  EFI_STATUS   Status;

  Status = CleanLoadAcpiTablesEnvironment ();
