...
Name(_DSD, Package() {
    ...
    Package () {
       ...
       Package (2) {"acpi-acd-endpoint-count", 2},    // 8 Endpoints: Headphones, LineOut
    },
    ToUUID("dbb8e3e6-5886-4ba6-8795-1319f52a966b"),    // Hierarchical Data Extension UUID
    Package () {
       Package (2) {"acpi-acd-endpoint-0-properties", "EP02"},     // Configuration for Headphones
       Package (2) {"acpi-acd-endpoint-1-properties", "EP03"},     // Configuration for LineOut
    }
}) //End _DSD
