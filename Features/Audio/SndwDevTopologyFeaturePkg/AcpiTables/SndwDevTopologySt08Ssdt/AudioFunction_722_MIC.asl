...
Name(_DSD, Package()
{
  ...
  Package ()
  {
    ...
    // Cluster Library
    Package (2) {"mipi-sdca-cluster-id-list", Package() {0x11, 0x21, 0x31} },
  },
...
Name(E013, Package()
{
  ...
  Package ()
  {
    ...
    Package (2) {"mipi-sdca-entity-label", "CS 11"}, // = CS 13 in ALC722 internal spec
...
Name(CLM2, Buffer()
{
  0x02, 0x00,  // Range type 2 parameters
  0x01, 0x00,  // Count of ranges = 0x1
  0x01, 0x00, 0x00, 0x00, 0x31, 0x00, 0x00, 0x00, // Cluster Index = 0x01, Cluster ID = 0x31
}) //End CLM2
