    ...
    Package () {
       ...
       Package (2) {"acpi-acd-connection-0-properties",
          Buffer()
          {
             0x01,
             0x00, 0x01, 0x00, 0x00,
             0x01, 0x16, 0x13, 0x5D, 0x02, 0x31, 0x01, 0x00, 0x01
          }
       },
       Package (2) {"acpi-acd-connection-1-properties",
          Buffer()
          {
             0x01,
             0x00, 0x02, 0x00, 0x00,
             0x01, 0x16, 0x13, 0x5D, 0x02, 0x30, 0x02, 0x00, 0x01
          }
       },
    }
}) //End VN00
   ...
   Package () {
      ...
      Package (2) {"acpi-acd-connection-0-properties",
                        Buffer()
                        {
                           0x02,
                           0x00, 0x03, 0x00, 0x00,
                           0x01, 0x14, 0x07, 0x5D, 0x02, 0x30, 0x03, 0x00, 0x06
                        }
                  },
   }
}) //End VN01
...
Name(CC11, Package() {
   ToUUID("daffd814-6eba-4d8c-8a91-bc9bbf4aa301"),    // Device Properties UUID
   Package () {
      Package (2) {"acpi-acd-device-namestring", "\\_SB.PC00.HDAS.IDA.SNDW.SWD3.AF02"},
      Package (2) {"acpi-acd-device-type", 1},    // 0: Generic, 1: SoundWire
   ...
   Package () {
      ...
      Package (2) {"acpi-acd-connection-0-properties",
                        Buffer()
                        {
                           0x01,
                           0x00, 0x00, 0x00, 0x00,
                           0x01, 0x11, 0x07, 0x5D, 0x02, 0x30, 0x00, 0x00, 0x03
                        }
                  },
   }
}) //End VN02
   ...
   Package () {
      ...
      Package (2) {"acpi-acd-connection-0-properties",
                        Buffer()
                        {
                           0x02,
                           0x00, 0x00, 0x00, 0x00,
                           0x01, 0x11, 0x07, 0x5D, 0x02, 0x30, 0x00, 0x00, 0x02
                        }
                  },
   }
}) //End VN05
