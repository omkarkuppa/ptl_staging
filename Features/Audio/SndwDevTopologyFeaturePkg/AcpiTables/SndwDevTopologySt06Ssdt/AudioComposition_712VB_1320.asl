...
Name(_DSD, Package() {
   ...
   Package () {
    ...
    Package (2) {"acpi-acd-endpoint-7-properties", "ERA1"},   // Configuration for ALC1320 Speaker
   }
}) //End _DSD
...
Name(ERA1, Package()
{
  ...
  Package ()
  {
    Package (2) {"acpi-acd-endpoint-config-0-properties", "CRA1"},
  }
})  //End ERA1
...
Name(CRA1, Package()
{
  ...
  Package ()
  {
    Package (2) {"acpi-acd-collection-0-properties", "RA10"}, // DSP Configuration
    Package (2) {"acpi-acd-collection-1-properties", "RA11"}, // Sdca Audio Function Configuration
  }
})  //End CRA1
...
Name(RA10, Package()
{
  ...
  {
    Package (2) {"msft-acx-properties", "AC00"}, // Acx specific properties
    Package (2) {"acpi-acd-vendor-collection-properties", "VNA1"},
  }
})  //End RA10
...
Name(VNA1, Package()
{   // Passed in as an AcxObjectBag during circuit creation. Contents of this package are proprietary.
  ToUUID("daffd814-6eba-4d8c-8a91-bc9bbf4aa301"), // Device Properties UUID
  Package ()
  {
    Package (2) {"acpi-vendor-id", 0x1},
    ...
    Package (2) {"acpi-acd-connection-0-properties",
      ...
      {
        0x01,
        0x00, 0x02, 0x00, 0x00,              //LID=0x02
        0x00, 0x20, 0x13, 0x5D, 0x02, 0x30, 0x02, 0x00,  // ALC1320 , UID=0x03 , LID=0x02
        0x01
      }
    },
  }
