...
Name(PDPN, Package()
{
    ...
    Package()
    {
        ...
        Package(2) {"mipi-sdw-channel-number-list", Package() {0, 1} },         // Integer: Allow channels 0 and 1, may need to update this on a per Jamerson basis.
        ...
        Package(2) {"mipi-sdw-block-packing-mode ", 1},                         // Boolean: Block packing modes are supported on Jamerson
