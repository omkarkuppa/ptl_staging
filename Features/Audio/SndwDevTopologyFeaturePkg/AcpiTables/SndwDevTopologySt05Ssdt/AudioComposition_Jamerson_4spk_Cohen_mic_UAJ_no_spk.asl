...
Name(_DSD, Package() {
    ...
    Package () {
       ...
       Package (2) {"acpi-acd-endpoint-count", 7},    // 7 Endpoints: Internal Microphone, Headphones, LineOut, HeadsetOutput, Stereo Microphone, LineIn, HeadsetMic
    },
    ToUUID("dbb8e3e6-5886-4ba6-8795-1319f52a966b"),    // Hierarchical Data Extension UUID
    Package () {
       Package (2) {"acpi-acd-endpoint-0-properties", "EP01"},     // Configuration for Internal Microphone
       ...
       Package (2) {"acpi-acd-endpoint-4-properties", "EP05"},     // Configuration for Stereo Microphone
