...
Name(_DSD, Package() {
    ...
    Package () {
       ...
       Package (2) {"acpi-acd-endpoint-count", 8},    // 8 Endpoints: Aggregated Speaker, Internal Microphone, Headphones, LineOut, HeadsetOutput, Stereo Microphone, LineIn, HeadsetMic
    },
    ...
    Package () {
       ...
       Package (2) {"acpi-acd-endpoint-1-properties", "EP01"},     // Configuration for Internal Microphone
       ...
       Package (2) {"acpi-acd-endpoint-5-properties", "EP05"},     // Configuration for Stereo Microphone
...
Name(CC21, Package() {
    ...
    Package () {
#ifdef _AMD
       Package (2) {"acpi-acd-device-namestring", "\\_SB.PCI0.GP17.ACP.SDWC.SWD6.AF03"},
#else
       Package (2) {"acpi-acd-device-namestring", "\\_SB.PC00.HDAS.IDA.SNDW.SWD6.AF03"},
#endif
