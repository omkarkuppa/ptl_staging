...
# define FEATURE_CS35L63_AMP_NO_VOL_MUTE_R_COND  0x00000020
#endif

#ifndef CS35L63_FU_21_VOL_MIN
// Min = 0x00009A00 (-102.0 dB) in Q7.8 format
# define CS35L63_FU_21_VOL_MIN 0x00, 0x9A, 0x00, 0x00
#endif

#ifndef CS35L63_FU_21_VOL_MAX
// Max = 0x00000C00 (+12.0 dB) in Q7.8 format
# define CS35L63_FU_21_VOL_MAX 0x00, 0x0C, 0x00, 0x00
#endif

#ifndef CS35L63_FU_21_VOL_FIXED_Q7_8
// Fixed = 0x00000C00 (+12 dB) in Q7.8 format
# define CS35L63_FU_21_VOL_FIXED_Q7_8 0x00000C00
#endif

#ifndef CS35L63_FU_21_VOL_STEP
// Step = 0x00000008 (0.03125 dB per step) in Q7.8 format
# define CS35L63_FU_21_VOL_STEP 0x08, 0x00, 0x00, 0x00
#endif

#ifndef CS35L63_FU_21_VOL_DEFAULT
// Default = 0x0 (0 dB) in Q7.8 format
# define CS35L63_FU_21_VOL_DEFAULT 0x0
#endif

#ifndef CS35L63_FU_23_VOL_MIN
// Min = 0x00009A00 (-102.0 dB) in Q7.8 format
# define CS35L63_FU_23_VOL_MIN 0x00, 0x9A, 0x00, 0x00
#endif

#ifndef CS35L63_FU_23_VOL_MAX
// Max = 0x00000C00 (+12.0 dB) in Q7.8 format
# define CS35L63_FU_23_VOL_MAX 0x00, 0x0C, 0x00, 0x00
#endif

#ifndef CS35L63_FU_23_VOL_STEP
// Step = 0x00000008 (0.03125 dB per step) in Q7.8 format
# define CS35L63_FU_23_VOL_STEP 0x08, 0x00, 0x00, 0x00
#endif

#ifndef CS35L63_FU_23_VOL_DEFAULT
// Default = 0x0 (0 dB) in Q7.8 format
# define CS35L63_FU_23_VOL_DEFAULT 0x0
#endif
...
#ifdef BUFFETT_DISABLE_REF_STREAM
# define _SMART_AMP_REFERENCE_STREAM_FEATURE_BITS   0
#else
# define _SMART_AMP_REFERENCE_STREAM_FEATURE_BITS   (1 << 5) | (1 << 6)
#endif

#ifdef BUFFETT_DISABLE_US_STREAM
# define _SMART_AMP_US_STREAM_FEATURE_BITS          0
#else
# define _SMART_AMP_US_STREAM_FEATURE_BITS          (1 << 2)
#endif

#define BUFFETT_RENDER_STREAM_ENTITY_ID_LIST         0x3, 0x2, 0x4, 0x1A, 0x8, 0x9, 0xA, 0xB, 0xE, 0xD, 0x6, 0xC,
#define BUFFETT_VOLUME_STREAM_ENTITY_ID_LIST_VOLUME  0x05,
#define BUFFETT_REF_STREAM_ENTITY_ID_LIST            0xF, 0x10,
#define BUFFETT_US_STREAM_ENTITY_ID_LIST             0x16, 0x15, 0x17, 0x18, 0x19,
#define BUFFETT_SPEAKER_SENSE_ENTITY_ID_LIST         0x13, 0x14, 0x11
...
{ // Function Descriptor
    ...
    Package()
    {
        ...
        Package(2) {"mipi-sdca-control-list",  (CTL_E0_FUNCTION_VERSION | CTL_E0_FUNCTION_ID | CTL_E0_FUNCTION_MANUFACTURER_ID |
                                                CTL_E0_FUNCTION_TYPE | CTL_E0_FUNCTION_SDCA_VERSION | CTL_E0_FUNCTION_STATUS | CTL_E0_FUNCTION_ACTION |
        ...
        Package(2) {"mipi-sdca-entity-id-list", Package() {
            BUFFETT_RENDER_STREAM_ENTITY_ID_LIST
#ifndef EXCLUDE_FU_21_VOLUME_CONTROL
            BUFFETT_VOLUME_STREAM_ENTITY_ID_LIST_VOLUME
#endif
#ifndef BUFFETT_DISABLE_REF_STREAM
            BUFFETT_REF_STREAM_ENTITY_ID_LIST
#endif
#ifndef BUFFETT_DISABLE_US_STREAM
            BUFFETT_US_STREAM_ENTITY_ID_LIST
#endif
    ...
    Package()
    {
        ...
        Package(2) { "mipi-sdca-control-0x11-subproperties", "C011"},
...
Name(EXT0, Package()
{
    ...
    Package()
    {
        ...
        Package(2) { "01fa-chip-id", BUFFETT_CHIP_ID },
...
Name(C006, Package()
{
    ...
    {   // Class, DC, Function_Manufacturer_Id = 0x01FA
        Package(2) {"mipi-sdca-control-access-layer", CAL_CLASS},
        Package(2) {"mipi-sdca-control-access-mode", CAM_DC},
        Package(2) {"mipi-sdca-control-dc-value", BUFFETT_MANUFACTURER_ID},
    }
}) //End C006
...
Name(C007, Package()
{
    ToUUID("daffd814-6eba-4d8c-8a91-bc9bbf4aa301"),
    Package()
    {   // Class, DC, Function_Id = 0x3563
        Package(2) {"mipi-sdca-control-access-layer", CAL_CLASS},
        Package(2) {"mipi-sdca-control-access-mode", CAM_DC},
        Package(2) {"mipi-sdca-control-dc-value", BUFFETT_CHIP_ID},
    }
}) //End C007
...
Name(C02D, Package()
{
    ...
    Package()
    {
        // Device_Part_ID: Class, DC = 0x3563
        Package(2) { "mipi-sdca-control-access-layer", CAL_CLASS},
        Package(2) { "mipi-sdca-control-access-mode", CAM_DC},
        Package(2) { "mipi-sdca-control-dc-value", BUFFETT_CHIP_ID},
    }
...
Name(C02E, Package()
{
    ...
    Package()
    {
        // Device_Version: Class, DC = 0xA0
        Package(2) { "mipi-sdca-control-access-layer", CAL_CLASS},
        Package(2) { "mipi-sdca-control-access-mode", CAM_DC},
        Package(2) { "mipi-sdca-control-dc-value", BUFFETT_CHIP_REV_ID},
    }
}) // End C02E
...
Name(BUF5, Buffer()
{
    ...
    //0x0C, 0x00, 0x00, 0x00, 0x88, 0x58, 0x01, 0x00, // SampleRateIndex = 0x0000000C, SampleRate = 88200 (0x00015888)
    //0x11, 0x00, 0x00, 0x00, 0x40, 0x1F, 0x00, 0x00, // SampleRateIndex = 0x00000011, SampleRate = 8000  (0x00001F40)
    //0x12, 0x00, 0x00, 0x00, 0x80, 0x3E, 0x00, 0x00, // SampleRateIndex = 0x00000012, SampleRate = 16000 (0x00003E80)
}) //End BUF5
#else
Name(BUF5, Buffer()
{
...
Name(C026, Package()
{
    ...
    {  // Volume, User, RW/Dual
        ...
        Package(2) {"mipi-sdca-control-fixed-value", CS35L63_FU_21_VOL_FIXED_Q7_8},
#else
        Package(2) {"mipi-sdca-control-default-value", CS35L63_FU_21_VOL_DEFAULT},
#endif
    },
    ToUUID("edb12dd0-363d-4085-a3d2-49522ca160c4"),
    Package()
...
Name(BUF4, Buffer()
{
    ...
    0x01, 0x00,  // Count of ranges = 0x1
    CS35L63_FU_21_VOL_MIN,
    CS35L63_FU_21_VOL_MAX,
    CS35L63_FU_21_VOL_STEP,
}) //End BUF4
...
Name(C039, Package() {
    ...
    Package () {
        Package (2) {"mipi-sdca-control-access-layer", CAL_CLASS},
        Package (2) {"mipi-sdca-control-access-mode", CAM_RO},
        //Package (2) {"mipi-sdca-control-interrupt-position", 10}, // CS35L56 rev B0.
    }
}) //End C039
...
Name(C042, Package() {
    ...
    Package () {
        Package (2) {"mipi-sdca-control-access-layer", CAL_CLASS},
        Package (2) {"mipi-sdca-control-access-mode", CAM_DC},
        Package (2) {"mipi-sdca-control-dc-value", 0x0002}, // DP_Index_A = 0x2
    },
    ToUUID("edb12dd0-363d-4085-a3d2-49522ca160c4"),
    Package () {
...
Name(C056, Package() {
    ...
    Package () {
        Package (2) {"mipi-sdca-control-access-layer", CAL_CLASS},
        Package (2) {"mipi-sdca-control-access-mode", CAM_DC},
        Package (2) {"mipi-sdca-control-dc-value", 0x0004}, // DP_Index_A = 0x4
    },
    ToUUID("edb12dd0-363d-4085-a3d2-49522ca160c4"),
    Package () {
...
Name(C062, Package() {
    ...
    Package () {
        Package (2) {"mipi-sdca-control-access-layer", CAL_CLASS},
        Package (2) {"mipi-sdca-control-access-mode", CAM_DC},
        Package (2) {"mipi-sdca-control-dc-value", 0x0003}, // DP_Index_A = 0x3
    },
    ToUUID("edb12dd0-363d-4085-a3d2-49522ca160c4"),
    Package () {
