...
#ifdef HWKWS
        Package(2) {"mipi-sdca-function-topology-features", 0x200000},   // bit21 - Secondary PCM Mic Stream available
#endif
        Package(2) { "mipi-sdca-control-list", 0x1F0}, // Function-Level Controls
#ifdef HWKWS
        //Package(2) { "mipi-sdca-entity-id-list", Package() { 0x4, 0x5, 0x2, 0x6, 0x1, 0x7, 0x8, 0x9, 0xA, 0x11, 0x12, 0x13, 0x14, 0x15} }, // Traversing from IT --> OT: IT11, CS11, PDE11, FU11, XU12, MFPU113, FU113, CS113, OT113, MFPU13, FU13, SMPU13, CS13, OT13.
        Package(2) { "mipi-sdca-entity-id-list", Package() { 0x4, 0x5, 0x2, 0x6, 0x1, 0x7, 0x9, 0xA, 0x11, 0x13, 0x14, 0x15} }, // Traversing from IT --> OT: IT11, CS11, PDE11, FU11, XU12, MFPU113, FU113, CS113, OT113, MFPU13, FU13, SMPU13, CS13, OT13.
#else
        //Package(2) { "mipi-sdca-entity-id-list", Package() { 0x4, 0x5, 0x2, 0x1, 0x7, 0x8, 0x9, 0xA} }, // Traversing from IT --> OT: IT11, CS11, PDE11, XU12, MFPU113, FU113, CS113, OT113.  NOTE: FU_11 is bypassed (platform, not in use by HW)
        Package(2) { "mipi-sdca-entity-id-list", Package() { 0x4, 0x5, 0x2, 0x1, 0x7, 0x9, 0xA} }, // Traversing from IT --> OT: IT11, CS11, PDE11, XU12, MFPU113, FU113, CS113, OT113.  NOTE: FU_11 is bypassed (platform, not in use by HW)
#endif
...
Name(E005, Package()
{
    ...
    Package()
    {
        ...
        Package(2) { "mipi-sdca-control-list", 0x4},  // ClockValid
    },
    ToUUID("dbb8e3e6-5886-4ba6-8795-1319f52a966b"),
    Package()
    {
...
Name(E006, Package()
{
    ...
    Package()
    {
        ...
        Package(2) { "mipi-sdca-control-list", 0x10802}, // Mute, Master Gain, Latency
...
#else
        Package(2) { "mipi-sdca-input-pin-1", "E004"}, // Input Pin 1 connected to IT 11 (bypassing FU 11)
#endif
    }
}) // End E001
...
Name(C502, Package()
{
    ...
    {   // User, Dual, Control Numbers = {1,2}
        ...
        Package(2) { "mipi-sdca-control-access-mode", 1},  // Dual R/W
#ifdef HWKWS
        Package(2) { "mipi-sdca-control-fixed-value", CS42L43_FU_113_VOL_FIXED},
#else
...
Name(E013, Package()
{
    ...
    Package()
    {
        ...
        Package(2) { "mipi-sdca-control-list", 0xD5F0000}, // Simple History Buffer mode
        Package(2) { "mipi-sdca-input-pin-list", 0x2 }, // Input Pin 1 connected
    },
    ToUUID("dbb8e3e6-5886-4ba6-8795-1319f52a966b"),
    Package()
...
Name(E014, Package()
{
    ...
    Package()
    {
        ...
        Package(2) { "mipi-sdca-cs-type", 1},   // internal asynchronous
        Package(2) { "mipi-sdca-control-list", 0x10000},  // SampleRateIndex
    },
    ToUUID("dbb8e3e6-5886-4ba6-8795-1319f52a966b"),
    Package()
