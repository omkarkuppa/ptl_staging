         ...
         Name(_DSD, Package()
			...
			Name(BUF0, Buffer()
			{
				...
				0x53, 0x00, 0x10, 0x06, 0xFF, // 0x06100053, 0xFF
                                ...
                                0x4A, 0x20, 0x00, 0x02, 0x08, // 0x0200204A, 0x08
	...
	//==============================================================================================
			...
			Name(E002, Package()
			{
				...
				Package ()
				{
					...
					Package (2) {"mipi-sdca-entity-label", "IT 41"}, // = IT 41 in ALC712 internal spec
...
*/
	...
	//==============================================================================================
			...
			Name(E010, Package()
			{
				...
				{
					Package (2) {"mipi-sdca-entity-type", 0x03},
					Package (2) {"mipi-sdca-entity-label", "OT 36"}, // = OT 10 in ALC712 internal spec
					Package (2) {"mipi-sdca-terminal-type", 0x0101},
					Package (2) {"mipi-sdca-input-pin-list", 0x2},
