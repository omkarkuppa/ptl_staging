...
Name(E013, Package()
{
	...
	Package ()
	{
		...
		Package (2) {"mipi-sdca-entity-label", "CS 11"}, // = CS 11 in ALC722 internal spec
...
Name(E012, Package()
{
	...
	{
		Package (2) {"mipi-sdca-entity-type", 0x0b},
		Package (2) {"mipi-sdca-entity-label", "CS 18"}, // = CS 18 in ALC722 internal spec
		Package (2) {"mipi-sdca-cs-type", 0},
		//Package (2) {"mipi-sdca-control-list", Package() {0x2} }, // clock_valid
		Package (2) {"mipi-sdca-control-list", 0x04}, // Bitmap: 0x2 - clock_valid
	},
...
Name(E014, Package()
{
	...
	Package ()
	{
		...
		Package (2) {"mipi-sdca-entity-label", "CX 11"}, // = Cx 11 in ALC712 internal spec
		Package (2) {"mipi-sdca-cs-type", 0},
...
Name(CLM3, Buffer()
{
	0x02, 0x00,  // Range type 2 parameters
	0x01, 0x00,  // Count of ranges = 0x1
	0x01, 0x00, 0x00, 0x00, 0x41, 0x00, 0x00, 0x00, // Cluster Index = 0x01, Cluster ID = 0x41 (Use 0x42 for 4ch MicArray)
}) //End CLM3
...
Name(BUF4, Buffer()
{
   ...
   Name(E01A, Package() {
        ...
        Package () {
           ...
           Package (2) {"mipi-sdca-input-pin-list", 0x2},  // Input Pin 1 connected
		   Package (2) {"mipi-sdca-control-list", 0x00030000}, // Bitmap: 0x10 - Trigger_Enable,0x11 - Trigger_Status
        },
        ToUUID("dbb8e3e6-5886-4ba6-8795-1319f52a966b"),
        Package () {
...
Name(E019, Package()
{
	...
	Package ()
	{
		Package (2) {"mipi-sdca-input-pin-1", "E01A"}, // Input Pin 1 connected to XU12
...
Name(E01B, Package()
{
	...
	Package ()
	{
		Package (2) {"mipi-sdca-input-pin-1", "E019"},	// Input pin 1 connected FU113
