...
Name(_DSD, Package()
{
  ...
  Package()
  {
    ...
    //20250217 Disable et67(spaker sense data output) only
    //Package(2) {"mipi-sdca-entity-id-list", Package() {0x30, 0x2, 0x6, 0x4E, 0x4, 0x7, 0x62, 0x4C, 0x4D, 0x57, 0x23, 0x42, 0x33, 0x31, 0x21, 0x09, 0x32, 0x61, 0x65, 0x12, 0x5E, 0x66, 0x68} }, // List of entities in this function
    //20250825 Disable et67(spaker sense data output) and Ultrasound entity 0x65( IT 26)
    Package(2) {"mipi-sdca-entity-id-list", Package() {0x30, 0x2, 0x6, 0x4E, 0x4, 0x7, 0x62, 0x4C, 0x4D, 0x57, 0x23, 0x42, 0x33, 0x31, 0x21, 0x09, 0x32, 0x61, 0x12, 0x5E, 0x66, 0x68} }, // List of entities in this function
