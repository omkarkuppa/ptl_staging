...
Name(VN08, Package() {    // Passed in as an AcxObjectBag during circuit creation. Contents of this package are proprietary.
   ...
   Package () {
      ...
      Package (2) {"acpi-vendor-amp-degraded-mode", 0x00}, // 0: Speaker protection on codec, 1: Speaker protection on DSP, 20250908 update for Intel streaming driver
      Package (2) {"acpi_vendor_smart_amp", 0x01}, // 0: Simple amp, 1: Smart amp  ,20250908 update for Intel streaming driver
      Package (2) {"acpi-acd-connection-0-properties",
         Buffer()
         {
            0x01,
...
Name(CR11, Package() {
   ToUUID("daffd814-6eba-4d8c-8a91-bc9bbf4aa301"),    // Device Properties UUID
   Package () {
      Package (2) {"acpi-acd-device-namestring", "\\_SB.PC00.HDAS.IDA.SNDW.SWD0.AF05"},
      Package (2) {"acpi-acd-device-type", 1},    // 0: Generic, 1: SoundWire
