...
#define UNIT_TEST_NAME     "PmaxDxe Unit Test"
...
UNIT_TEST_CASE_STRUCT mUnitTestCasesStruct [] = {
  { "[FindPmaxTable] Testing of the Finding PMAX SSDT Table.",     "FindPmaxTable function",    TestCaseFindPmaxTable,            PreFindPmaxTable,                    CleanUpFindPmaxTable,                NULL,           0,            0},
  { "[UpdatePmaxTable] Testing of the Get PCD and update the values in the PMAX table.",   "UpdatePmaxTable function",  TestCaseUpdatePmaxTable,          PreUpdatePmaxTable,                  CleanUpUpdatePmaxTable,              NULL,           0,            0},
  { "[InstallTable] Tesing of the Install the PMAX table",      "InstallTable function",     TestCaseInstallTable,             PreInstallTable,                     CleanUpInstallTable,                 NULL,           0,            0},
  { "[GetStrLength] Testing of the Calculate the string length ",      "GetStrLength function",     TestCaseGetStrLength,             NULL,                                NULL,                                NULL,           0,            0},

  { "[TestCaseGetHandlesWithFvProtocol] Testing of the GetHandlesWithFvProtocol.",     "GetHandlesWithFvProtocol function",    TestCaseGetHandlesWithFvProtocol,            PreGetHandlesWithFvProtocol,                    NULL,                NULL,           0,            0},
  { "[TestCaseGetPmaxFirmwareVolume] Testing of the GetPmaxFirmwareVolume.",    "GetPmaxFirmwareVolume function",  TestCaseGetPmaxFirmwareVolume,         PreGetPmaxFirmwareVolume,                  NULL,                NULL,           0,            0},
  { "[TestCaseReadPmaxAcpiFile] Testing of the ReadPmaxAcpiFile.",    "ReadPmaxAcpiFile function",  TestCaseReadPmaxAcpiFile,                NULL,                                  NULL,                NULL,           0,            0},
  { "[TestCasecheckPmaxConfig] Testing of the PMAX Config values.",     "CheckPmaxConfig function",    TestCaseCheckPmaxConfig,                PreCheckPmaxConfig,                    NULL,                NULL,           0,            0},
  { "[InstallPmaxTable] Tesing of the Install the PMAX table",      "InstallPmaxTable function",     TestCaseInstallPmaxTable,                NULL,                                   NULL,                NULL,           0,            0},
};
  ...
  )
{
  ...
  UNIT_TEST_SUITE_HANDLE        UnitTestPmaxDxe;
  UINTN                         Index;
  ...
  Status = CreateUnitTestSuite (
             &UnitTestPmaxDxe,        // SuiteHandle  : Unit test suite to create
  ...
  for (Index = 0; Index < ARRAY_SIZE (mUnitTestCasesStruct); Index++) {
    Status = AddTestCase (
               UnitTestPmaxDxe,                          // SuiteHandle        : Unit test suite to add test to
