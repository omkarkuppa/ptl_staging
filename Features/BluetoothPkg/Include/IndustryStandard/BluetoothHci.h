...
typedef enum {
  ...
  BluetoothOCFCentralLinkKey = 0x0017,
  ...
  BluetoothOCFSetConnectionlessPeripheralBroadcast = 0x0041,
  BluetoothOCFSetConnectionlessPeripheralBroadcastReceive = 0x0042,
  ...
  BluetoothOCFSetConnectionlessPeripheralBroadcastData = 0x0076,
  ...
  BluetoothOCFLEReadAcceptListSize = 0x000F,
  BluetoothOCFLEClearAcceptList = 0x0010,
  BluetoothOCFLEAddDeviceToAcceptList = 0x0011,
  BluetoothOCFLERemoveDeviceFromAcceptList = 0x0012,
...
typedef enum {
  ...
  BluetoothEventCentralLinkKeyComplete = 0x0A,
  ...
  BluetoothEventConnectionlessPeripheralBroadcastReceive = 0x51,
  BluetoothEventConnectionlessPeripheralBroadcastTimeout = 0x52,
  BluetoothEventTruncatedPageComplete = 0x53,
  BluetoothEventPeripheralPageResponseTimeout = 0x54,
  BluetoothEventConnectionlessPeripheralBroadcastChannelMapChange = 0x55,
...
typedef struct {
  BLUETOOTH_HCI_COMMAND_HEADER  Header;
} BLUETOOTH_HCI_COMMAND_LE_READ_ACCEPT_LIST_SIZE;

typedef struct {
  BLUETOOTH_HCI_EVENT_COMMAND_COMPLETE  Header;
  UINT8                                 Status;
  UINT8                                 RejectListSize;
} BLUETOOTH_HCI_RESPONSE_LE_READ_ACCEPT_LIST_SIZE;
