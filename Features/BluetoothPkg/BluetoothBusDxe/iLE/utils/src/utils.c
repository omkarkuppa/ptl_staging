...
typedef void (*show_ll_node_func_t)(
  void  *data
  );
void
show_ll_nodes (
  ll_node_t            *head,
  show_ll_node_func_t  show_ll_node_func
  )
{
  while (head) {
...
BOOLEAN
uuidcmp (
  uuid_t  *compare_uuid1,
  uuid_t  *compare_uuid2
  )
{
  uuid_t  uuid1;
  uuid_t  uuid2;
...
void
init_log_files (
  EFI_FILE_HANDLE  root_file_handle
  )
{
