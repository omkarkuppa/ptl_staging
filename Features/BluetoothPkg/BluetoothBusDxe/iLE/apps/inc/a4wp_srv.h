...
typedef void (*cb_handler_t)(
  a4wp_sm_opcodes_t  opcode,
  void               *param
  );
...
extern UINT8
a4wp_register_sm_cb (
  cb_handler_t  sm_handler
  );

extern UINT8
a4wp_write_adv_parameters (
  UINT8  rssi,
  UINT8  adv_flags
  );

extern UINT8
a4wp_write_static_parameters (
  pru_static_param_char_t  *param
  );

extern UINT8
a4wp_write_dynamic_parameters (
  pru_dynamic_param_char_t  *param
  );
