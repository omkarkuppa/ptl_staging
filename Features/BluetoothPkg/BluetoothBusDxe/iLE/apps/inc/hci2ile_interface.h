 ...
 */
typedef void (*hci2ile_Event_Dispatch_cb_t)(
  UINT16  op_code,
  UINT8   len,
  UINT8   *hcidata
  );
 ...
 */
typedef void (*hci2ile_Status_Dispatch_cb_t)(
  UINT16  op_code,
  UINT8   len,
  UINT8   *hcidata
  );
...
void
hci2ile_initialize (
  hci2ile_Status_Dispatch_cb_t  hci2ile_Status_cb,
  hci2ile_Event_Dispatch_cb_t   hci2ile_Event_cb
  );
