...
static void
hogp_on_primary_service_discovered_cb (
  trans_id_t  trans_id,
  UINT8       status,
  UINT8       conn_id,
  UINT16      start_handle,
...
static void
hogp_on_characteristic_discovered_cb (
  trans_id_t  trans_id,
  UINT8       status,
  UINT8       conn_id,
  UINT8       property,
...
static void
hogp_on_descriptor_discovered_cb (
  trans_id_t  trans_id,
  UINT8       status,
  UINT8       conn_id,
  UINT16      att_handle,
...
static osa_thread_ret_t
hogp_app_main_thread (
