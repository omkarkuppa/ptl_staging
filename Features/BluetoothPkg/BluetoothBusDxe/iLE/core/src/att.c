...
static void
att_client_timer_expire_cb (
  osa_timer_arg_t  arg
  );

static INT8
att_client_timer_stop (
  UINT8  conn_id
  );

static INT8
att_validate_response (
  UINT8  conn_id,
  UINT8  respponse_code
  );

static INT8
att_decode_err_response (
  UINT8     conn_id,
  buffer_t  *in_buffer
  );
...
static void
att_server_timer_expire_cb (
  osa_timer_arg_t  arg
  );

static INT8
att_server_timer_start (
  UINT8  conn_id
  );

static INT8
att_server_timer_stop (
  UINT8  conn_id
  );
 ...
 *********************************************************************/
static void
att_client_timer_expire_handler (
  osa_timer_arg_t  arg
  )
{
 ...
 *********************************************************************/
static void
att_server_timer_expire_handler (
  osa_timer_arg_t  arg
  )
{
  UINT8  idx = (UINT8)osa_get_timer_arg_val (arg);
 ...
 *********************************************************************/
INT8
att_send_handle_val_indication (
  UINT8     conn_id,
  UINT16    att_handle,
  buffer_t  *in_buffer
  )
