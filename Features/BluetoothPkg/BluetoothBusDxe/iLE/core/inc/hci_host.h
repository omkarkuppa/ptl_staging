...
#define HCI_CON_ROLE_CENTRAL     0
#define HCI_CON_ROLE_PERIPHERAL  1
...
#define HCI_EVENT_STATUS_UNKNOWN_CONNECTION_IDENTIFIER  2
#define HCI_EVENT_STATUS_HARDWARE_FAILURE               3
...
#define HCI_LE_FEATURE_PERIPHERAL_INIT_FEAT_EXCHANGE_OFFSET    0
#define HCI_LE_FEATURE_PERIPHERAL_INIT_FEAT_EXCHANGE_MASK      0x08
