...
void
gatt_mtu_exchange_req_cb (
  UINT8     conn_id,
  buffer_t  *buffer
  );

INT8
gatt_handle_mtu_resp_cb (
  UINT8     conn_id,
  buffer_t  *buffer
  );
...
INT8
gatt_discover_primary_service (
  UINT8   conn_id,
  uuid_t  *filter_uuid
  );

INT8
gatt_discover_included_service (
  UINT8   conn_id,
  UINT16  start_handle,
  UINT16  end_handle
  );
...
INT8
gatt_read_characteristic_value_using_uuid (
  UINT8   conn_id,
  UINT16  start_handle,
  UINT16  end_handle,
  uuid_t  *char_uuid
...
INT8
gatt_read_multiple_characteristic_value (
  UINT8   conn_id,
  UINT16  *handle_list
  );

INT8
gatt_write_attribute_command (
  UINT8     conn_id,
  UINT8     att_opcode,
  UINT16    att_id,
  buffer_t  *buffer
...
INT8
gatt_send_indication_confirmation (
  UINT8  conn_id
  );

INT8
gatt_send_signed_write (
  UINT8     conn_id,
  UINT16    att_id,
  buffer_t  *buffer,
  UINT8     *signature
...
#if (GATT_CLIENT_SUPPORTED == TRUE)
void
gatt_client_connect_cb (
  connected_device_t  *device
  );

void
gatt_client_disconnect_cb (
  connected_device_t  *device
  );
...
void
gatt_discover_prim_srv_by_uuid_cb (
  UINT8     conn_id,
  UINT8     att_opcode,
  buffer_t  *in_buffer
  );
...
void
gatt_read_by_group_type_resp_cb (
  UINT8     conn_id,
  UINT8     att_opcode,
  buffer_t  *in_buffer
  );
