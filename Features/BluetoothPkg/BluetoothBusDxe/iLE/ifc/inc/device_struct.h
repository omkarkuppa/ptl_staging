...
#define LINK_ROLE_CENTRAL     0
#define LINK_ROLE_PERIPHERAL  1
 ...
 * @return None.
 */
typedef void (*register_application_cb_t)(
  UINT8    app_handle,
  BOOLEAN  result
  );

typedef void (*on_att_mtu_changed_cb_t)(
  trans_id_t  trans_id,
  UINT8       conn_id,
  UINT16      mtu_size
  );

typedef void (*on_service_added_cb_t)(
  trans_id_t  trans_id,
  UINT8       status,
  uuid_t      *uuid,
  UINT16      att_id
...
typedef void (*on_included_service_added_cb_t)(
  trans_id_t  trans_id,
  UINT8       status,
  uuid_t      *uuid,
  UINT16      att_id
...
typedef void (*on_characteristic_added_cb_t)(
  trans_id_t  trans_id,
  UINT8       status,
  uuid_t      *uuid,
  UINT16      att_id
...
typedef void (*on_descriptor_added_cb_t)(
  trans_id_t  trans_id,
  UINT8       status,
  uuid_t      *uuid,
  UINT16      att_id
...
typedef void (*on_service_removed_cb_t)(
  trans_id_t  trans_id,
  UINT8       status,
  UINT16      start_handle,
  UINT16      end_handle
 ...
 * @return None.
 */
typedef void (*on_service_started_cb_t)(
  trans_id_t  trans_id,
  UINT8       status,
  uuid_t      *uuid,
  UINT16      att_id
 ...
 * @return None.
 */
typedef void (*on_attribute_read_req_cb_t)(
  trans_id_t  trans_id,
  UINT8       conn_id,
  UINT8       att_opcode,
  UINT16      att_id,
 ...
 * @return TRUE / FALSE.
 */
typedef void (*on_attribute_write_req_cb_t)(
  trans_id_t  trans_id,
  UINT8       conn_id,
  UINT8       att_opcode,
  UINT16      att_id,
 ...
 * @return None.
 */
typedef void (*on_indication_confirmation_cb_t)(
  trans_id_t  trans_id,
  UINT8       conn_id,
  UINT16      att_id
  );
 ...
 * @return None.
 */
typedef void (*on_attribute_handle_changed_cb_t)(
  UINT16  old_handle,
  UINT16  new_handle
  );
 ...
 * @return None.
 */
typedef void (*on_primary_service_discovered_cb_t)(
  trans_id_t  trans_id,
  UINT8       status,
  UINT8       conn_id,
  UINT16      start_handle,
...
typedef void (*on_included_service_discovered_cb_t)(
  trans_id_t  trans_id,
  UINT8       status,
  UINT8       conn_id,
  UINT16      inc_handle,
...
typedef void (*on_characteristic_discovered_cb_t)(
  trans_id_t  trans_id,
  UINT8       status,
  UINT8       conn_id,
  UINT8       property,
...
typedef void (*on_descriptor_discovered_cb_t)(
  trans_id_t  trans_id,
  UINT8       status,
  UINT8       conn_id,
  UINT16      att_handle,
 ...
 * @return None.
 */
typedef void (*on_attribute_read_cb_t)(
  trans_id_t  trans_id,
  UINT8       conn_id,
  UINT8       opcode,
  UINT8       status,
 ...
 * @return None.
 */
typedef void (*on_attribute_write_cb_t)(
  trans_id_t  trans_id,
  UINT8       conn_id,
  UINT8       opcode,
  UINT8       status,
 ...
 * @return None.
 */
typedef void (*on_notification_cb_t)(
  trans_id_t  trans_id,
  UINT8       conn_id,
  UINT16      att_id,
  buffer_t    *buffer,
 ...
 * @return None.
 */
typedef void (*on_notification_registered_cb_t)(
  trans_id_t  trans_id,
  UINT8       conn_id,
  UINT16      att_id,
  UINT8       status
...
typedef void (*on_connected_cb_t)(
  trans_id_t  trans_id,
 ...
 * @return None.
 */
typedef void (*on_disconnected_cb_t)(
  trans_id_t  trans_id,
  UINT8       conn_id,
  UINT8       status
  );
 ...
 * @return None.
 */
typedef void (*scan_result_cb_t)(
  trans_id_t                    trans_id,
  struct __discovered_device_t  *device
  );
 ...
 * @return None.
 */
typedef void (*scan_completed_cb_t)(
  trans_id_t  trans_id
  );
 ...
 * @param latency - Peripheral latency for the connection in number of connection events.
 * @param timeout - Supervision timeout for this connection.
 * @return None
 */

typedef void (*on_conn_param_update_cb_t)(
  trans_id_t  trans_id,
  UINT8       status,
  UINT8       conn_id,
  UINT16      interval,
 ...
 * @return None
 */
typedef void (*stack_initialized_cb_t)(
  BOOLEAN  initialized
  );
 ...
 * @return none
 */
typedef void (*on_link_enc_changed_cb_t)(
  trans_id_t  trans_id,
  UINT8       conn_id,
  UINT8       status,
  UINT8       sec_level
 ...
 * @return None
 */
typedef void (*bonding_complete_cb_t)(
  trans_id_t  trans_id,
  UINT8       *bdaddr,
  UINT8       bdaddr_type,
  UINT8       conn_id,
 ...
 * @return None
 */
typedef void (*rpa_complete_cb_t)(
  UINT8    *bdaddr,
  BOOLEAN  local,
  UINT8    bonded_idx,
  UINT8    status
 ...
 * @return None
 */
typedef void (*data_siging_complete_cb_t)(
  UINT8  conn_id,
  UINT8  status,
  UINT8  *signed_data
  );

typedef void (*sign_verify_complete_cb_t)(
  UINT8  conn_id,
  UINT8  status
  );
 ...
 * @return None
 */
typedef void (*read_authpayload_timout_cb_t)(
  trans_id_t  trans_id,
  UINT8       conn_id,
 ...
 * @return None
 */
typedef void (*data_len_change_evt_cb_t)(
  trans_id_t  trans_id,
  UINT8       conn_id,
 ...
 *
 */
typedef void (*bonding_info_cb_t)(
  trans_id_t                  trans_id,
  UINT8                       *bdaddr,
  UINT8                       bdaddr_type,
  UINT8                       *id_bdaddr,
  UINT8                       id_bdaddr_type,
  struct __smp_bonding_key_t  *keys
  );
...
typedef void (*on_lc_conn_complete_cb_t)(
  INT8                      status,
  l2cap_coc_conn_req_res_t  *p_res
  );
typedef void (*on_lc_disconn_complete_cb_t)(
  INT8   status,
  UINT8  handle
  );
typedef void (*on_lc_conn_notify_cb_t)(
  INT8                      status,
  l2cap_coc_conn_req_res_t  *p_res
  );
typedef void (*on_lc_disconn_notify_cb_t)(
  INT8   status,
  UINT8  handle
  );
typedef void (*on_lc_data_notify_cb_t)(
  INT8    status,
  UINT8   handle,
  UINT8   *buffer,
  UINT16  buffer_len
  );
typedef void (*on_lc_credit_notify_cb_t)(
  INT8    status,
  UINT8   handle,
  UINT16  fc_credit
  );
typedef void (*on_lc_stack_busy_notify_cb_t)(
  INT8     status,
  UINT8    handle,
  BOOLEAN  stack_busy
  );

typedef void (*lc_register_cb)(
  trans_id_t  trans_id,
  UINT16      psm,
  INT8        status
  );
typedef void (*lc_authorisation_cb)(
  trans_id_t  trans_id,
  UINT8       conn_id,
  UINT16      psm
  );                                                                                 // add coc configuration
typedef void (*lc_connection_cmpl_cb)(
  trans_id_t  trans_id,
  UINT8       conn_id,
  UINT16      psm,
  UINT8       coc_handle,
...
typedef void (*lc_flow_control_cb)(
  trans_id_t  trans_id,
  UINT8       conn_id,
  UINT8       coc_handle,
  UINT8       fc_packets
  );
typedef void (*lc_recv_data_cb)(
  trans_id_t  trans_id,
  UINT8       conn_id,
  UINT8       coc_handle,
  UINT8       *buffer,
...
typedef void (*lc_disconnection_cmpl_cb)(
  trans_id_t  trans_id,
  UINT8       conn_id,
  UINT8       coc_handle,
  UINT8       status
...
typedef struct __connected_device_t {
 ...
 #endif /* GAP_EXTRA_REMOTE_DATA == TRUE */
  BOOLEAN                 local_link_role; /**< Central:0 / Peripheral:1 */
  /* Internal data */
...
typedef struct {
  ...
  UINT16                     timer_id;
  UINT8                      num_of_buffer;
  UINT8                      rejectlist_size;
  UINT8                      num_rejectlist_entries;
...
extern UINT8
hci_read_bt_controller_info (
  ble_controller_info_t  *controller_info
  );

extern UINT8
hci_write_bt_controller_info (
  ble_controller_event_mask_t  *event_mask
  );

extern UINT8
hci_write_bt_controller_adv_params (
  ble_adv_params_t  *adv_params
  );

extern UINT8
hci_write_bt_controller_adv_data (
  bt_tlv_data_t  *tlv_data
  );

extern UINT8
hci_write_bt_controller_scan_resp_data (
  bt_tlv_data_t  *tlv_data
  );
...
UINT8
get_connected_device_idx_by_handle (
  UINT16  acl_handle
  );

UINT8
get_connected_device_idx_by_bdaddr (
  UINT8  *bdaddr
  );

connected_device_t *
get_connected_device_by_bdaddr (
  UINT8  *bdaddr
  );

connected_device_t *
get_connected_device_by_id_addr (
  UINT8  *bdaddr
  );

connected_device_t *
get_connected_device_by_conn_id (
  UINT8  conn_id
  );
...
UINT8
find_first_free_connected_device_slot (
  void
  );

#if (GAP_PERIPHERAL_ROLE_SUPPORTED == TRUE)
UINT8
find_adv_scanresp_data_idx (
  gap_adv_scanresp_data_t  **list,
  UINT8                    type
  );

UINT8
find_first_free_adv_scanresp_data_slot (
  gap_adv_scanresp_data_t  **list
  );
...
UINT8
get_idx_from_autoconn_list (
  UINT8  *bdaddr
  );

#if (GAP_CENTRAL_ROLE_SUPPORTED == TRUE)
INT8
add_trans_id_to_auto_connect_list (
  autoconn_dev_t  *device,
  trans_id_t      trans_id
  );

INT8
remove_trans_id_from_auto_connect_list (
  autoconn_dev_t  *device,
  trans_id_t      trans_id
  );

void
add_to_autoconn_list (
  UINT8       *bdaddr,
  UINT8       addr_type,
  trans_id_t  trans_id
  );
...
void
remove_from_autoconn_list (
  UINT8       *bdaddr,
  trans_id_t  trans_id
  );

BOOLEAN
is_autoconn_list_empty (
  );

#endif /* GAP_CENTRAL_ROLE_SUPPORTED == TRUE */
#if (L2CAP_COC == TRUE)
l2cap_coc_conn_t *
create_l2cap_coc_tbl (
  void
  );

void
delete_l2cap_coc_tbl (
  UINT8  l2cap_coc_tbl_idx
  );
...
UINT8
find_first_free_l2cap_coc_tbl_slot (
  void
  );

UINT8
get_free_psm_registration_slot (
  );

l2cap_coc_conn_t *
get_l2cap_coc_tbl_from_idx (
  UINT8  ccb_idx
  );

UINT8
get_coc_ccb_by_l2cap_id (
  UINT8  conn_id,
  UINT8  l2cap_id
  );
...
UINT8
get_psm_registration_idx (
  UINT16  psm
  );

UINT8
check_psm_already_in_use (
  UINT16  psm,
  UINT8   conn_id
  );

UINT8
get_handle_from_coc_table_for_cid (
  UINT16  cid
  );

UINT8
get_handle_from_coc_table_for_cids (
  UINT16  cid,
  UINT16  r_cid
  );

l2cap_coc_conn_send_data_t *
get_free_coc_tx_data_pool (
  UINT8  ccb_idx
  );
