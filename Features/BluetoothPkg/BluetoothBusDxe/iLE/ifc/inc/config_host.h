...
#ifndef A4WP_ONLY_STACK
#define A4WP_ONLY_STACK  FALSE
#endif
...
#ifndef TARGET_THREADX_RW
#define TARGET_THREADX_RW  FALSE
#endif

#ifndef ATP_AUTO_TEST_MODE
#define ATP_AUTO_TEST_MODE  FALSE
#endif

#define MAX_NUM_SCAN_FILTER_UUIDS  10

#define MIN_SCAN_INTERVAL  1600     /* 1sec */
#define MIN_SCAN_WINDOW    8        /* 5ms */
...
#define UHID_HOST_DBG_LVL  DBG_LVL_WARNING
  #else
    #ifndef HOGP_APP_DBG_LVL
#define HOGP_APP_DBG_LVL  DBG_LVL_WARNING
    #endif
    #ifndef UHID_HOST_DBG_LVL
#define UHID_HOST_DBG_LVL  DBG_LVL_WARNING
    #endif
  #endif
