/**@file
    Unit test case of the Platform Firmware Version Dxe driver.
  @copyright
  INTEL CONFIDENTIAL
...
//
// Unit Test case Library.
//
#include "TestCase/PlatformFirmwareVersionDxeTestCase.h"

#define UNIT_TEST_NAME     "PlatformFirmwareVersionDxe Unit Test"
...
UNIT_TEST_CASE_STRUCT mUnitTestCasesStruct [] = {
  { "Basic function to test Framework",        "Hello World",     UnitTestHelloWorld,            NULL,                                  NULL,                                NULL,           0,            0},
  { "Other function to verify Framework",      "Other",           UnitTestOther,                 NULL,                                  NULL,                                NULL,           0,            0},
};
/**
  ...
  )
{
  ...
  UNIT_TEST_SUITE_HANDLE        UnitTestPlatformFirmwareVersionDxe;
  UINTN                         Index;
  ...
  Status = CreateUnitTestSuite (
             &UnitTestPlatformFirmwareVersionDxe,   // SuiteHandle  : Unit test suite to create
  ...
  for (Index = 0; Index < ARRAY_SIZE (mUnitTestCasesStruct); Index++) {
    Status = AddTestCase (
               UnitTestPlatformFirmwareVersionDxe,       // SuiteHandle        : Unit test suite to add test to
