/**@file
    Unit test main of the Me Resiliency Dxe driver.
...
//
#include "TestCase/MeResiliencyDxeTestCase.h"

#define UNIT_TEST_NAME     "MeResiliencyDxe Unit Test"
  ...
  )
{
  ...
  UNIT_TEST_SUITE_HANDLE        UnitTestMeResiliencyDxe;
  UINTN                         Index;
  ...
  Status = CreateUnitTestSuite (
             &UnitTestMeResiliencyDxe,   // SuiteHandle  : Unit test suite to create
  ...
  for (Index = 0; Index < ARRAY_SIZE (mUnitTestCasesStruct); Index++) {
    Status = AddTestCase (
               UnitTestMeResiliencyDxe,                  // SuiteHandle        : Unit test suite to add test to
