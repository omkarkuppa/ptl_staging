...
# Foxville
#
FOXVILLE_IMG_FILE_NAME: str = gFwComponentInfo[FOXVILLE_COMPONENT_KEY][FILE_NAME_KEY]
FOXVILLE_IMG_FILE_GUID: str = gFwComponentInfo[FOXVILLE_COMPONENT_KEY][FILE_GUID_KEY]
FOXVILLE_IMG_FILE_PATH: str = JoinPath (TEMPORARY_DIR_PATH, FOXVILLE_IMG_FILE_NAME)
...
FW_COMPONENT_DICT: dict = {
    ...
    FW_FOXVILLE: {
        FW_FILE_NAME_KEY: FOXVILLE_IMG_FILE_NAME,
        FW_FILE_PATH_KEY: FOXVILLE_IMG_FILE_PATH,
        FW_FILE_GUID_KEY: FOXVILLE_IMG_FILE_GUID,
        },
    }
