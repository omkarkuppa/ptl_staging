...
BIOS_FW_HEADER_FORMAT_DICT: Dict[str, Any] = {
    BIOS_ID_HDR_SIGNATURE : {FILED_FORMAT: '8c' , FIELD_SIZE:  8},
    BIOS_ID_HDR_BOARD_ID  : {FILED_FORMAT: '14c', FIELD_SIZE: 14},
    BIOS_ID_HDR_BOARD_REV : {FILED_FORMAT: '2c' , FIELD_SIZE:  2},
    BIOS_ID_HDR_DOT1      : {FILED_FORMAT: '2c',  FIELD_SIZE:  2},
    BIOS_ID_HDR_BOARD_EXT : {FILED_FORMAT: '6c',  FIELD_SIZE:  6},
    BIOS_ID_HDR_DOT2      : {FILED_FORMAT: '2c',  FIELD_SIZE:  2},
    BIOS_ID_HDR_MAJOR_VER : {FILED_FORMAT: '8c',  FIELD_SIZE:  8},
    BIOS_ID_HDR_DOT3      : {FILED_FORMAT: '2c',  FIELD_SIZE:  2},
    BIOS_ID_HDR_BUILD_TYPE: {FILED_FORMAT: '2c',  FIELD_SIZE:  2},
    BIOS_ID_HDR_MINOR_VER : {FILED_FORMAT: '4c',  FIELD_SIZE:  4},
    BIOS_ID_HDR_DOT4      : {FILED_FORMAT: '2c',  FIELD_SIZE:  2},
    BIOS_ID_HDR_TIMESTAMP : {FILED_FORMAT: '20c', FIELD_SIZE: 20},
    }
