...
UCODE_FW_HEADER_FORMAT_DICT: Dict[str, Any] = {
    UCODE_FW_HDR_HDR_VER        : { FIELD_FORMAT: 'L',   FIELD_SIZE:  4 },
    UCODE_FW_HDR_UPDATE_REV     : { FIELD_FORMAT: 'L',   FIELD_SIZE:  4 },
    UCODE_FW_HDR_DATE           : { FIELD_FORMAT: 'L',   FIELD_SIZE:  4 },
    UCODE_FW_HDR_PROCESSOR_SIG  : { FIELD_FORMAT: 'L',   FIELD_SIZE:  4 },
    UCODE_FW_HDR_CHECK_SUM      : { FIELD_FORMAT: 'L',   FIELD_SIZE:  4 },
    UCODE_FW_HDR_LOADER_REV     : { FIELD_FORMAT: 'L',   FIELD_SIZE:  4 },
    UCODE_FW_HDR_PROCESSOR_FLAGS: { FIELD_FORMAT: 'L',   FIELD_SIZE:  4 },
    UCODE_FW_HDR_DATA_SIZE      : { FIELD_FORMAT: 'L',   FIELD_SIZE:  4 },
    UCODE_FW_HDR_TOTAL_SIZE     : { FIELD_FORMAT: 'L',   FIELD_SIZE:  4 },
    UCODE_FW_HDR_RESERVED       : { FIELD_FORMAT: '12x', FIELD_SIZE: 12 },
    }
