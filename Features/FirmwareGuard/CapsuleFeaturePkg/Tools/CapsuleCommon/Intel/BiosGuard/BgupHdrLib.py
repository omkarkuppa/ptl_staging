...
BGUP_HDR_VER2_FORMAT_DICT: Dict[str, Any] = {
    BGUP_HDR_VERSION        : {FILED_FORMAT: 'H',   FIELD_SIZE:   2},
    BGUP_HDR_RSVD_3         : {FILED_FORMAT: '2B',  FIELD_SIZE:   2},
    BGUP_HDR_PLATID         : {FILED_FORMAT: '16c', FIELD_SIZE:  16},
    BGUP_HDR_PKG_ATTRIBUTES : {FILED_FORMAT: 'H',   FIELD_SIZE:   2},
    BGUP_HDR_RSVD_4         : {FILED_FORMAT: '2B',  FIELD_SIZE:   2},
    BGUP_HDR_PSL_MAJOR_VER  : {FILED_FORMAT: 'H',   FIELD_SIZE:   2},
    BGUP_HDR_PSL_MINOR_VER  : {FILED_FORMAT: 'H',   FIELD_SIZE:   2},
    BGUP_HDR_SCRIPT_SIZE    : {FILED_FORMAT: 'L',   FIELD_SIZE:   4},
    BGUP_HDR_DATA_SIZE      : {FILED_FORMAT: 'L',   FIELD_SIZE:   4},
    BGUP_HDR_BIOS_SVN       : {FILED_FORMAT: 'L',   FIELD_SIZE:   4},
    BGUP_HDR_EC_SVN         : {FILED_FORMAT: 'L',   FIELD_SIZE:   4},
    BGUP_HDR_VENDOR_SPECIFIC: {FILED_FORMAT: 'L',   FIELD_SIZE:   4},
    }
