...
EC_FW_HDR_VER1_FORMAT_DICT: Dict[str, Any] = {
    EC_FW_HDR_SIGNATURE  : {FILED_FORMAT: '4c', FIELD_SIZE:  4},
    EC_FW_HDR_PLATFORM_ID: {FILED_FORMAT: 'B',  FIELD_SIZE:  1},
    EC_FW_HDR_MAJOR_VER  : {FILED_FORMAT: 'B',  FIELD_SIZE:  1},
    EC_FW_HDR_MINOR_VER  : {FILED_FORMAT: 'B',  FIELD_SIZE:  1},
    EC_FW_HDR_BUILD_VER  : {FILED_FORMAT: 'B',  FIELD_SIZE:  1},
    }
