...
ACM_VER_INFO_TBL_FORMAT_DICT = {
    ACM_VER_INFO_TBL_ID              : {FILED_FORMAT: 'L', FIELD_SIZE: 4},
    ACM_VER_INFO_TBL_LENGTH          : {FILED_FORMAT: 'L', FIELD_SIZE: 4},
    ACM_VER_INFO_TBL_REVISION        : {FILED_FORMAT: 'L', FIELD_SIZE: 4},
    ACM_VER_INFO_TBL_ACM_INFO_TBL_VER: {FILED_FORMAT: 'L', FIELD_SIZE: 4},
    ACM_VER_INFO_TBL_GENERATION_VER  : {FILED_FORMAT: 'L', FIELD_SIZE: 4},
    ACM_VER_INFO_TBL_CORE_VER        : {FILED_FORMAT: 'L', FIELD_SIZE: 4},
    ACM_VER_INFO_TBL_ACM_REVISION    : {FILED_FORMAT: 'L', FIELD_SIZE: 4},
    ACM_VER_INFO_TBL_ACM_SECURITY_VER: {FILED_FORMAT: 'L', FIELD_SIZE: 4},
    }
