...
ACM_INFO_TBL_FORMAT_DICT = {
    GUID_SEGMENT_1                 : {FILED_FORMAT: 'L'     , FIELD_SIZE: 4},
    GUID_SEGMENT_2                 : {FILED_FORMAT: 'H'     , FIELD_SIZE: 2},
    GUID_SEGMENT_3                 : {FILED_FORMAT: 'H'     , FIELD_SIZE: 2},
    GUID_SEGMENT_4                 : {FILED_FORMAT: 'BB'    , FIELD_SIZE: 2},
    GUID_SEGMENT_5                 : {FILED_FORMAT: 'BBBBBB', FIELD_SIZE: 6},
    ACM_INFO_TBL_CHIPSET_ACM_TYPE  : {FILED_FORMAT: 'B'     , FIELD_SIZE: 1},
    ACM_INFO_TBL_AIT_VERSION       : {FILED_FORMAT: 'B'     , FIELD_SIZE: 1},
    ACM_INFO_TBL_AIT_LENGTH        : {FILED_FORMAT: 'H'     , FIELD_SIZE: 2},
    ACM_INFO_TBL_CHIPSET_ID_LIST   : {FILED_FORMAT: 'L'     , FIELD_SIZE: 4},
    ACM_INFO_TBL_OS_SINIT_TBL_VER  : {FILED_FORMAT: 'L'     , FIELD_SIZE: 4},
    ACM_INFO_TBL_MIN_MLE_HEADER_VER: {FILED_FORMAT: 'L'     , FIELD_SIZE: 4},
    ACM_INFO_TBL_SINIT_CAPS        : {FILED_FORMAT: 'L'     , FIELD_SIZE: 4},
    ACM_INFO_TBL_OFFSET_36         : {FILED_FORMAT: 'B'     , FIELD_SIZE: 1},
    ACM_INFO_TBL_OFFSET_37         : {FILED_FORMAT: 'BBB'   , FIELD_SIZE: 3},
    ACM_INFO_TBL_PROCESSOR_ID_LIST : {FILED_FORMAT: 'L'     , FIELD_SIZE: 4},
    ACM_INFO_TBL_TPM_INFO_LIST     : {FILED_FORMAT: 'L'     , FIELD_SIZE: 4},
    }
