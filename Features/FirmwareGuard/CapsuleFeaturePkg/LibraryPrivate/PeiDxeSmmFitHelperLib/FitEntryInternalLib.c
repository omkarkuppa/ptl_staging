  ...
  )
{
  ...
  switch (FitEntryType) {
    ...
    case FIT_TYPE_1A_VENDOR_AUTH_BOOT_PROV_TBL:
    case FIT_TYPE_1B_VENDOR_AUTH_BOOT_KM:
    case FIT_TYPE_1C_VENDOR_AUTH_BOOT_IMG_MANIFEST:
    case FIT_TYPE_1D_VENDOR_AUTH_BOOT_IMG_HASH_DESC:
