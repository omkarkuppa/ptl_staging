...
**/
#ifndef __RESILIENCY_SUPPORT_LIB_H__
#define __RESILIENCY_SUPPORT_LIB_H__


#define SUPPORT_BIOS_RESILIENCY_RECOVERY  1
#define SUPPORT_NVME_BASED_RECOVERY       2
#define NOT_SUPPORT_RECOVERY              0
...
#endif  // __RESILIENCY_SUPPORT_LIB_H__
