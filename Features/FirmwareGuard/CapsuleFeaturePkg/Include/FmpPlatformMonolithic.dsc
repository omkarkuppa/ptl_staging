## @file
# FmpDxe driver for monolithic system firmware (BIOS/ME/EC/etc.) update.
#
#  @copyright
#  INTEL CONFIDENTIAL
...
##
  ...
  FmpDevicePkg/FmpDxe/FmpDxe.inf {
    ...
    <PcdsFixedAtBuild>
      ...
      #
      gFmpDevicePkgTokenSpaceGuid.PcdFmpDeviceImageIdName|L"$(FMP_CLIENT_PLATFORM_NAME) System Firmware Device"
      ...
      #
      # File GUID for the Monolithic FMP device driver.
      #
      gFmpDevicePkgTokenSpaceGuid.PcdFmpDeviceImageTypeIdGuid|{GUID(gFmpDeviceMonolithicDefaultGuid)}

    <LibraryClasses>
      FmpDeviceLib|CapsuleFeaturePkg/Library/FmpDeviceLibMonolithic/FmpDeviceLibMonolithic.inf
  }
