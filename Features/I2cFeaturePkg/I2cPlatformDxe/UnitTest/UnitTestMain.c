...
#define UNIT_TEST_NAME     "I2cPlatformDxe Unit Test"
...
UNIT_TEST_CASE_STRUCT mUnitTestCasesStruct [] = {
 // This test case made host.exe exception, so comment out it first.   { "UnitTestIsSerialIoI2cDeviceIdCp",             "UnitTestIsSerialIoI2cDeviceIdCp",             UnitTestIsSerialIoI2cDeviceIdCp,                 NULL,                                  NULL,                                NULL,             0,            0},
  { "UnitTestSetConfiguration",                    "UnitTestSetConfiguration",                    UnitTestSetConfiguration,                        NULL,                                  NULL,                                NULL,             0,            0},
 // This test case made host.exe exception, so comment out it first.   { "UnitTestGetPciDevId",                         "UnitTestGetPciDevId",                         UnitTestGetPciDevId,                             NULL,                                  NULL,                                NULL,             0,            0},
  { "UnitTestGetBusFrequency",                     "UnitTestGetBusFrequency",                     UnitTestGetBusFrequency,                         NULL,                                  NULL,                                NULL,             0,            0},
  { "UnitTestEnumerate",                           "UnitTestEnumerate",                           UnitTestEnumerate,                               NULL,                                  NULL,                                NULL,             0,            0},
 // This test case made host.exe exception, so comment out it first.   { "UnitTestI2cPlatformDriverBindingSupported",   "UnitTestI2cPlatformDriverBindingSupported",   UnitTestI2cPlatformDriverBindingSupported,       NULL,                                  NULL,                                NULL,             0,            0},
 // This test case made host.exe exception, so comment out it first.   { "UnitTestI2cPlatformDriverBindingStart",       "UnitTestI2cPlatformDriverBindingStart",       UnitTestI2cPlatformDriverBindingStart,           NULL,                                  NULL,                                NULL,             0,            0},
  { "UnitTestI2cPlatformDriverBindingStop",        "UnitTestI2cPlatformDriverBindingStop",        UnitTestI2cPlatformDriverBindingStop,            NULL,                                  NULL,                                NULL,             0,            0},
  { "UnitTestI2cPlatformEntryPoint",               "UnitTestI2cPlatformEntryPoint",               UnitTestI2cPlatformEntryPoint,                   NULL,                                  NULL,                                NULL,             0,            0},
};
