/**@file
    Unit test main of the I2c PssMonza Dxe driver.
...
#define UNIT_TEST_NAME     "I2cPssMonzaDxe Unit Test"
...
UNIT_TEST_CASE_STRUCT mUnitTestCasesStruct [] = {
  { "UnitTestPssMonzaDriverEntryPoint",                    "UnitTestPssMonzaDriverEntryPoint",                    UnitTestPssMonzaDriverEntryPoint,                     NULL,                                NULL,                                NULL,             0,            0},
  { "UnitTestPssMonzaDriverBindingSupported",              "UnitTestPssMonzaDriverBindingSupported",              UnitTestPssMonzaDriverBindingSupported,               NULL,                                NULL,                                NULL,             0,            0},
  { "UnitTestPssMonzaDriverBindingStart",                  "UnitTestPssMonzaDriverBindingStart",                  UnitTestPssMonzaDriverBindingStart,                   NULL,                                NULL,                                NULL,             0,            0},
  { "UnitTestPssMonzaDriverBindingStop",                   "UnitTestPssMonzaDriverBindingStop",                   UnitTestPssMonzaDriverBindingStop,                    NULL,                                NULL,                                NULL,             0,            0},
  { "UnitTestPssMonzaDriverComponentNameGetDriverName",    "UnitTestPssMonzaDriverComponentNameGetDriverName",    UnitTestPssMonzaDriverComponentNameGetDriverName,     NULL,                                NULL,                                NULL,             0,            0},
  { "UnitTestPssMonzaDriverComponentNameGetControllerName","UnitTestPssMonzaDriverComponentNameGetControllerName",UnitTestPssMonzaDriverComponentNameGetControllerName, NULL,                                NULL,                                NULL,             0,            0},
  { "UnitTestPssMonzaNewRequestPacket",                    "UnitTestPssMonzaNewRequestPacket",                    UnitTestPssMonzaNewRequestPacket,                     NULL,                                NULL,                                NULL,             0,            0},
  { "UnitTestPssMonzaDeleteRequestPacket",                 "UnitTestPssMonzaDeleteRequestPacket",                 UnitTestPssMonzaDeleteRequestPacket,                  NULL,                                NULL,                                NULL,             0,            0},
  { "UnitTestPssMonzaReadData",                            "UnitTestPssMonzaReadData",                            UnitTestPssMonzaReadData,                             NULL,                                NULL,                                NULL,             0,            0},
  { "UnitTestIsPssMonzaExist",                             "UnitTestIsPssMonzaExist",                             UnitTestIsPssMonzaExist,                              NULL,                                NULL,                                NULL,             0,            0},
 // This test case made host.exe exception, so comment out it first. { "UnitTestPssMonzaGetSerialNumber",                     "UnitTestPssMonzaGetSerialNumber",                     UnitTestPssMonzaGetSerialNumber,                      NULL,                                NULL,                                NULL,             0,            0},
 // This test case made host.exe exception, so comment out it first. { "UnitTestPssMonzaGetMacAddress",                       "UnitTestPssMonzaGetMacAddress",                       UnitTestPssMonzaGetMacAddress,                        NULL,                                NULL,                                NULL,             0,            0},
};
