...
extern const UINT8 UnknownPssChipClassId[];
extern const UINT8 PssChipClassId[];
extern const UINT8 UnknownPssSerialNumber[];
extern const UINT8 PssSerialNumber[];
extern const UINT8 SizeofPssChipClassId;
extern const UINT8 SizeofPssSerialNumber;
