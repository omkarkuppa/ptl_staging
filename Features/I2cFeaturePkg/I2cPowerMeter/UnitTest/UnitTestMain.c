/**@file
  Unit test main of the I2C Power Meter Driver.
...
#define UNIT_TEST_NAME     "I2cPowerMeter Unit Test"
...
UNIT_TEST_CASE_STRUCT mUnitTestCasesStruct [] = {
  { "Test-I2cPmData",         "Test I2cPmData",         TestCaseI2cPmData,         PreI2cPmData,         CleanUpI2cPmData,         NULL,           0,            0},
};
  ...
  )
{
  ...
  UNIT_TEST_SUITE_HANDLE        UnitTestI2cPowerMeter;
  UINTN                         Index;
  ...
  Status = CreateUnitTestSuite (
             &UnitTestI2cPowerMeter,   // SuiteHandle  : Unit test suite to create
  ...
  for (Index = 0; Index < ARRAY_SIZE (mUnitTestCasesStruct); Index++) {
    Status = AddTestCase (
               UnitTestI2cPowerMeter,                    // SuiteHandle        : Unit test suite to add test to
