...
#include "CleanUpI2CTouchDevEntry.h"

#define CLEAN_UP_FUNCTION_NAME     "CleanUpI2CTouchDevEntry"
#define CLEAN_UP_FUNCTION_VERSION  "0.1"

/**
  Clean up all variables used in testing I2CTouchDevEntry function.
...
EFI_STATUS
EFIAPI
CleanI2CTouchDevEntryEnvironment (
  VOID
  )
{
  FreePool (gBS);
  ...
  )
{
  ...
  Status = CleanI2CTouchDevEntryEnvironment ();
