...
#define UNIT_TEST_NAME     "I2cTouchCommon Unit Test"
...
UNIT_TEST_CASE_STRUCT mUnitTestCasesStruct [] = {
  {"Test-InstallI2cTable",     "InstallI2cTable",     UnitTestInstallI2cTable,     PreInstallI2cTable,     CleanUpInstallI2cTable,     NULL,    0x00,      0},
  {"Test-GetDevTablePointer",  "GetDevTablePointer",  UnitTestGetDevTablePointer,  PreGetDevTablePointer,  CleanUpGetDevTablePointer,  NULL,    0x00,      0},
  {"Test-I2CTouchDevEntry",    "I2CTouchDevEntry",    UnitTestI2CTouchDevEntry,    PreI2CTouchDevEntry,    CleanUpI2CTouchDevEntry,    NULL,    0x00,      0},
};
  ...
  )
{
  ...
  UNIT_TEST_SUITE_HANDLE      UnitTestI2cTouchCommon;
  UINTN                       Index;
  ...
  Status = CreateUnitTestSuite (
             &UnitTestI2cTouchCommon,  // SuiteHandle  : Unit test suite to create
  ...
  for (Index = 0; Index < ARRAY_SIZE (mUnitTestCasesStruct); Index++) {
    Status = AddTestCase (
               UnitTestI2cTouchCommon,                   // SuiteHandle        : Unit test suite to add test to
