...
#include "CleanUpI2CBoardData.h"

#define CLEAN_UP_FUNCTION_NAME     "CleanUpI2CBoardData"
#define CLEAN_UP_FUNCTION_VERSION  "0.1"

/**
  Clean up all variables used in testing I2CBoardData function.
  ...
  )
{
  ...
  Status = CleanI2CBoardDataEnvironment ();
