...
#define UNIT_TEST_NAME     "I2cTouchDevAcpi Unit Test"
...
UNIT_TEST_CASE_STRUCT mUnitTestCasesStruct [] = {
  {"Test-PatchI2cDevicesBuffer",   "PatchI2cDevicesBuffer",   UnitTestPatchI2cDevicesBuffer,   PrePatchI2cDevicesBuffer,   CleanUpPatchI2cDevicesBuffer,   NULL,    0x00,      0},
  {"Test-PatchRtd3Buffer",         "PatchRtd3Buffer",         UnitTestPatchRtd3Buffer,         PrePatchRtd3Buffer,         CleanUpPatchRtd3Buffer,         NULL,    0x00,      0},
  {"Test-I2CBoardData",            "I2CBoardData",            UnitTestI2CBoardData,            PreI2CBoardData,            CleanUpI2CBoardData,            NULL,    0x00,      0},
  {"Test-I2cDevPatchEntry",        "I2cDevPatchEntry",        UnitTestI2cDevPatchEntry,        PreI2cDevPatchEntry,        CleanUpI2cDevPatchEntry,        NULL,    0x00,      0},
};
...
/**
  ...
  @retval EFI_OUT_OF_RESOURCES  There are not enough resources available to initialize the unit tests.
  ...
  )
{
  ...
  UNIT_TEST_SUITE_HANDLE      UnitTestI2cTouchDevAcpi;
  UINTN                       Index;
  ...
  Status = CreateUnitTestSuite (
             &UnitTestI2cTouchDevAcpi,  // SuiteHandle  : Unit test suite to create
  ...
  for (Index = 0; Index < ARRAY_SIZE (mUnitTestCasesStruct); Index++) {
    Status = AddTestCase (
               UnitTestI2cTouchDevAcpi,                  // SuiteHandle        : Unit test suite to add test to
