...
#include <setjmp.h>
#include <cmocka.h>
#include "TestCaseDeleteRequestPacket.h"
  ...
  )
{
  ...
  // check value will free after DeleteRequestPacket.
  DeleteRequestPacket (Packet);
