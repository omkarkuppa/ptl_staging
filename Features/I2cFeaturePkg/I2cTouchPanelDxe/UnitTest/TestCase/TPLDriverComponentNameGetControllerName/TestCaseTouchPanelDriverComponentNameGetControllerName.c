...
#include <setjmp.h>
#include <cmocka.h>
#include "TestCaseTouchPanelDriverComponentNameGetControllerName.h"
  ...
  )
{
  ...
  //
  // Test1 :Mock TouchPanelDriverComponentNameGetControllerName.
  // Expected Result: EFI_UNSUPPORTED.
  //
  Status = TouchPanelDriverComponentNameGetControllerName (NULL, NULL, NULL, NULL, NULL );
