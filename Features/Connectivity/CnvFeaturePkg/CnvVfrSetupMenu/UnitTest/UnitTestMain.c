/**@file
  Unit test main of the CnvVfrSetupMenu driver.
...
//
#include "TestCase/CnvVfrSetupMenuTestCase.h"

#define UNIT_TEST_NAME     "CnvVfrSetupMenu Unit Test"
  ...
  )
{
  ...
  UNIT_TEST_SUITE_HANDLE      UnitTestCnvVfrSetupMenu;
  UINTN                       Index;
  ...
  Status = CreateUnitTestSuite (
             &UnitTestCnvVfrSetupMenu,  // SuiteHandle  : Unit test suite to create
  ...
  for (Index = 0; Index < ARRAY_SIZE (mUnitTestCasesStruct); Index++) {
    Status = AddTestCase (
               UnitTestCnvVfrSetupMenu,                  // SuiteHandle        : Unit test suite to add test to
