/**@file
  Unit test main of the Cnv Dxe driver.
...
#define UNIT_TEST_NAME     "CnvDxe Unit Test"
...
UNIT_TEST_CASE_STRUCT  mUnitTestCasesStruct[] = {
  { "UnitTestCnvNvsAreaInit",   "CnvNvsAreaInit",   UnitTestCnvNvsAreaInit,   NULL, NULL, NULL, 0, 0 },
  { "UnitTestCnvNvsAreaUpdate", "CnvNvsAreaUpdate", UnitTestCnvNvsAreaUpdate, NULL, NULL, NULL, 0, 0 }
};
  ...
  )
{
  ...
  UNIT_TEST_SUITE_HANDLE      UnitTestCnvDxe;
  UINTN                       Index;
  ...
  Status = CreateUnitTestSuite (
             &UnitTestCnvDxe,         // SuiteHandle  : Unit test suite to create
  ...
  for (Index = 0; Index < ARRAY_SIZE (mUnitTestCasesStruct); Index++) {
    Status = AddTestCase (
               UnitTestCnvDxe,                           // SuiteHandle        : Unit test suite to add test to
